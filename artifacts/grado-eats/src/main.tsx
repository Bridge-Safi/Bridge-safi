    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: '1.75rem', position: 'relative', zIndex: 1 }}>
        ...
        <p style={{
          ...
          SAFI ÃÂÃÂ· MAROC ÃÂÃÂ· ÃÂÃÂ¢ÃÂÃÂ³ÃÂÃÂÃÂÃÂ ÃÂÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂµÃÂ
        </p>
        ...
        <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.62rem', letterSpacing: '0.18em', marginTop: 4 }}>
          Bienvenue ÃÂÃÂ· Welcome ÃÂÃÂ· ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ
        </p>
      </div>
      ...
      <p style={{
        ...
        ÃÂÃÂ© 2026 BRIDGE SAFI ÃÂÃÂ· safi-bridge.ma ÃÂÃÂ· ÃÂ°ÃÂÃÂÃÂ SÃÂÃÂ©curisÃÂÃÂ©
      </p>
    </div>
  );
}
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SHARED FORM STYLES ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SIGN-IN PAGE (custom ÃÂ¢ÃÂÃÂ email/phone + password, single screen) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ FORGOT PASSWORD PAGE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (loading) return;
    if (!identifier.trim()) { setError('Entrez votre numÃ©ro ou adresse email.'); return; }
    if (!password) { setError('Entrez votre mot de passe.'); return; }
    setLoading(true); setError('');
    try { await signIn(identifier.trim(), password); navigate(basePath || '/'); }
    catch (err: any) { setError(err.message || 'Identifiants incorrects. RÃ©essayez.'); }
    setLoading(false);
  };
  return (
    <AuthPageWrapper>
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SIGN-UP PAGE (custom ÃÂ¢ÃÂÃÂ name + email/phone + password, then OTP) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
const SIGNUP_T: Record<SignUpLang, {
  ...
  fr: {
    title:'CrÃÂÃÂ©er un compte ÃÂÃÂ· Sign up', sub:'Email ou tÃÂÃÂ©lÃÂÃÂ©phone + mot de passe',
    emailLabel:'EMAIL OU NUMÃÂÃÂRO DE TÃÂÃÂLÃÂÃÂPHONE *', emailPh:'+212 6XX XXX XXX ou email@...',
    passLabel:'MOT DE PASSE * (8 CARACTÃÂÃÂRES MIN.)', passPh:'ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢',
    btnCreate:'CrÃÂÃÂ©er mon compte ÃÂ¢ÃÂÃÂ', btnCreating:'CrÃÂÃÂ©ation en cours...',
    errEmail:'Email invalide ou dÃÂÃÂ©jÃÂÃÂ  utilisÃÂÃÂ©.', errPhone:'NumÃÂÃÂ©ro invalide ou dÃÂÃÂ©jÃÂÃÂ  utilisÃÂÃÂ©.',
    errPass:'Mot de passe trop faible (8 caractÃÂÃÂ¨res min.).', errId:'Email ou tÃÂÃÂ©lÃÂÃÂ©phone requis.',
    alreadyHave:'DÃÂÃÂ©jÃÂÃÂ  un compte ?', login:'Se connecter',
    verifyTitle:'VÃÂÃÂ©rification ÃÂÃÂ· Verify', verifySub:(id)=>`Code envoyÃÂÃÂ© ÃÂÃÂ  ${id}`,
    verifyLabel:'CODE DE VÃÂÃÂRIFICATION (6 CHIFFRES)', btnVerify:'VÃÂÃÂ©rifier ÃÂ¢ÃÂÃÂ', btnVerifying:'VÃÂÃÂ©rification...',
    errCode:'Code incorrect ou expirÃÂÃÂ©.', back:'ÃÂ¢ÃÂÃÂ Retour',
    loadMsgs:['Bienvenue chez Bridge Safi ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¦','CrÃÂÃÂ©ation de votre compte...','PrÃÂÃÂ©paration de vos services...','Presque prÃÂÃÂªt ÃÂ¢ÃÂÃÂ¨','Connexion sÃÂÃÂ©curisÃÂÃÂ©e ÃÂ°ÃÂÃÂÃÂ'],
  },
  en: {
    title:'Create account ÃÂÃÂ· CrÃÂÃÂ©er un compte', sub:'Email or phone + password',
    emailLabel:'EMAIL OR PHONE NUMBER *', emailPh:'+212 6XX XXX XXX or email@...',
    passLabel:'PASSWORD * (MIN. 8 CHARACTERS)', passPh:'ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢',
    btnCreate:'Create my account ÃÂ¢ÃÂÃÂ', btnCreating:'Creating account...',
    ...
    verifyTitle:'Verification ÃÂÃÂ· VÃÂÃÂ©rification', verifySub:(id)=>`Code sent to ${id}`,
    verifyLabel:'VERIFICATION CODE (6 DIGITS)', btnVerify:'Verify ÃÂ¢ÃÂÃÂ', btnVerifying:'Verifying...',
    errCode:'Wrong or expired code.', back:'ÃÂ¢ÃÂÃÂ Back',
    loadMsgs:['Welcome to Bridge Safi ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¦','Creating your account...','Setting up your services...','Almost ready ÃÂ¢ÃÂÃÂ¨','Securing your connection ÃÂ°ÃÂÃÂÃÂ'],
  },
  ar: {
    title:'ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ´ÃÂÃÂ§ÃÂÃÂ¡ ÃÂÃÂ­ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨ ÃÂÃÂ· Sign up', sub:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂ£ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂ + ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ±',
    emailLabel:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¥ÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂ±ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ£ÃÂÃÂ ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂ *', emailPh:'+212 6XX XXX XXX ÃÂÃÂ£ÃÂÃÂ email@...',
    passLabel:'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ± * (8 ÃÂÃÂ£ÃÂÃÂ­ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ)', passPh:'ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢',
    btnCreate:'ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ´ÃÂÃÂ§ÃÂÃÂ¡ ÃÂÃÂ­ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨ÃÂÃÂ ÃÂ¢ÃÂÃÂ', btnCreating:'ÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¥ÃÂÃÂÃÂÃÂ´ÃÂÃÂ§ÃÂÃÂ¡...',
    errEmail:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂºÃÂÃÂÃÂÃÂ± ÃÂÃÂµÃÂÃÂ§ÃÂÃÂÃÂÃÂ­ ÃÂÃÂ£ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂªÃÂÃÂ®ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ§ÃÂÃÂ.', errPhone:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂºÃÂÃÂÃÂÃÂ± ÃÂÃÂµÃÂÃÂ§ÃÂÃÂÃÂÃÂ­ ÃÂÃÂ£ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂªÃÂÃÂ®ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ§ÃÂÃÂ.',
    errPass:'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ± ÃÂÃÂ¶ÃÂÃÂ¹ÃÂÃÂÃÂÃÂÃÂÃÂ© (8 ÃÂÃÂ£ÃÂÃÂ­ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ).', errId:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂ£ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂ ÃÂÃÂÃÂÃÂ·ÃÂÃÂÃÂÃÂÃÂÃÂ¨.',
    alreadyHave:'ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ ÃÂÃÂ­ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨ÃÂÃÂ', login:'ÃÂÃÂªÃÂÃÂ³ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ®ÃÂÃÂÃÂÃÂ',
    verifyTitle:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂ ÃÂÃÂ· Verify', verifySub:(id)=>`ÃÂÃÂªÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂ±ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ² ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ${id}`,
    verifyLabel:'ÃÂÃÂ±ÃÂÃÂÃÂÃÂ² ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂ (6 ÃÂÃÂ£ÃÂÃÂ±ÃÂÃÂÃÂÃÂ§ÃÂÃÂ)', btnVerify:'ÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ', btnVerifying:'ÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂ...',
    errCode:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ² ÃÂÃÂ®ÃÂÃÂ§ÃÂÃÂ·ÃÂÃÂ¦ ÃÂÃÂ£ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ§ÃÂÃÂ­ÃÂÃÂÃÂÃÂ©.', back:'ÃÂÃÂ±ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¹ ÃÂ¢ÃÂÃÂ',
    loadMsgs:['ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂÃÂÃÂ Bridge Safi ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¦','ÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ´ÃÂÃÂ§ÃÂÃÂ¡ ÃÂÃÂ­ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨ÃÂÃÂ...','ÃÂÃÂªÃÂÃÂ¬ÃÂÃÂÃÂÃÂÃÂÃÂ² ÃÂÃÂ®ÃÂÃÂ¯ÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂ...','ÃÂÃÂªÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ² ÃÂ¢ÃÂÃÂ¨','ÃÂÃÂªÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂªÃÂÃÂµÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂ°ÃÂÃÂÃÂ'],
  },
  amz: {
    title:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂÃÂ· Sign up', sub:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ»ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ + ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ',
    emailLabel:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ»ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ *', emailPh:'+212 6XX XXX XXX ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ email@...',
    passLabel:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ * (8 ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ»ÃÂ¢ÃÂµÃÂ)', passPh:'ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¢',
    btnCreate:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ', btnCreating:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ°...',
    errEmail:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ»ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ»ÃÂ¢ÃÂµÃÂ.', errPhone:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ»ÃÂ¢ÃÂµÃÂ.',
    errPass:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ (8).', errId:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ»ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ.',
    alreadyHave:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ?', login:'ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    verifyTitle:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ ÃÂÃÂ· Verify', verifySub:(id)=>`ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ${id}`,
    verifyLabel:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ (6)', btnVerify:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ ÃÂ¢ÃÂÃÂ', btnVerifying:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ°...',
    errCode:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ»ÃÂ¢ÃÂµÃÂ.', back:'ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    loadMsgs:['ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ Bridge Safi ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¦','ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ...','ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ...','ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ¹ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂÃÂ¨','ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° ÃÂ°ÃÂÃÂÃÂ'],
  },
};

const LANG_FLAGS: Record<SignUpLang, string> = { fr:'ÃÂ°ÃÂÃÂÃÂ«ÃÂ°ÃÂÃÂÃÂ·', en:'ÃÂ°ÃÂÃÂÃÂ¬ÃÂ°ÃÂÃÂÃÂ§', ar:'ÃÂ°ÃÂÃÂÃÂ²ÃÂ°ÃÂÃÂÃÂ¦', amz:'ÃÂ¢ÃÂµÃÂ£' };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ color:'rgba(255,255,255,0.45)', fontSize:'0.62rem', marginTop:6, letterSpacing:'0.08em', fontWeight:600 }}>
          {lang==='ar'?'ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂÃÂÃÂ³ÃÂÃÂªÃÂÃÂºÃÂÃÂ±ÃÂÃÂ 5ÃÂ¢ÃÂÃÂ15 ÃÂÃÂ«ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ©ÃÂ¢ÃÂÃÂ¦':lang==='en'?'May take 5ÃÂ¢ÃÂÃÂ15 s on slow networksÃÂ¢ÃÂÃÂ¦':'Peut prendre 5ÃÂ¢ÃÂÃÂ15 s selon le rÃÂÃÂ©seauÃÂ¢ÃÂÃÂ¦'}
        </p>
        <p style={{ color:'rgba(255,255,255,0.2)', fontSize:'0.58rem', marginTop:4, letterSpacing:'0.15em' }}>
          BRIDGE SAFI ÃÂÃÂ· ÃÂÃÂ¢ÃÂÃÂ³ÃÂÃÂÃÂÃÂ ÃÂÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂµÃÂ
        </p>
      </div>
...
function SignUpPage() {
  ...
  return (
    <AuthPageWrapper>
      ...
      <form onSubmit={handleSubmit} style={{ display:'flex', flexDirection:'column' }}>
        <FocusInput label="TÃ©lÃ©phone ou email *"
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Session keep-alive: renews the Clerk JWT every 4 min when
//    the user chose "Rester connectÃÂÃÂ©", preventing inactivity sign-out ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ GAME PAGE PLACEHOLDER ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

const GAME_LANGS = ['fr','en','ar','amz'] as const;
type GameLang = typeof GAME_LANGS[number];
const GAME_LANG_LABELS: Record<GameLang,string> = {fr:'FR',en:'EN',ar:'AR',amz:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£'};
const GAME_URL = 'https://game.safi-bridge.ma';
const GAME_TARGET = 60000;
const GAME_T = {
  fr:{
    back:'ÃÂ¢ÃÂÃÂ Retour', playerId:'ID JOUEUR', diamonds:'MES DIAMANTS', playBtn:'ÃÂ°ÃÂÃÂÃÂ® JOUER MAINTENANT',
    rulesBtn:'ÃÂ°ÃÂÃÂÃÂ RÃÂÃÂ¨gles du jeu', target:'OBJECTIF', progress:'PROGRESSION',
    days:'3 jours ÃÂÃÂ· 3h/jour', pts:'pts',
    howTitle:'ÃÂ°ÃÂÃÂÃÂ COMMENT GAGNER ?',
    sec1Title:'ÃÂ¢ÃÂÃÂ±ÃÂ¯ÃÂ¸ÃÂ DURÃÂÃÂE DE JEU',
    sec1:'Jouez 3h/jour pendant 3 jours ÃÂÃÂ· DurÃÂÃÂ©e totale : 9h ÃÂÃÂ· Plus vous jouez, plus vous gagnez de ÃÂ°ÃÂÃÂÃÂ !',
    sec2Title:'ÃÂ°ÃÂÃÂÃÂ DIAMANTS ÃÂÃÂ RÃÂÃÂCOLTER',
    sec2:'Objectif : 60 000 ÃÂ°ÃÂÃÂÃÂ en 3 jours ÃÂÃÂ· Rythme : 6 000 ÃÂ°ÃÂÃÂÃÂ/heure (3h ÃÂÃÂ 3j = 54 000 ÃÂ°ÃÂÃÂÃÂ) ÃÂÃÂ· +2 000 ÃÂ°ÃÂÃÂÃÂ/jour bonus (1h en plus) = 60 000 ÃÂ°ÃÂÃÂÃÂ = livraison gratuite',
    sec3Title:'ÃÂ°ÃÂÃÂÃÂ DIAMANTS MANQUANTS',
    sec3:'Objectif atteint ÃÂ¢ÃÂÃÂ tout est offert ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· Manque 10 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ vous payez 5 DH ÃÂÃÂ· Calcul : diamants manquants ÃÂÃÂ· 10 000 ÃÂÃÂ 5 DH',
    bonusTitle:'ÃÂ°ÃÂÃÂÃÂ BONUS ÃÂ¢ÃÂÃÂ LIVRAISON GRATUITE',
    bonusDesc:'Jouez 4h/jour (1h bonus) ÃÂ¢ÃÂÃÂ +2 000 ÃÂ°ÃÂÃÂÃÂ/jour ÃÂ¢ÃÂÃÂ 60 000 ÃÂ°ÃÂÃÂÃÂ = livraison 100% GRATUITE ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· Sinon le jeu s\'arrÃÂÃÂªte net ÃÂÃÂ  3h, revenez le lendemain',
  },
  en:{
    back:'ÃÂ¢ÃÂÃÂ Back', playerId:'PLAYER ID', diamonds:'MY DIAMONDS', playBtn:'ÃÂ°ÃÂÃÂÃÂ® PLAY NOW',
    rulesBtn:'ÃÂ°ÃÂÃÂÃÂ Game Rules', target:'TARGET', progress:'PROGRESS',
    days:'3 days ÃÂÃÂ· 3h/day', pts:'pts',
    howTitle:'ÃÂ°ÃÂÃÂÃÂ HOW TO WIN?',
    sec1Title:'ÃÂ¢ÃÂÃÂ±ÃÂ¯ÃÂ¸ÃÂ PLAY TIME',
    sec1:'Play 3h/day for 3 days ÃÂÃÂ· Total: 9h ÃÂÃÂ· The more you play, the more ÃÂ°ÃÂÃÂÃÂ you earn!',
    sec2Title:'ÃÂ°ÃÂÃÂÃÂ DIAMONDS TO COLLECT',
    sec2:'Goal: 60,000 ÃÂ°ÃÂÃÂÃÂ in 3 days ÃÂÃÂ· Rate: 6,000 ÃÂ°ÃÂÃÂÃÂ/hour (3h ÃÂÃÂ 3j = 54,000 ÃÂ°ÃÂÃÂÃÂ) ÃÂÃÂ· +2,000 ÃÂ°ÃÂÃÂÃÂ/day bonus (1 extra hour) = 60,000 ÃÂ°ÃÂÃÂÃÂ = free delivery',
    sec3Title:'ÃÂ°ÃÂÃÂÃÂ MISSING DIAMONDS',
    sec3:'Goal reached ÃÂ¢ÃÂÃÂ everything is free ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· Missing 10,000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ you pay 5 DH ÃÂÃÂ· Formula: missing ÃÂÃÂ· 10,000 ÃÂÃÂ 5 DH',
    bonusTitle:'ÃÂ°ÃÂÃÂÃÂ BONUS ÃÂ¢ÃÂÃÂ FREE DELIVERY',
    bonusDesc:'Play 4h/day (1 bonus hour) ÃÂ¢ÃÂÃÂ +2,000 ÃÂ°ÃÂÃÂÃÂ/day ÃÂ¢ÃÂÃÂ 60,000 ÃÂ°ÃÂÃÂÃÂ = 100% FREE delivery ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· Otherwise the game stops at 3h, come back tomorrow',
  },
  ar:{
    back:'ÃÂ¢ÃÂÃÂ ÃÂÃÂ±ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¹', playerId:'ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ¨', diamonds:'ÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂªÃÂÃÂ', playBtn:'ÃÂ°ÃÂÃÂÃÂ® ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¢ÃÂÃÂ',
    rulesBtn:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂ©', target:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ', progress:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂÃÂÃÂ¯ÃÂÃÂ',
    days:'3 ÃÂÃÂ£ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ· 3 ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ§ÃÂÃÂª/ÃÂÃÂÃÂÃÂÃÂÃÂ', pts:'ÃÂÃÂÃÂÃÂÃÂÃÂ·ÃÂÃÂ©',
    howTitle:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂªÃÂÃÂÃÂÃÂÃÂÃÂ²ÃÂÃÂ',
    sec1Title:'ÃÂ¢ÃÂÃÂ±ÃÂ¯ÃÂ¸ÃÂ ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨',
    sec1:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ 3 ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ§ÃÂÃÂª/ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ© 3 ÃÂÃÂ£ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ· ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¬ÃÂÃÂÃÂÃÂÃÂÃÂ¹: 9 ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ· ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂª ÃÂÃÂ£ÃÂÃÂÃÂÃÂ«ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂ¨ÃÂÃÂª ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ£ÃÂÃÂÃÂÃÂ«ÃÂÃÂ±!',
    sec2Title:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ·ÃÂÃÂÃÂÃÂÃÂÃÂ¨ÃÂÃÂ©',
    sec2:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ: 60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ 3 ÃÂÃÂ£ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ· 6 000 ÃÂ°ÃÂÃÂÃÂ/ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ© (3ÃÂÃÂ³ ÃÂÃÂ 3ÃÂÃÂ£ = 54 000 ÃÂ°ÃÂÃÂÃÂ) ÃÂÃÂ· +2 000 ÃÂ°ÃÂÃÂÃÂ/ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£ÃÂÃÂ© (ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ© ÃÂÃÂ¥ÃÂÃÂ¶ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ©) = 60 000 ÃÂ°ÃÂÃÂÃÂ = ÃÂÃÂªÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ',
    sec3Title:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµÃÂÃÂ©',
    sec3:'ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂª ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂ´ÃÂÃÂÃÂÃÂ¡ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· ÃÂÃÂÃÂÃÂÃÂÃÂµ 10 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¹ 5 ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂ· ÃÂÃÂ§ÃÂÃÂÃÂÃÂ­ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨: ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµ ÃÂÃÂ· 10 000 ÃÂÃÂ 5 = ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂÃÂÃÂ',
    bonusTitle:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£ÃÂÃÂ© ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ',
    bonusDesc:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ 4 ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ§ÃÂÃÂª/ÃÂÃÂÃÂÃÂÃÂÃÂ (ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ© ÃÂÃÂ¥ÃÂÃÂ¶ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ©) ÃÂ¢ÃÂÃÂ +2 000 ÃÂ°ÃÂÃÂÃÂ/ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ 60 000 ÃÂ°ÃÂÃÂÃÂ = ÃÂÃÂªÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ 100% ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· ÃÂÃÂÃÂÃÂ¥ÃÂÃÂÃÂÃÂ§ ÃÂÃÂªÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂ© ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ¯ 3 ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ§ÃÂÃÂªÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂ¯ ÃÂÃÂºÃÂÃÂ¯ÃÂÃÂ§ÃÂÃÂ',
  },
  amz:{
    back:'ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', playerId:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ³ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡', diamonds:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', playBtn:'ÃÂ°ÃÂÃÂÃÂ® ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    rulesBtn:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', target:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', progress:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ¹',
    days:'3 ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂÃÂ· 3 ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ/ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', pts:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ',
    howTitle:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ?',
    sec1Title:'ÃÂ¢ÃÂÃÂ±ÃÂ¯ÃÂ¸ÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ',
    sec1:'ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂ 3 ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ/ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂÃÂ· 3 ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂÃÂ· ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ: 9 ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    sec2Title:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·',
    sec2:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ: 60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· 6 000 ÃÂ°ÃÂÃÂÃÂ/ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂÃÂ· +2 000 ÃÂ°ÃÂÃÂÃÂ/ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ = ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    sec3Title:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    sec3:'ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· 10 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ 5 ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ: ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂÃÂ· 10 000 ÃÂÃÂ 5 = ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    bonusTitle:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    bonusDesc:'ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂ 4 ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ/ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ +2 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ 60 000 ÃÂ°ÃÂÃÂÃÂ = ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ 100% ÃÂ°ÃÂÃÂÃÂ',
  },
};

// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ BRIDGE GAME RULES MODAL ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

function GameRulesModal({ lang, onClose }: { lang: GameLang; onClose: () => void }) {
  const isAR = lang === 'ar';
  const rules = {
    fr: {
      title: 'ÃÂ°ÃÂÃÂÃÂ RÃÂÃÂ¨gles du Jeu',
      subtitle: 'Bridge Shark ÃÂ¢ÃÂÃÂ Comment gagner ?',
      sections: [
        {
          icon: 'ÃÂ¢ÃÂÃÂ±ÃÂ¯ÃÂ¸ÃÂ', title: 'DurÃÂÃÂ©e de jeu',
          points: [
            'Jouez autant que vous voulez, ÃÂÃÂ  votre rythme',
            'Objectif total : atteindre 60 000 ÃÂ°ÃÂÃÂÃÂ',
            'ÃÂ°ÃÂÃÂÃÂ Plus vous jouez, plus vous gagnez de ÃÂ°ÃÂÃÂÃÂ !',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ', title: 'Diamants ÃÂÃÂ  rÃÂÃÂ©colter',
          points: [
            'Objectif : rÃÂÃÂ©colter 60 000 ÃÂ°ÃÂÃÂÃÂ',
            '200 ÃÂ°ÃÂÃÂÃÂ = 1 MAD de rÃÂÃÂ©duction sur votre commande',
            '60 000 ÃÂ°ÃÂÃÂÃÂ = 300 MAD offerts !',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ¸', title: 'Diamants manquants',
          points: [
            'Si vous atteignez 60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ tout est offert ! ÃÂ°ÃÂÃÂÃÂ',
            'S\'il manque 10 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ vous payez 5 DH',
            'S\'il manque 30 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ vous payez 15 DH',
            'Calcul : diamants manquants ÃÂÃÂ· 10 000 ÃÂÃÂ 5 DH',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ´', title: 'BONUS ÃÂ¢ÃÂÃÂ Livraison gratuite',
          points: [
            'Atteignez 60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ prochaine livraison 100% GRATUITE ÃÂ°ÃÂÃÂÃÂ',
            'Chaque commande jouÃÂÃÂ©e booste vos diamants !',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ', title: 'Comment utiliser vos gains',
          points: [
            'ÃÂ°ÃÂÃÂÃÂµ Un menu depuis Bridge Eats',
            'ÃÂ°ÃÂÃÂÃÂ¬ Un paquet de cigarettes via Bridge Tabac',
            'ÃÂ°ÃÂÃÂÃÂ¹ Une coupe de fleurs via Bridge Fleurs',
            'ÃÂÃÂchangez directement dans l\'application !',
          ]
        },
      ],
      example: 'ÃÂ°ÃÂÃÂÃÂ¡ Exemple : vous avez 50 000 ÃÂ°ÃÂÃÂÃÂ au lieu de 60 000 ÃÂ¢ÃÂÃÂ il manque 10 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ vous payez seulement 5 DH.',
      close: 'J\'ai compris ! ÃÂ°ÃÂÃÂ¦ÃÂ',
    },
    en: {
      title: 'ÃÂ°ÃÂÃÂÃÂ Game Rules',
      subtitle: 'Bridge Shark ÃÂ¢ÃÂÃÂ How to win?',
      sections: [
        {
          icon: 'ÃÂ¢ÃÂÃÂ±ÃÂ¯ÃÂ¸ÃÂ', title: 'Playing time',
          points: [
            'Play at your own pace, whenever you want',
            'Total goal: reach 60,000 ÃÂ°ÃÂÃÂÃÂ',
            'ÃÂ°ÃÂÃÂÃÂ The more you play, the more ÃÂ°ÃÂÃÂÃÂ you earn!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ', title: 'Diamonds to collect',
          points: [
            'Goal: collect 60,000 ÃÂ°ÃÂÃÂÃÂ',
            '200 ÃÂ°ÃÂÃÂÃÂ = 1 MAD discount on your order',
            '60,000 ÃÂ°ÃÂÃÂÃÂ = 300 MAD off!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ¸', title: 'Missing diamonds',
          points: [
            'Reach 60,000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ everything is free! ÃÂ°ÃÂÃÂÃÂ',
            'Missing 10,000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ you pay 5 DH',
            'Missing 30,000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ you pay 15 DH',
            'Formula: missing diamonds ÃÂÃÂ· 10,000 ÃÂÃÂ 5 DH',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ´', title: 'BONUS ÃÂ¢ÃÂÃÂ Free delivery',
          points: [
            'Reach 60,000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ next delivery 100% FREE ÃÂ°ÃÂÃÂÃÂ',
            'Every order played boosts your diamonds!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ', title: 'How to use your winnings',
          points: [
            'ÃÂ°ÃÂÃÂÃÂµ A meal from Bridge Eats',
            'ÃÂ°ÃÂÃÂÃÂ¬ A pack of cigarettes from Bridge Tabac',
            'ÃÂ°ÃÂÃÂÃÂ¹ A bunch of flowers from Bridge Fleurs',
            'Redeem directly in the app!',
          ]
        },
      ],
      example: 'ÃÂ°ÃÂÃÂÃÂ¡ Example: you have 50,000 ÃÂ°ÃÂÃÂÃÂ instead of 60,000 ÃÂ¢ÃÂÃÂ missing 10,000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ you pay only 5 DH.',
      close: 'Got it! ÃÂ°ÃÂÃÂ¦ÃÂ',
    },
    ar: {
      title: 'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂ©',
      subtitle: 'Bridge Shark ÃÂ¢ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂªÃÂÃÂÃÂÃÂÃÂÃÂ²ÃÂÃÂ',
      sections: [
        {
          icon: 'ÃÂ¢ÃÂÃÂ±ÃÂ¯ÃÂ¸ÃÂ', title: 'ÃÂÃÂÃÂÃÂÃÂÃÂª ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨',
          points: [
            'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ ÃÂÃÂ¨ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂÃÂÃÂ±ÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ ÃÂÃÂªÃÂÃÂ±ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂªÃÂÃÂ ÃÂÃÂ´ÃÂÃÂ¦ÃÂÃÂª',
            'ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ : ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ 60 000 ÃÂ°ÃÂÃÂÃÂ',
            'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂª ÃÂÃÂ£ÃÂÃÂÃÂÃÂ«ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂ¨ÃÂÃÂª ÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ£ÃÂÃÂÃÂÃÂ«ÃÂÃÂ±!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ', title: 'ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ·ÃÂÃÂÃÂÃÂÃÂÃÂ¨ÃÂÃÂ©',
          points: [
            'ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ : ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¹ 60 000 ÃÂ°ÃÂÃÂÃÂ',
            '200 ÃÂ°ÃÂÃÂÃÂ = 1 ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂ®ÃÂÃÂµÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ ÃÂÃÂ·ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ',
            '60 000 ÃÂ°ÃÂÃÂÃÂ = 300 ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂÃÂ!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ¸', title: 'ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµÃÂÃÂ©',
          points: [
            'ÃÂÃÂ­ÃÂÃÂÃÂÃÂÃÂÃÂª 60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂ´ÃÂÃÂÃÂÃÂ¡ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ! ÃÂ°ÃÂÃÂÃÂ',
            'ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµ 10 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¹ 5 ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂÃÂÃÂ',
            'ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµ 30 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¹ 15 ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂÃÂÃÂ',
            'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ­ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨ : ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµ ÃÂÃÂ· 10 000 ÃÂÃÂ 5 = ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂÃÂÃÂ',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ´', title: 'ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ£ÃÂÃÂ© ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ',
          points: [
            'ÃÂÃÂ§ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¹ 60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂÃÂÃÂ 100% ÃÂ°ÃÂÃÂÃÂ',
            'ÃÂÃÂÃÂÃÂ ÃÂÃÂ·ÃÂÃÂÃÂÃÂ¨ ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂÃÂÃÂ±ÃÂÃÂÃÂÃÂ¹ ÃÂÃÂ±ÃÂÃÂµÃÂÃÂÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂª!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ', title: 'ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂªÃÂÃÂ³ÃÂÃÂªÃÂÃÂ®ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ¨ÃÂÃÂ',
          points: [
            'ÃÂ°ÃÂÃÂÃÂµ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ¨ÃÂÃÂ© ÃÂÃÂÃÂÃÂ Bridge Eats',
            'ÃÂ°ÃÂÃÂÃÂ¬ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ© ÃÂÃÂ³ÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂ¦ÃÂÃÂ± ÃÂÃÂÃÂÃÂ Bridge Tabac',
            'ÃÂ°ÃÂÃÂÃÂ¹ ÃÂÃÂ¨ÃÂÃÂ§ÃÂÃÂÃÂÃÂ© ÃÂÃÂÃÂÃÂ±ÃÂÃÂ¯ ÃÂÃÂÃÂÃÂ Bridge Fleurs',
            'ÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂªÃÂÃÂ¨ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ§ÃÂÃÂ´ÃÂÃÂ±ÃÂÃÂ© ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ·ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ!',
          ]
        },
      ],
      example: 'ÃÂ°ÃÂÃÂÃÂ¡ ÃÂÃÂÃÂÃÂ«ÃÂÃÂ§ÃÂÃÂ : ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ 50 000 ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂ¯ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂ 60 000 ÃÂ¢ÃÂÃÂ ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂµ 10 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¹ 5 ÃÂÃÂ¯ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ·.',
      close: 'ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂª! ÃÂ°ÃÂÃÂ¦ÃÂ',
    },
    amz: {
      title: 'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡',
      subtitle: 'Bridge Shark',
      sections: [
        {
          icon: 'ÃÂ¢ÃÂÃÂ±ÃÂ¯ÃÂ¸ÃÂ', title: 'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡',
          points: [
            'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·, ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·',
            'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ : 60 000 ÃÂ°ÃÂÃÂÃÂ',
            'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ°ÃÂÃÂÃÂ!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ', title: 'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ',
          points: [
            'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ : 60 000 ÃÂ°ÃÂÃÂÃÂ',
            '200 ÃÂ°ÃÂÃÂÃÂ = 1 ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ°',
            '60 000 ÃÂ°ÃÂÃÂÃÂ = 300 ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ¸', title: 'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ',
          points: [
            '60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½! ÃÂ°ÃÂÃÂÃÂ',
            'ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° 10 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ 5 ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
            'ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° 30 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ 15 ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
            'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ: ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂÃÂ· 10 000 ÃÂÃÂ 5 = ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ´', title: 'ÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ ÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼',
          points: [
            '60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ 100% ÃÂ°ÃÂÃÂÃÂ',
            'ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂµÃÂ ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ!',
          ]
        },
        {
          icon: 'ÃÂ°ÃÂÃÂÃÂ', title: 'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½',
          points: [
            'ÃÂ°ÃÂÃÂÃÂµ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ Bridge Eats',
            'ÃÂ°ÃÂÃÂÃÂ¬ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ Bridge Tabac',
            'ÃÂ°ÃÂÃÂÃÂ¹ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ Bridge Fleurs',
          ]
        },
      ],
      example: 'ÃÂ°ÃÂÃÂÃÂ¡ 50 000 ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ³ 60 000 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° 10 000 ÃÂ¢ÃÂÃÂ 5 ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ.',
      close: 'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ! ÃÂ°ÃÂÃÂ¦ÃÂ',
    },
  };
          ...
          {!showIOSGuide ? (
            <div style={{display:'flex',alignItems:'center',gap:14}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                <p style={{color:'rgba(255,255,255,0.7)',fontSize:12,margin:0}}>AccÃÂÃÂ¨s rapide depuis l'ÃÂÃÂ©cran d'accueil</p>
              </div>
            ...
            <div style={{textAlign:'center',padding:'4px 0'}}>
              ...
              <p style={{color:'rgba(255,255,255,0.8)',fontSize:12,margin:'0 0 12px'}}>
                Appuyez sur <span style={{fontSize:20}}>ÃÂ¢ÃÂÃÂ</span> puis <strong>"Sur l'ÃÂÃÂ©cran d'accueil"</strong>
              </p>
              <div style={{fontSize:28,marginBottom:12}}>ÃÂ¢ÃÂÃÂ</div>
...
function GamePage() {
  ...
  // Not signed in ÃÂ¢ÃÂÃÂ show lock screen (Bridge Eats login REQUIRED, no phone bypass)
  if (!isSignedIn) {
    const lockT = {
      fr: { title: 'CONNEXION BRIDGE EATS REQUISE', game: 'SAFI RUNNER', desc: 'Pour jouer, connecte-toi d\'abord sur Bridge Eats avec ton email et ton numÃÂÃÂ©ro. Tu seras automatiquement reconnu sur le jeu et tes diamants seront synchronisÃÂÃÂ©s.', connectBtn: 'ÃÂ°ÃÂÃÂÃÂµ ME CONNECTER SUR BRIDGE EATS', note: 'ÃÂ°ÃÂÃÂÃÂ Bridge Eats gÃÂÃÂ¨re la connexion. Tes ÃÂ°ÃÂÃÂÃÂ sont liÃÂÃÂ©s ÃÂÃÂ  ton compte\nÃÂ¢ÃÂÃÂ joue depuis n\'importe quel appareil avec le mÃÂÃÂªme email.', signUpLink: 'Pas encore inscrit ? CrÃÂÃÂ©er un compte' },
      en: { title: 'BRIDGE EATS LOGIN REQUIRED', game: 'SAFI RUNNER', desc: 'To play, sign in to Bridge Eats first with your email and number. You\'ll be automatically recognized and your diamonds will sync.', connectBtn: 'ÃÂ°ÃÂÃÂÃÂµ SIGN IN ON BRIDGE EATS', note: 'ÃÂ°ÃÂÃÂÃÂ Bridge Eats manages the login. Your ÃÂ°ÃÂÃÂÃÂ are linked to your account\nÃÂ¢ÃÂÃÂ play from any device with the same email.', signUpLink: 'Not registered yet? Create an account' },
      ar: { title: 'ÃÂÃÂªÃÂÃÂ³ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ®ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ·ÃÂÃÂÃÂÃÂÃÂÃÂ¨', game: 'SAFI RUNNER', desc: 'ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂ³ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ®ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ Bridge Eats. ÃÂÃÂ³ÃÂÃÂÃÂÃÂªÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ¹ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂªÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ¦ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂªÃÂÃÂªÃÂÃÂ²ÃÂÃÂ§ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂªÃÂÃÂ.', connectBtn: 'ÃÂ°ÃÂÃÂÃÂµ ÃÂÃÂªÃÂÃÂ³ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ®ÃÂÃÂÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂ± Bridge Eats', note: 'ÃÂ°ÃÂÃÂÃÂ Bridge Eats ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ± ÃÂÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂµÃÂÃÂ§ÃÂÃÂ. ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ±ÃÂÃÂªÃÂÃÂ¨ÃÂÃÂ·ÃÂÃÂ© ÃÂÃÂ¨ÃÂÃÂ­ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨ÃÂÃÂ.', signUpLink: 'ÃÂÃÂÃÂÃÂÃÂÃÂ³ ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ ÃÂÃÂ­ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂ£ÃÂÃÂÃÂÃÂ´ÃÂÃÂ¦ ÃÂÃÂÃÂÃÂ§ÃÂÃÂ­ÃÂÃÂ¯ÃÂÃÂ§ÃÂÃÂ' },
      amz: { title: 'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ³ BRIDGE EATS', game: 'SAFI RUNNER', desc: 'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ± ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ ÃÂ¢ÃÂµÃÂ Bridge Eats.', connectBtn: 'ÃÂ°ÃÂÃÂÃÂµ ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ BRIDGE EATS', note: 'ÃÂ°ÃÂÃÂÃÂ Bridge Eats ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ³.', signUpLink: 'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°? ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ±' },
    }[lang];
    return (
      <div dir={isAR ? 'rtl' : 'ltr'} style={{minHeight:'100dvh',background:'linear-gradient(180deg,#04110A 0%,#071C11 60%,#050F08 100%)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'32px 20px',gap:0}}>
        <div style={{width:'100%',maxWidth:360,background:'rgba(255,255,255,0.04)',border:'1px solid rgba(74,222,128,0.2)',borderRadius:28,padding:'36px 24px 28px',display:'flex',flexDirection:'column',alignItems:'center',gap:16,backdropFilter:'blur(12px)'}}>
          <div style={{fontSize:52,lineHeight:1}}>ÃÂ°ÃÂÃÂÃÂ</div>
          ...
          <p style={{color:'#fff',fontSize:22,fontWeight:900,letterSpacing:'0.12em',margin:0,textAlign:'center'}}>ÃÂ°ÃÂÃÂ¦ÃÂ {lockT.game}</p>
          <p style={{color:'rgba(255,255,255,0.65)',fontSize:13,fontWeight:500,lineHeight:1.6,textAlign:'center',margin:0}}>{lockT.desc}</p>
          {/* SEUL accÃÂÃÂ¨s : via Bridge Eats ÃÂ¢ÃÂÃÂ aucune entrÃÂÃÂ©e par numÃÂÃÂ©ro seul */}
  ...
  // Signed in ÃÂ¢ÃÂÃÂ fetch game token then show Safi Runner
...
function GameIframe({ userId, lang, isAR }: { userId: string; lang: GameLang; isAR: boolean }) {
  ...
  useEffect(() => {
    const handler = (event: MessageEvent) => {
      ...
      // Game requests player info ÃÂ¢ÃÂÃÂ send profile
      ...
      // If game sends less than the session start, it started from 0 ÃÂ¢ÃÂÃÂ add to existing balance.
      // If game sends more than session start, it incorporated our starting value ÃÂ¢ÃÂÃÂ use directly.
  ...
  const noPhoneMsg = {
    fr: { title: 'NUMÃÂÃÂRO REQUIS', body: 'Pour jouer, tu dois d\'abord enregistrer ton numÃÂÃÂ©ro de tÃÂÃÂ©lÃÂÃÂ©phone dans ton profil Bridge.', btn: 'Aller ÃÂÃÂ  mon profil' },
    en: { title: 'PHONE REQUIRED', body: 'To play, you must first add your phone number to your Bridge profile.', btn: 'Go to my profile' },
    ar: { title: 'ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂ ÃÂÃÂÃÂÃÂ·ÃÂÃÂÃÂÃÂÃÂÃÂ¨', body: 'ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ¨ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂ¶ÃÂÃÂ§ÃÂÃÂÃÂÃÂ© ÃÂÃÂ±ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ´ÃÂÃÂ®ÃÂÃÂµÃÂÃÂ.', btn: 'ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ´ÃÂÃÂ®ÃÂÃÂµÃÂÃÂ' },
    amz: { title: 'AÃÂ¡ÃÂ¹ÃÂ¬ILIFUN ILAQ', body: 'Ad tsÃÂÃÂ£eÃÂ¡ÃÂ¹ÃÂÃÂ¡ÃÂ¸ÃÂ, ÃÂÃÂemmreÃÂÃÂ£ aÃÂ¡ÃÂ¹ÃÂ­ilifun inek.', btn: 'AÃÂ¡ÃÂ¸ÃÂ¥sab inek' },
  }[lang];
  ...
  if (state === 'loading') return (
    <div style={{minHeight:'100dvh',background:'#04110A',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',gap:16}}>
      ...
      <p style={{color:'rgba(255,255,255,0.4)',fontSize:12,fontWeight:700,letterSpacing:'0.1em'}}>{isAR?'ÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂÃÂÃÂ...':lang==='en'?'Loading...':'Chargement...'}</p>
  ...
  if (state === 'no_phone') return (
    <div dir={isAR?'rtl':'ltr'} style={{minHeight:'100dvh',background:'linear-gradient(180deg,#04110A,#071C11)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'32px 20px'}}>
      <div style={{width:'100%',maxWidth:360,background:'rgba(255,255,255,0.04)',border:'1px solid rgba(248,113,113,0.3)',borderRadius:28,padding:'36px 24px',display:'flex',flexDirection:'column',alignItems:'center',gap:14,backdropFilter:'blur(12px)'}}>
        <div style={{fontSize:48}}>ÃÂ°ÃÂÃÂÃÂµ</div>
        ...
        <button onClick={()=>navigate('/')} style={{width:'100%',padding:'16px 0',borderRadius:16,border:'none',cursor:'pointer',background:'linear-gradient(135deg,#059669,#4ADE80)',color:'#fff',fontSize:14,fontWeight:900,marginTop:4}}>
          ÃÂ°ÃÂÃÂÃÂ¤ {noPhoneMsg.btn}
        </button>
      </div>
    </div>
  );
  ...
  if (state === 'error') return (
    <div style={{minHeight:'100dvh',background:'#04110A',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',gap:12}}>
      <p style={{color:'#F87171',fontSize:13,fontWeight:700}}>{isAR?'ÃÂÃÂ®ÃÂÃÂ·ÃÂÃÂ£ ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂÃÂÃÂ':lang==='en'?'Failed to load game':'Erreur de chargement'}</p>
      <button onClick={()=>navigate('/')} style={{padding:'12px 24px',borderRadius:14,border:'none',background:'rgba(74,222,128,0.15)',color:'#4ADE80',fontSize:13,fontWeight:900,cursor:'pointer'}}>
        ÃÂ¢ÃÂÃÂ {isAR?'ÃÂÃÂ±ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¹':lang==='en'?'Back':'Retour'}
      </button>
    </div>
  );
  ...
  // Use the server-side avatar endpoint ÃÂ¢ÃÂÃÂ a stable HTTPS URL the game can always fetch.
  ...
  return (
    <div style={{position:'fixed',inset:0,zIndex:9999,background:'#000'}}>
      {/* Fullscreen iframe ÃÂ¢ÃÂÃÂ no space stolen */}
      <iframe
        ref={iframeRef}
        src={gameSrc}
      ...
      />
      {/* Right-side controls ÃÂ¢ÃÂÃÂ back arrow + avatar stacked, near the game's player circle */}
      <div style={{position:'absolute',right:10,bottom:120,zIndex:10,display:'flex',flexDirection:'column',alignItems:'center',gap:8,pointerEvents:'auto'}}>
        ...
        {avatarSrc
          ...
          : <div style={{width:36,height:36,borderRadius:'50%',background:'rgba(4,17,10,0.75)',
              ...
              fontSize:16,boxShadow:'0 2px 12px rgba(0,0,0,0.5)',flexShrink:0}}>ÃÂ°ÃÂÃÂÃÂ¤</div>
        }
      </div>
    </div>
  );
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ DRIVER GPS TRACKER PAGE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
function DriverTrackerPage({ params }: { params?: { ref?: string } }) {
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Delivery mode state ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  const [status, setStatus] = useState<'asking'|'active'|'error'|'denied'>('asking');
  const [coords, setCoords] = useState<{lat:number;lng:number}|null>(null);
  const [lastSent, setLastSent] = useState<number|null>(null);
  const watchId = useRef<number|null>(null);

  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Taxi mode state ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Load taxi booking info ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  useEffect(() => {
    if (!isTaxi) return;
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Delivery mode ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ TAXI MODE UI ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  if (isTaxi) {
    return (
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#78350F 0%,#1A2F23 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: 'system-ui, sans-serif' }}>
        <div style={{ width: '100%', maxWidth: '360px', background: '#fff', borderRadius: '24px', padding: '28px 24px', boxShadow: '0 8px 40px rgba(0,0,0,0.3)', textAlign: 'center' }}>
          <div style={{ fontSize: '56px', marginBottom: '8px' }}>ÃÂ°ÃÂÃÂÃÂ</div>
          ...
          {taxiState === 'loading' && (
            <div style={{ padding: '20px', background: '#FEF3C7', borderRadius: '12px' }}>
              <p style={{ fontSize: '13px', color: '#B45309', fontWeight: '700' }}>ÃÂ¢ÃÂÃÂ³ Chargement de la courseÃÂ¢ÃÂÃÂ¦</p>
            </div>
          )}
          ...
          {taxiState === 'pending' && bookingInfo && (
            <div>
              ...
              <div style={{ background: '#FEF3C7', borderRadius: '14px', padding: '14px', marginBottom: '16px', textAlign: 'left' }}>
                <p style={{ fontSize: '10px', fontWeight: '900', color: '#92400E', letterSpacing: '0.1em', marginBottom: '10px' }}>DÃÂÃÂTAILS DE LA COURSE</p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <div style={{ display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
                    <span style={{ fontSize: '14px' }}>ÃÂ°ÃÂÃÂÃÂ¤</span>
                    <div>
                  ...
                  {bookingInfo.clientAddress && (
                    <div style={{ display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
                      <span style={{ fontSize: '14px' }}>ÃÂ°ÃÂÃÂÃÂ</span>
                      <div>
                        <p style={{ fontSize: '10px', color: '#9CA3AF', margin: '0 0 2px', fontWeight: '700' }}>DÃÂÃÂPART</p>
                        <p style={{ fontSize: '12px', color: '#1A2F23', margin: 0 }}>{bookingInfo.clientAddress}</p>
                        {bookingInfo.clientLat && bookingInfo.clientLng && (
                          <a href={`https://maps.google.com/?q=${bookingInfo.clientLat},${bookingInfo.clientLng}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: '11px', color: '#3B82F6', fontWeight: '700' }}>Ouvrir dans Maps ÃÂ¢ÃÂÃÂ</a>
                        )}
                      </div>
                    </div>
                  )}
              ...
              <button onClick={handleAccept} style={{ width: '100%', padding: '14px', background: 'linear-gradient(135deg,#065F46,#10B981)', color: '#fff', border: 'none', borderRadius: '14px', fontSize: '16px', fontWeight: '900', cursor: 'pointer', boxShadow: '0 4px 16px rgba(16,185,129,0.4)' }}>
                ÃÂ¢ÃÂÃÂ Accepter la course
              </button>
            </div>
          )}
          ...
          {taxiState === 'pending' && !bookingInfo && (
            <div style={{ padding: '20px', background: '#FEF3C7', borderRadius: '12px' }}>
              <p style={{ fontSize: '13px', color: '#B45309', fontWeight: '700' }}>ÃÂ°ÃÂÃÂÃÂ Course en attente</p>
            ...
            <div>
              ...
              {bookingInfo?.destination && (
                <div style={{ background: '#EFF6FF', borderRadius: '12px', padding: '10px 14px', marginBottom: '12px', textAlign: 'left' }}>
                  ...
                  <p style={{ fontSize: '13px', color: '#1D4ED8', fontWeight: '800', margin: 0 }}>ÃÂ°ÃÂÃÂÃÂ {bookingInfo.destination}</p>
                </div>
              )}
              {taxiCoords && (
              ...
              {taxiSecsAgo !== null && <p style={{ fontSize: '11px', color: '#10B981', marginBottom: '16px' }}>ÃÂ¢ÃÂÃÂ Mis ÃÂÃÂ  jour il y a {taxiSecsAgo}s</p>}
              <button onClick={handleArrived} style={{ width: '100%', padding: '14px', background: 'linear-gradient(135deg,#78350F,#F59E0B)', color: '#fff', border: 'none', borderRadius: '14px', fontSize: '16px', fontWeight: '900', cursor: 'pointer', boxShadow: '0 4px 16px rgba(120,53,15,0.4)' }}>
                ÃÂ°ÃÂÃÂÃÂ¯ Je suis arrivÃÂÃÂ© !
              </button>
              <div style={{ marginTop: '12px', padding: '10px', background: '#FEF3C7', borderRadius: '10px' }}>
                <p style={{ fontSize: '11px', color: '#92400E', fontWeight: '700' }}>ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Ne fermez pas cette page</p>
              </div>
            </div>
          )}
          ...
          {taxiState === 'arrived' && (
            <div style={{ background: '#EFF6FF', borderRadius: '14px', padding: '20px' }}>
              <p style={{ fontSize: '36px', marginBottom: '8px' }}>ÃÂ°ÃÂÃÂÃÂ</p>
              <p style={{ fontSize: '16px', fontWeight: '900', color: '#1D4ED8', marginBottom: '4px' }}>Course terminÃÂÃÂ©e !</p>
              <p style={{ fontSize: '12px', color: '#3B82F6' }}>Le client a ÃÂÃÂ©tÃÂÃÂ© notifiÃÂÃÂ© de votre arrivÃÂÃÂ©e.</p>
            </div>
          )}
        </div>
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ DELIVERY MODE UI ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  return (
    <div style={{ minHeight: '100vh', background: '#F0FDF4', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ width: '100%', maxWidth: '360px', background: '#fff', borderRadius: '24px', padding: '32px 24px', boxShadow: '0 8px 40px rgba(0,0,0,0.12)', textAlign: 'center' }}>
        <div style={{ fontSize: '64px', marginBottom: '16px' }}>ÃÂ°ÃÂÃÂÃÂµ</div>
        <h1 style={{ fontSize: '20px', fontWeight: '900', color: '#065F46', margin: '0 0 4px' }}>Bridge Safi ÃÂ¢ÃÂÃÂ GPS Livreur</h1>
        ...
        {status === 'asking' && (
          <div style={{ background: '#FEF3C7', borderRadius: '12px', padding: '16px' }}>
            <p style={{ fontSize: '14px', color: '#B45309', fontWeight: '700' }}>ÃÂ¢ÃÂÃÂ³ En attente de la localisationÃÂ¢ÃÂÃÂ¦</p>
            <p style={{ fontSize: '12px', color: '#92400E', marginTop: '4px' }}>Autorisez l'accÃÂÃÂ¨s ÃÂÃÂ  votre position GPS</p>
          </div>
        )}
        ...
        {status === 'active' && delivStatus !== 'delivered' && (
          <div>
            ...
            {/* Status buttons */}
            <p style={{ fontSize: '10px', fontWeight: '900', color: '#9CA3AF', letterSpacing: '0.08em', marginBottom: '10px', textTransform: 'uppercase' }}>Mettre ÃÂÃÂ  jour le statut</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '16px' }}>
              {([
                { key: 'received',  label: 'ÃÂ°ÃÂÃÂÃÂ Commande reÃÂÃÂ§ue',      bg: '#F0FDF4', border: '#86EFAC', color: '#065F46' },
                { key: 'preparing', label: 'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ¢ÃÂÃÂÃÂ°ÃÂÃÂÃÂ³ En prÃÂÃÂ©paration',       bg: '#FEF3C7', border: '#FDE68A', color: '#92400E' },
                { key: 'on_way',    label: 'ÃÂ°ÃÂÃÂÃÂµ En chemin vers le client', bg: '#EFF6FF', border: '#93C5FD', color: '#1D4ED8' },
                { key: 'delivered', label: 'ÃÂ¢ÃÂÃÂ Livraison effectuÃÂÃÂ©e',  bg: '#065F46', border: '#065F46', color: '#fff'    },
            ...
            {coords && (
              <p style={{ fontSize: '10px', fontFamily: 'monospace', color: '#9CA3AF', background: '#F9FAFB', borderRadius: '8px', padding: '6px 8px', marginBottom: '8px' }}>
                ÃÂ°ÃÂÃÂÃÂ {coords.lat.toFixed(5)}, {coords.lng.toFixed(5)}
              </p>
            )}
        ...
        {status === 'active' && delivStatus === 'delivered' && (
          <div style={{ background: '#F0FDF4', borderRadius: '14px', padding: '20px' }}>
            <p style={{ fontSize: '36px', marginBottom: '8px' }}>ÃÂ°ÃÂÃÂÃÂ</p>
            <p style={{ fontSize: '16px', fontWeight: '900', color: '#065F46', marginBottom: '4px' }}>Livraison terminÃÂÃÂ©e !</p>
            <p style={{ fontSize: '12px', color: '#6B7280' }}>Le client a ÃÂÃÂ©tÃÂÃÂ© notifiÃÂÃÂ©. Merci !</p>
          </div>
        )}

        {status === 'denied' && (
          <div style={{ background: '#FEE2E2', borderRadius: '12px', padding: '16px' }}>
            <p style={{ fontSize: '14px', color: '#DC2626', fontWeight: '700' }}>ÃÂ¢ÃÂÃÂ AccÃÂÃÂ¨s GPS refusÃÂÃÂ©</p>
            <p style={{ fontSize: '12px', color: '#991B1B', marginTop: '4px' }}>Activez la localisation dans les paramÃÂÃÂ¨tres de votre navigateur puis rechargez la page</p>
          </div>
        )}

        {status === 'error' && (
          <div style={{ background: '#FEE2E2', borderRadius: '12px', padding: '16px' }}>
            <p style={{ fontSize: '14px', color: '#DC2626', fontWeight: '700' }}>ÃÂ¢ÃÂÃÂ Lien invalide</p>
            <p style={{ fontSize: '12px', color: '#991B1B', marginTop: '4px' }}>Utilisez le lien envoyÃÂÃÂ© par le restaurant</p>
          </div>
        )}
      </div>
      <style>{`@keyframes pulse{0%,100%{opacity:0.5;transform:scale(1);}50%{opacity:1;transform:scale(1.3);}}`}</style>
...
function DispatchPage() {
  ...
  useEffect(() => {
    ...
    else if (role === 'taxi') document.title = 'Bridge Taxi ÃÂ¢ÃÂÃÂ Safi';
    else if (role === 'livreur') document.title = 'Bridge Livraison';
    else document.title = 'Bridge Dispatch';
    return () => { document.title = 'Bridge Safi ÃÂÃÂ· Livraison & Taxi ÃÂÃÂ  Safi, Maroc'; };
  }, [role]);
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ GPS reporting to server (for smart dispatch proximity) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ EATS: SSE stream for new orders ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  useEffect(() => {
  ...
  const acceptEatsOrder = async (order: PendingOrder) => {
    ...
    // Don't override tracking status here ÃÂ¢ÃÂÃÂ restaurant may have already set 'preparing'
  };
  ...
  const pickupEatsOrder = async () => {
    ...
    // Tracking store: on_way ÃÂ¢ÃÂÃÂ customer sees EN CHEMIN ÃÂ°ÃÂÃÂÃÂµ
  ...
  const finishEatsDelivery = async () => {
    ...
    if (order) {
      // Tracking store: delivered ÃÂ¢ÃÂÃÂ customer sees LIVRÃÂÃÂE ÃÂ¢ÃÂÃÂ
      ...
      // Delete tracking entry after 15s so customer can see LIVRÃÂÃÂE
      const ref = order.ref;
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ TAXI: poll for pending bookings ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  useEffect(() => {
    if (role !== 'taxi') return;
    const poll = async () => {
      try {
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ MOTO: poll for pending moto-taxi bookings ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  useEffect(() => {
    if (role !== 'moto') return;
    const poll = async () => {
      try {
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ UI ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    return (
      <div style={{ minHeight: '100dvh', background: 'linear-gradient(160deg,#020c07 0%,#071C11 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px 20px' }}>
        ...
        <input
          ...
          placeholder="Votre prÃÂÃÂ©nom (ex: Youssef)"
        ...
        <input
          ...
          placeholder="Votre tÃÂÃÂ©lÃÂÃÂ©phone (ex: 0600000000)"
          type="tel"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%', maxWidth: 340 }}>
          <button onClick={() => handleSetRole('livreur')}
            ...
            <span style={{ fontSize: 26, flexShrink: 0 }}>ÃÂ°ÃÂÃÂÃÂµ</span>
            <div>
          ...
          <button onClick={() => handleSetRole('taxi')}
            ...
            <span style={{ fontSize: 26, flexShrink: 0 }}>ÃÂ°ÃÂÃÂÃÂ</span>
            <div>
              <div style={{ fontSize: 15, fontWeight: 900 }}>Taxi Confort</div>
              <div style={{ fontSize: 11, fontWeight: 500, opacity: 0.85 }}>Courses taxi confort ÃÂ¢ÃÂÃÂ Safi</div>
            </div>
          </button>
          <button onClick={() => handleSetRole('moto')}
            ...
            <div>
              ...
              <div style={{ fontSize: 11, fontWeight: 500, opacity: 0.85 }}>Courses moto ÃÂ¢ÃÂÃÂ Bridge Moto Taxi</div>
            </div>
          </button>
        </div>
        <button onClick={() => navigate('/')} style={{ marginTop: 24, color: 'rgba(255,255,255,0.4)', fontSize: 13, background: 'none', border: 'none', cursor: 'pointer' }}>ÃÂ¢ÃÂÃÂ Retour</button>
      </div>
    );
  }
  ...
  const icon = role === 'taxi' ? 'ÃÂ°ÃÂÃÂÃÂ' : role === 'moto' ? 'ÃÂ°ÃÂÃÂÃÂµ' : 'ÃÂ°ÃÂÃÂÃÂµ';
    ...
    <div style={{ minHeight: '100dvh', background: isDelivery ? '#F0FDF4' : isMoto ? '#FFF7ED' : '#FFFBEB', fontFamily: 'system-ui,sans-serif' }}>
      ...
      <div style={{ background: accentDark, padding: '52px 20px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          {pushLoading && <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: 11 }}>ÃÂ¢ÃÂÃÂ³</span>}
          {pushOk && <span style={{ background: 'rgba(74,222,128,0.2)', border: '1px solid rgba(74,222,128,0.4)', borderRadius: 20, padding: '3px 10px', color: '#4ADE80', fontSize: 10, fontWeight: 900 }}>ÃÂ°ÃÂÃÂÃÂ Notifs ON</span>}
          <button onClick={() => { setRole('choose'); setActiveEatsOrder(null); setActiveTaxi(null); setActiveMoto(null); }}
            style={{ background: 'rgba(255,255,255,0.1)', border: 'none', color: '#fff', borderRadius: 10, padding: '6px 12px', fontSize: 12, cursor: 'pointer' }}>ÃÂ¢ÃÂÃÂµ</button>
        </div>
      </div>

      <div style={{ padding: '20px 16px', maxWidth: 480, margin: '0 auto' }}>

        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ EATS / SCOOTER MODE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
          ...
          <>
            ...
            {eatsOrders.length === 0 ? (
              <div style={{ ...cardStyle, textAlign: 'center', padding: '40px 20px' }}>
                <p style={{ fontSize: 32, margin: '0 0 10px' }}>ÃÂ¢ÃÂÃÂ³</p>
                <p style={{ color: '#6B7280', fontSize: 14, fontWeight: 700, margin: 0 }}>En attente de commandesÃÂ¢ÃÂÃÂ¦</p>
              ...
              <div key={order.id} style={{ ...cardStyle, borderColor: '#BBF7D0', borderWidth: 2 }}>
                ...
                <p style={{ fontSize: 13, fontWeight: 800, color: '#111', margin: '0 0 2px' }}>ÃÂ°ÃÂÃÂÃÂ¤ {order.customerName}</p>
                {order.restaurantName && <p style={{ fontSize: 12, color: '#6B7280', margin: '0 0 2px' }}>ÃÂ°ÃÂÃÂ¥ÃÂ {order.restaurantName}</p>}
                <p style={{ fontSize: 12, color: '#6B7280', margin: '0 0 12px' }}>ÃÂ°ÃÂÃÂÃÂ {order.customerAddress}</p>
                <button onClick={() => acceptEatsOrder(order)}
                  ...
                  ÃÂ¢ÃÂÃÂ Accepter cette commande
                </button>
              </div>
            ))}
          </>
          ...
          <>
            ...
            <div style={{ ...cardStyle, borderColor: '#BBF7D0', borderWidth: 2, marginBottom: 10 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                  <p style={{ fontSize: 11, color: '#9CA3AF', fontWeight: 700, letterSpacing: '0.1em', margin: '0 0 2px' }}>COMMANDE ACCEPTÃÂÃÂE</p>
              ...
              <p style={{ fontSize: 13, fontWeight: 800, color: '#111', margin: '10px 0 2px' }}>ÃÂ°ÃÂÃÂÃÂ¤ {activeEatsOrder.customerName}</p>
            </div>
            ...
            {eatsGPS === 'active' && (
              <div style={{ background: '#D1FAE5', borderRadius: 12, padding: '10px 14px', marginBottom: 10, display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div>
                  <p style={{ fontSize: 12, fontWeight: 900, color: '#065F46', margin: 0 }}>ÃÂ°ÃÂÃÂÃÂ¡ GPS EN DIRECT ÃÂ¢ÃÂÃÂ Client vous suit</p>
            ...
            {eatsGPS === 'denied' && <p style={{ color: '#DC2626', fontSize: 12, marginBottom: 10 }}>ÃÂ¢ÃÂÃÂ GPS refusÃÂÃÂ© ÃÂ¢ÃÂÃÂ activez la localisation dans les paramÃÂÃÂ¨tres</p>}

            {/* ÃÂÃÂTAPE 1 : Aller au restaurant */}
            <div style={{ ...cardStyle, borderColor: eatsDriverStep === 'going_to_restaurant' ? '#FDE68A' : '#BBF7D0', borderWidth: 2, marginBottom: 10, opacity: eatsDriverStep === 'done' ? 0.5 : 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                <div style={{ width: 28, height: 28, borderRadius: '50%', background: eatsDriverStep !== 'going_to_restaurant' ? '#059669' : '#FEF3C7', border: `2px solid ${eatsDriverStep !== 'going_to_restaurant' ? '#059669' : '#F59E0B'}`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <span style={{ fontSize: 12, color: eatsDriverStep !== 'going_to_restaurant' ? '#fff' : '#B45309', fontWeight: 900 }}>{eatsDriverStep !== 'going_to_restaurant' ? 'ÃÂ¢ÃÂÃÂ' : '1'}</span>
                </div>
                <div>
                  <p style={{ fontSize: 10, color: '#9CA3AF', fontWeight: 700, letterSpacing: '0.1em', margin: 0 }}>POINT DE COLLECTE ÃÂÃÂ· ÃÂÃÂTAPE 1</p>
              ...
              {activeEatsOrder.restaurantName && (
                <a href={`https://maps.google.com/?q=${encodeURIComponent(activeEatsOrder.restaurantName + ' Safi Maroc')}`} target="_blank" rel="noopener noreferrer"
                  ...
                  ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Naviguer ÃÂ¢ÃÂÃÂ Restaurant
                </a>
              )}
              {eatsDriverStep === 'going_to_restaurant' && (
                <button onClick={pickupEatsOrder}
                  ...
                  <span style={{ fontSize: 20 }}>ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ</span> J'ai rÃÂÃÂ©cupÃÂÃÂ©rÃÂÃÂ© la commande
                </button>
              )}
            </div>

            {/* ÃÂÃÂTAPE 2 : Livrer au client */}
            <div style={{ ...cardStyle, borderColor: eatsDriverStep === 'delivering' ? '#93C5FD' : '#E5E7EB', borderWidth: 2, opacity: eatsDriverStep === 'going_to_restaurant' ? 0.5 : 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                <div style={{ width: 28, height: 28, borderRadius: '50%', background: eatsDriverStep === 'done' ? '#059669' : eatsDriverStep === 'delivering' ? '#EFF6FF' : '#F3F4F6', border: `2px solid ${eatsDriverStep === 'done' ? '#059669' : eatsDriverStep === 'delivering' ? '#3B82F6' : '#E5E7EB'}`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <span style={{ fontSize: 12, color: eatsDriverStep === 'done' ? '#fff' : eatsDriverStep === 'delivering' ? '#1D4ED8' : '#9CA3AF', fontWeight: 900 }}>{eatsDriverStep === 'done' ? 'ÃÂ¢ÃÂÃÂ' : '2'}</span>
                </div>
                <div>
              ...
              {eatsDriverStep === 'delivering' && (
                <>
                  <a href={`https://maps.google.com/?q=${encodeURIComponent(activeEatsOrder.customerAddress)}`} target="_blank" rel="noopener noreferrer"
                    ...
                    ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Naviguer ÃÂ¢ÃÂÃÂ Client
                  </a>
                  <button onClick={finishEatsDelivery}
                    ...
                    <span style={{ fontSize: 20 }}>ÃÂ¢ÃÂÃÂ</span> J'ai livrÃÂÃÂ© au client
                  </button>
                </>
              )}
            </div>
        ...
        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ TAXI MODE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        {role === 'taxi' && !activeTaxi && (
          <>
            ...
            {taxiBookings.length === 0 ? (
              <div style={{ ...cardStyle, textAlign: 'center', padding: '40px 20px' }}>
                <p style={{ fontSize: 32, margin: '0 0 10px' }}>ÃÂ¢ÃÂÃÂ³</p>
                <p style={{ color: '#6B7280', fontSize: 14, fontWeight: 700, margin: 0 }}>En attente de coursesÃÂ¢ÃÂÃÂ¦</p>
                <p style={{ color: '#9CA3AF', fontSize: 11, margin: '4px 0 0' }}>La sonnette retentira automatiquement</p>
              </div>
              ...
              <div key={booking.ref} style={{ ...cardStyle, borderColor: '#FDE68A', borderWidth: 2 }}>
                ...
                <p style={{ fontSize: 13, fontWeight: 800, color: '#111', margin: '0 0 4px' }}>ÃÂ°ÃÂÃÂÃÂ¤ {booking.customerName || 'Client'}</p>
                {booking.clientAddress && <p style={{ fontSize: 12, color: '#6B7280', margin: '0 0 2px' }}>ÃÂ°ÃÂÃÂÃÂ DÃÂÃÂ©part : {booking.clientAddress}</p>}
                {booking.destination && <p style={{ fontSize: 12, color: '#1D4ED8', fontWeight: 800, margin: '0 0 6px' }}>ÃÂ°ÃÂÃÂÃÂ Destination : {booking.destination}</p>}
                {booking.clientPrice && (
                  <div style={{ background: '#FEF3C7', borderRadius: 10, padding: '8px 12px', marginBottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: 12, color: '#92400E', fontWeight: 800 }}>ÃÂ°ÃÂÃÂÃÂ° Client propose : <strong style={{ fontSize: 15 }}>{booking.clientPrice} DH</strong></span>
                  </div>
                )}
        ...
        {role === 'taxi' && activeTaxi && (
          <div style={{ ...cardStyle, borderColor: '#FDE68A', borderWidth: 2 }}>
            <p style={{ fontSize: 11, color: '#9CA3AF', fontWeight: 700, letterSpacing: '0.1em', margin: '0 0 8px' }}>COURSE ACCEPTÃÂÃÂE</p>
            <p style={{ fontSize: 18, fontWeight: 900, color: '#B45309', margin: '0 0 6px' }}>{activeTaxi.ref}</p>
            <p style={{ fontSize: 13, fontWeight: 800, color: '#111', margin: '0 0 4px' }}>ÃÂ°ÃÂÃÂÃÂ¤ {activeTaxi.customerName || 'Client'}</p>
            {activeTaxi.clientAddress && <p style={{ fontSize: 12, color: '#6B7280', margin: '0 0 2px' }}>ÃÂ°ÃÂÃÂÃÂ DÃÂÃÂ©part : {activeTaxi.clientAddress}</p>}
            {activeTaxi.destination && <p style={{ fontSize: 12, color: '#1D4ED8', fontWeight: 800, margin: '0 0 14px' }}>ÃÂ°ÃÂÃÂÃÂ Destination : {activeTaxi.destination}</p>}
            ...
            {taxiGPS === 'active' ? (
              <div style={{ background: '#FEF3C7', borderRadius: 12, padding: '12px 14px', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <p style={{ fontSize: 12, fontWeight: 900, color: '#B45309', margin: 0 }}>GPS EN DIRECT ÃÂ¢ÃÂÃÂ Client vous suit sur la carte</p>
              </div>
            ) : taxiGPS === 'denied' ? (
              <p style={{ color: '#DC2626', fontSize: 12, marginBottom: 12 }}>ÃÂ¢ÃÂÃÂ GPS refusÃÂÃÂ© ÃÂ¢ÃÂÃÂ activez la localisation</p>
            ) : (
              <p style={{ fontSize: 11, color: '#9CA3AF', marginBottom: 12 }}>ÃÂ¢ÃÂÃÂ³ DÃÂÃÂ©marrage GPSÃÂ¢ÃÂÃÂ¦</p>
            )}
            ...
            <button onClick={finishTaxi}
              ...
              ÃÂ¢ÃÂÃÂ J'ai dÃÂÃÂ©posÃÂÃÂ© le client
            </button>
            <style>{`@keyframes pulse{0%,100%{opacity:0.5;transform:scale(1);}50%{opacity:1;transform:scale(1.3);}}`}</style>
          </div>
        )}

        {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ MOTO TAXI MODE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
        {isMoto && !activeMoto && (
          <>
            ...
            {motoBookings.length === 0 ? (
              <div style={{ ...cardStyle, textAlign: 'center', padding: '40px 20px' }}>
                <p style={{ fontSize: 32, margin: '0 0 10px' }}>ÃÂ¢ÃÂÃÂ³</p>
                <p style={{ color: '#6B7280', fontSize: 14, fontWeight: 700, margin: 0 }}>En attente de courses motoÃÂ¢ÃÂÃÂ¦</p>
                <p style={{ color: '#9CA3AF', fontSize: 11, margin: '4px 0 0' }}>La sonnette retentira automatiquement</p>
              </div>
              ...
              <div key={booking.ref} style={{ ...cardStyle, borderColor: '#FED7AA', borderWidth: 2 }}>
                ...
                {booking.clientPrice && (
                  <div style={{ background: '#FFEDD5', borderRadius: 10, padding: '8px 12px', marginBottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: 12, color: '#7C2D12', fontWeight: 800 }}>ÃÂ°ÃÂÃÂÃÂ° Client propose : <strong style={{ fontSize: 15 }}>{booking.clientPrice} DH</strong></span>
                  </div>
                )}
                <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
                  <input
                ...
                <button onClick={() => acceptMoto(booking)}
                  ...
                  ÃÂ¢ÃÂÃÂ Accepter la course moto
                </button>
              </div>
            ))}
          </>
        ...
        {isMoto && activeMoto && (
          <div style={{ ...cardStyle, borderColor: '#FED7AA', borderWidth: 2 }}>
            <p style={{ fontSize: 11, color: '#9CA3AF', fontWeight: 700, letterSpacing: '0.1em', margin: '0 0 8px' }}>COURSE MOTO ACCEPTÃÂÃÂE</p>
            <p style={{ fontSize: 18, fontWeight: 900, color: '#9A3412', margin: '0 0 6px' }}>{activeMoto.ref}</p>
            <p style={{ fontSize: 13, fontWeight: 800, color: '#111', margin: '0 0 4px' }}>ÃÂ°ÃÂÃÂÃÂ¤ {activeMoto.customerName || 'Client'}</p>
            {activeMoto.clientAddress && <p style={{ fontSize: 12, color: '#6B7280', margin: '0 0 2px' }}>ÃÂ°ÃÂÃÂÃÂ DÃÂÃÂ©part : {activeMoto.clientAddress}</p>}
            {activeMoto.destination && <p style={{ fontSize: 12, color: '#1D4ED8', fontWeight: 800, margin: '0 0 14px' }}>ÃÂ°ÃÂÃÂÃÂ Destination : {activeMoto.destination}</p>}
            ...
            {motoGPS === 'active' ? (
              <div style={{ background: '#FFEDD5', borderRadius: 12, padding: '12px 14px', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <p style={{ fontSize: 12, fontWeight: 900, color: '#9A3412', margin: 0 }}>GPS EN DIRECT ÃÂ¢ÃÂÃÂ Client vous suit sur la carte</p>
              </div>
            ) : motoGPS === 'denied' ? (
              <p style={{ color: '#DC2626', fontSize: 12, marginBottom: 12 }}>ÃÂ¢ÃÂÃÂ GPS refusÃÂÃÂ© ÃÂ¢ÃÂÃÂ activez la localisation</p>
            ) : (
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ BRIDGE AI ASSISTANT PAGE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
const ASSISTANT_T = {
  fr: {
    ...
    placeholder: 'ÃÂÃÂcrivez votre question...',
    send: 'Envoyer',
    thinking: 'Bridge IA rÃÂÃÂ©flÃÂÃÂ©chit...',
    greeting: 'Bonjour ! ÃÂ°ÃÂÃÂÃÂ Je suis votre assistant Bridge Safi. Comment puis-je vous aider aujourd\'hui ?',
    quickTitle: 'Questions frÃÂÃÂ©quentes',
    q1: 'ÃÂ°ÃÂÃÂÃÂ¦ Suivre ma commande',
    q2: 'ÃÂ°ÃÂÃÂÃÂ Retard de livraison',
    q3: 'ÃÂ°ÃÂÃÂÃÂ³ ProblÃÂÃÂ¨me de paiement',
    q4: 'ÃÂ¢ÃÂÃÂ Autre question',
    escalated: 'ÃÂ°ÃÂÃÂÃÂ Un responsable Bridge vous contacte sous 30 min',
    wa: 'ÃÂ°ÃÂÃÂÃÂ± Contacter via WhatsApp',
    back: 'ÃÂ¢ÃÂÃÂ Retour',
  },
  en: {
    title: 'Bridge Assistant',
    ...
    greeting: 'Hello! ÃÂ°ÃÂÃÂÃÂ I\'m your Bridge Safi assistant. How can I help you today?',
    quickTitle: 'Frequent questions',
    q1: 'ÃÂ°ÃÂÃÂÃÂ¦ Track my order',
    q2: 'ÃÂ°ÃÂÃÂÃÂ Delivery delay',
    q3: 'ÃÂ°ÃÂÃÂÃÂ³ Payment issue',
    q4: 'ÃÂ¢ÃÂÃÂ Other question',
    escalated: 'ÃÂ°ÃÂÃÂÃÂ A Bridge manager will contact you within 30 min',
    wa: 'ÃÂ°ÃÂÃÂÃÂ± Contact via WhatsApp',
    back: 'ÃÂ¢ÃÂÃÂ Back',
  },
  ar: {
    title: 'ÃÂÃÂÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ¯ ÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¬',
    subtitle: 'ÃÂÃÂÃÂÃÂ³ÃÂÃÂªÃÂÃÂ´ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ 24/7',
    placeholder: 'ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ¨ ÃÂÃÂ³ÃÂÃÂ¤ÃÂÃÂ§ÃÂÃÂÃÂÃÂ...',
    send: 'ÃÂÃÂ¥ÃÂÃÂ±ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ',
    thinking: 'ÃÂÃÂ¨ÃÂÃÂ±ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¬ AI ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±...',
    greeting: 'ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ! ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ£ÃÂÃÂÃÂÃÂ§ ÃÂÃÂÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ°ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ Bridge Safi. ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ¯ÃÂÃÂªÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ',
    quickTitle: 'ÃÂÃÂ£ÃÂÃÂ³ÃÂÃÂ¦ÃÂÃÂÃÂÃÂ© ÃÂÃÂ´ÃÂÃÂ§ÃÂÃÂ¦ÃÂÃÂ¹ÃÂÃÂ©',
    q1: 'ÃÂ°ÃÂÃÂÃÂ¦ ÃÂÃÂªÃÂÃÂªÃÂÃÂ¨ÃÂÃÂ¹ ÃÂÃÂ·ÃÂÃÂÃÂÃÂ¨ÃÂÃÂ',
    q2: 'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂªÃÂÃÂ£ÃÂÃÂ®ÃÂÃÂ± ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ',
    q3: 'ÃÂ°ÃÂÃÂÃÂ³ ÃÂÃÂÃÂÃÂ´ÃÂÃÂÃÂÃÂÃÂÃÂ© ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¹',
    q4: 'ÃÂ¢ÃÂÃÂ ÃÂÃÂ³ÃÂÃÂ¤ÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂ®ÃÂÃÂ±',
    escalated: 'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ³ÃÂÃÂÃÂÃÂªÃÂÃÂµÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂÃÂÃÂ³ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ Bridge ÃÂÃÂ®ÃÂÃÂÃÂÃÂ§ÃÂÃÂ 30 ÃÂÃÂ¯ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©',
    wa: 'ÃÂ°ÃÂÃÂÃÂ± ÃÂÃÂªÃÂÃÂÃÂÃÂ§ÃÂÃÂµÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂ¨ÃÂÃÂ± ÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂ¨',
    back: 'ÃÂ¢ÃÂÃÂ ÃÂÃÂ±ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ¹',
  },
  amz: {
    title: 'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ Bridge',
    subtitle: 'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ 24/7',
    placeholder: 'ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ± ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½...',
    send: 'ÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂ',
    thinking: 'Bridge AI ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ...',
    greeting: 'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ! ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ ÃÂ¢ÃÂµÃÂ Bridge Safi.',
    quickTitle: 'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂ',
    q1: 'ÃÂ°ÃÂÃÂÃÂ¦ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ³ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¥ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    q2: 'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    q3: 'ÃÂ°ÃÂÃÂÃÂ³ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼',
    q4: 'ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¹ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂµÃÂ',
    escalated: 'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂ Bridge ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂ´ÃÂ½ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ 30 ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    wa: 'ÃÂ°ÃÂÃÂÃÂ± ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ WhatsApp',
    back: 'ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂ£ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
  },
};
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ RESTAURANT OWNER PAGE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
function statusLabel(s: string) {
  const m: Record<string,{label:string;color:string}> = {
    pending:   {label:'ÃÂ°ÃÂÃÂÃÂ¡ En attente',   color:'#F59E0B'},
    accepted:  {label:'ÃÂ°ÃÂÃÂÃÂ¢ AcceptÃÂÃÂ©e',     color:'#10B981'},
    preparing: {label:'ÃÂ°ÃÂÃÂÃÂµ En prÃÂÃÂ©paration',color:'#3B82F6'},
    ready:     {label:'ÃÂ¢ÃÂÃÂ PrÃÂÃÂªt',         color:'#059669'},
    delivered: {label:'ÃÂ°ÃÂÃÂÃÂ¦ LivrÃÂÃÂ©e',       color:'#6B7280'},
    refused:   {label:'ÃÂ¢ÃÂÃÂ RefusÃÂÃÂ©e',      color:'#EF4444'},
    cancelled: {label:'ÃÂ°ÃÂÃÂÃÂ« AnnulÃÂÃÂ©e',      color:'#EF4444'},
    on_the_way:{label:'ÃÂ°ÃÂÃÂÃÂ´ En route',     color:'#8B5CF6'},
  };
...
function RestaurantOwnerPage() {
  ...
  const updateStatus = async (ref: string, status: string) => {
    ...
    // Sync tracking store ÃÂ¢ÃÂÃÂ customer sees the change in real-time
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ NOT SIGNED IN ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  if (!isLoaded || loading) return (
    <div style={{minHeight:'100dvh',background:'linear-gradient(135deg,#0A1A0F,#0D2E1A)',display:'flex',alignItems:'center',justifyContent:'center'}}>
      <span style={{color:'rgba(255,255,255,0.4)',fontSize:13}}>ChargementÃÂ¢ÃÂÃÂ¦</span>
    </div>
  );
  ...
  if (!isSignedIn) return (
    <div style={{minHeight:'100dvh',background:'linear-gradient(135deg,#0A1A0F 0%,#0D2E1A 50%,#0A1A0F 100%)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'20px',fontFamily:'system-ui'}}>
      <div style={{fontSize:52,marginBottom:14}}>ÃÂ°ÃÂÃÂÃÂ½ÃÂ¯ÃÂ¸ÃÂ</div>
      ...
      <p style={{color:'rgba(255,255,255,0.4)',fontSize:12,fontWeight:600,margin:'0 0 28px',textAlign:'center'}}>Bridge Safi ÃÂÃÂ· Interface partenaire</p>
      <div style={{width:'100%',maxWidth:340,background:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)',borderRadius:24,padding:'24px 20px',display:'flex',flexDirection:'column',gap:14,textAlign:'center'}}>
        <p style={{color:'rgba(255,255,255,0.6)',fontSize:13,margin:0}}>Connectez-vous avec votre compte Bridge pour accÃÂÃÂ©der ÃÂÃÂ  votre espace restaurateur.</p>
      ...
      <button onClick={()=>navigate('/')} style={{marginTop:20,background:'none',border:'none',color:'rgba(255,255,255,0.35)',fontSize:12,fontWeight:700,cursor:'pointer'}}>
        ÃÂ¢ÃÂÃÂ Retour ÃÂÃÂ  Bridge
      </button>
    </div>
  );

  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ SIGNED IN BUT NO RESTAURANT LINKED YET ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  if (!linked) return (
    <div style={{minHeight:'100dvh',background:'linear-gradient(135deg,#0A1A0F 0%,#0D2E1A 50%,#0A1A0F 100%)',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'20px',fontFamily:'system-ui'}}>
      <div style={{fontSize:52,marginBottom:14}}>ÃÂ°ÃÂÃÂÃÂ½ÃÂ¯ÃÂ¸ÃÂ</div>
      ...
      <p style={{color:'rgba(255,255,255,0.4)',fontSize:12,fontWeight:600,margin:'0 0 6px',textAlign:'center'}}>ConnectÃÂÃÂ© : <strong style={{color:'#4ADE80'}}>{user?.emailAddresses?.[0]?.emailAddress}</strong></p>
      ...
      <div style={{width:'100%',maxWidth:340,background:'rgba(255,255,255,0.05)',border:'1px solid rgba(255,255,255,0.1)',borderRadius:24,padding:'24px 20px',display:'flex',flexDirection:'column',gap:14}}>
        <div>
          ...
          <select value={claimName} onChange={e=>setClaimName(e.target.value)}
            ...
            <option value="">-- SÃÂÃÂ©lectionner --</option>
        ...
        <button onClick={handleClaim} disabled={!claimName||claimPin.length!==4||linking}
          ...
          {linking ? 'Liaison en coursÃÂ¢ÃÂÃÂ¦' : 'Lier mon restaurant ÃÂ¢ÃÂÃÂ'}
        </button>
        <p style={{color:'rgba(255,255,255,0.25)',fontSize:10,textAlign:'center' as const,margin:0}}>
          Le PIN est fourni par l'ÃÂÃÂ©quipe Bridge Safi lors de l'inscription partenaire
        </p>
      </div>
      <button onClick={()=>navigate('/')} style={{marginTop:20,background:'none',border:'none',color:'rgba(255,255,255,0.35)',fontSize:12,fontWeight:700,cursor:'pointer'}}>
        ÃÂ¢ÃÂÃÂ Retour ÃÂÃÂ  Bridge
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ORDER CARD ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  const OrderCard = ({o}: {o: RestoOrder}) => {
    ...
    return (
      <div style={{background:'rgba(255,255,255,0.04)',border:`1px solid ${o.status==='pending'?'rgba(245,158,11,0.5)':o.status==='refused'?'rgba(239,68,68,0.3)':'rgba(255,255,255,0.08)'}`,borderRadius:18,padding:'14px 16px',marginBottom:10}}>
        ...
        <p style={{color:'#fff',fontSize:13,fontWeight:700,margin:'0 0 2px'}}>ÃÂ°ÃÂÃÂÃÂ¤ {o.customerName} ÃÂÃÂ· ÃÂ°ÃÂÃÂÃÂ {o.customerPhone}</p>
        <p style={{color:'rgba(255,255,255,0.5)',fontSize:11,fontWeight:600,margin:'0 0 8px'}}>ÃÂ°ÃÂÃÂÃÂ {o.customerAddress} ÃÂÃÂ· {o.deliveryMode==='collect'?'Click & Collect':'Livraison'}</p>
          ...
          <div style={{background:'rgba(0,0,0,0.2)',borderRadius:10,padding:'8px 10px',marginBottom:10}}>
            {items.map((it,i)=>(
              <p key={i} style={{color:'rgba(255,255,255,0.75)',fontSize:11,fontWeight:600,margin:'0 0 2px'}}>
                ÃÂÃÂ {it.qty} {it.name} ÃÂ¢ÃÂÃÂ {it.price} MAD
              </p>
            ))}
          </div>
        )}
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom: o.status==='pending'||o.status==='accepted'||o.status==='preparing'?10:0}}>
          <span style={{color:'#4ADE80',fontSize:14,fontWeight:900}}>ÃÂ°ÃÂÃÂÃÂ° {o.total} MAD</span>
          <span style={{color:'rgba(255,255,255,0.4)',fontSize:10,fontWeight:700}}>{o.paymentMethod==='cash'?'ÃÂ°ÃÂÃÂÃÂµ Cash':o.paymentMethod==='card'?'ÃÂ°ÃÂÃÂÃÂ³ Carte':'ÃÂ°ÃÂÃÂÃÂ³'}</span>
        </div>
        ...
        {o.status==='accepted' && (
          <button onClick={()=>updateStatus(o.ref,'preparing')}
            ...
            ÃÂ°ÃÂÃÂÃÂ¨ÃÂ¢ÃÂÃÂÃÂ°ÃÂÃÂÃÂ³ En prÃÂÃÂ©paration
          </button>
        )}
        {o.status==='preparing' && (
          <button onClick={()=>updateStatus(o.ref,'ready')}
            ...
            ÃÂ°ÃÂÃÂÃÂ Commande PrÃÂÃÂªte !
          </button>
        )}
      </div>
    );
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ DASHBOARD SCREEN ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  return (
    <div style={{minHeight:'100dvh',background:'linear-gradient(135deg,#0A1A0F 0%,#0D2E1A 50%,#0A1A0F 100%)',fontFamily:'system-ui',paddingBottom:30}}>
      ...
      <div style={{position:'sticky',top:0,zIndex:100,background:'rgba(4,17,10,0.95)',backdropFilter:'blur(12px)',borderBottom:'1px solid rgba(255,255,255,0.08)',padding:'12px 16px',display:'flex',alignItems:'center',gap:10}}>
        <span style={{fontSize:20}}>ÃÂ°ÃÂÃÂÃÂ½ÃÂ¯ÃÂ¸ÃÂ</span>
        <div style={{flex:1}}>
        ...
        <button onClick={()=>setIsOpen(p=>!p)}
          ...
          {isOpen?'ÃÂ°ÃÂÃÂÃÂ¢ OUVERT':'ÃÂ°ÃÂÃÂÃÂ´ FERMÃÂÃÂ'}
        </button>
      ...
      <div style={{display:'flex',borderBottom:'1px solid rgba(255,255,255,0.08)'}}>
        {([['orders','ÃÂ°ÃÂÃÂÃÂ Commandes'],['settings','ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ ParamÃÂÃÂ¨tres']] as const).map(([tab,label])=>(
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ COMMANDES TAB ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      {activeTab==='orders' && (
        <div style={{padding:'14px 14px 0'}}>
          ...
          <div style={{display:'flex',gap:8,marginBottom:14}}>
            {[
              ...
              {label:'TerminÃÂÃÂ©es',  count:done.length,     color:'#6B7280'},
            ].map(s=>(
          ...
          {active.length>0 && (
            <>
              <p style={{color:'#60A5FA',fontSize:10,fontWeight:900,letterSpacing:'0.15em',textTransform:'uppercase',margin:'14px 0 10px'}}>
                ÃÂ°ÃÂÃÂÃÂ¨ÃÂ¢ÃÂÃÂÃÂ°ÃÂÃÂÃÂ³ EN COURS ({active.length})
              </p>
          ...
          {done.length>0 && (
            <>
              <p style={{color:'rgba(255,255,255,0.25)',fontSize:10,fontWeight:900,letterSpacing:'0.15em',textTransform:'uppercase',margin:'14px 0 10px'}}>
                ÃÂ°ÃÂÃÂÃÂ¦ TERMINÃÂÃÂES ({done.length})
              </p>
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ PARAMÃÂÃÂTRES TAB ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      {activeTab==='settings' && (
        <div style={{padding:'16px 14px 40px'}}>
          ...
          <div style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:18,padding:'16px',marginBottom:16}}>
            <p style={{color:'rgba(255,255,255,0.4)',fontSize:10,fontWeight:900,letterSpacing:'0.12em',textTransform:'uppercase',margin:'0 0 14px'}}>ÃÂ°ÃÂÃÂÃÂ Informations</p>
            ...
            <div style={{marginBottom:12}}>
              <label style={{color:'rgba(255,255,255,0.45)',fontSize:10,fontWeight:800,letterSpacing:'0.1em',textTransform:'uppercase',display:'block',marginBottom:6}}>TÃÂÃÂ©lÃÂÃÂ©phone WhatsApp</label>
          ...
          {/* GPS coordinates */}
          <div style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:18,padding:'16px',marginBottom:16}}>
            <p style={{color:'rgba(255,255,255,0.4)',fontSize:10,fontWeight:900,letterSpacing:'0.12em',textTransform:'uppercase',margin:'0 0 14px'}}>ÃÂ°ÃÂÃÂÃÂ CoordonnÃÂÃÂ©es GPS</p>
            <p style={{color:'rgba(255,255,255,0.3)',fontSize:11,fontWeight:600,margin:'0 0 12px'}}>UtilisÃÂÃÂ©es pour le dispatch intelligent des livreurs.</p>
            <div style={{display:'flex',gap:10}}>
              <div style={{flex:1}}>
          ...
          <div style={{background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:18,padding:'16px',marginBottom:16}}>
            <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:4}}>
              ...
              <p style={{color:'#fff',fontSize:13,fontWeight:900,margin:0}}>Pont d'intÃÂÃÂ©gration Eats</p>
            </div>
            <p style={{color:'rgba(255,255,255,0.35)',fontSize:11,fontWeight:600,margin:'0 0 14px'}}>Donnez ces informations ÃÂÃÂ  votre responsable Bridge Eats</p>
            <div style={{background:'rgba(74,222,128,0.06)',border:'1px solid rgba(74,222,128,0.15)',borderRadius:12,padding:'10px 12px',marginBottom:14}}>
              <p style={{color:'rgba(74,222,128,0.8)',fontSize:11,fontWeight:600,margin:0}}>Bridge Eats enverra automatiquement vos nouvelles commandes ÃÂÃÂ  cette URL en utilisant votre token secret. DÃÂÃÂ¨s qu'une commande arrive, l'alarme sonne et elle apparaÃÂÃÂ®t sur votre tableau de bord.</p>
            </div>

            <div style={{marginBottom:12}}>
              <label style={{color:'rgba(255,255,255,0.45)',fontSize:10,fontWeight:800,letterSpacing:'0.12em',textTransform:'uppercase',display:'block',marginBottom:6}}>URL DU WEBHOOK (votre systÃÂÃÂ¨me)</label>
              <div style={{display:'flex',gap:8,alignItems:'center'}}>
                ...
                {profile.webhookUrl && (
                  <button onClick={()=>copyToClipboard(profile.webhookUrl,'wh')}
                    ...
                    {copied==='wh'?'ÃÂ¢ÃÂÃÂ':'ÃÂ¢ÃÂÃÂ'}
                  </button>
                )}
              </div>
            </div>
            ...
            <div style={{marginBottom:12}}>
              <label style={{color:'rgba(255,255,255,0.45)',fontSize:10,fontWeight:800,letterSpacing:'0.12em',textTransform:'uppercase',display:'block',marginBottom:6}}>EN-TÃÂÃÂTE REQUIS</label>
              ...
              <div>
                ...
                <div style={{display:'flex',gap:8,alignItems:'center'}}>
                  ...
                  <button onClick={()=>copyToClipboard(bridgeSecret,'secret')}
                    style={{padding:'11px 14px',borderRadius:12,border:'1px solid rgba(255,255,255,0.1)',background:'rgba(255,255,255,0.05)',color:'rgba(255,255,255,0.5)',fontSize:12,cursor:'pointer',flexShrink:0}}>
                    {copied==='secret'?'ÃÂ¢ÃÂÃÂ':'ÃÂ¢ÃÂÃÂ'}
                  </button>
                </div>
              </div>
            )}
          ...
          <div style={{background:'rgba(255,255,255,0.03)',border:`1px solid ${pushEnabled?'rgba(74,222,128,0.25)':'rgba(255,255,255,0.08)'}`,borderRadius:18,padding:'16px',marginBottom:16}}>
            ...
            <p style={{color:'rgba(255,255,255,0.35)',fontSize:11,fontWeight:600,margin:'0 0 14px'}}>
              Recevez une alerte instantanÃÂÃÂ©e sur cet appareil dÃÂÃÂ¨s qu'une nouvelle commande arrive ÃÂ¢ÃÂÃÂ avant mÃÂÃÂªme le livreur.
            </p>
            <button onClick={togglePushNotifications} disabled={pushLoading}
              ...
              {pushLoading ? 'ÃÂ¢ÃÂÃÂ³ En coursÃÂ¢ÃÂÃÂ¦' : pushEnabled ? 'ÃÂ°ÃÂÃÂÃÂ DÃÂÃÂ©sactiver les notifications' : 'ÃÂ°ÃÂÃÂÃÂ Activer les notifications sur cet appareil'}
            </button>
          </div>
          ...
          <button onClick={saveProfile} disabled={profileLoading}
            ...
            {profileSaved?'ÃÂ¢ÃÂÃÂ EnregistrÃÂÃÂ© !':profileLoading?'Enregistrement...':'ÃÂ°ÃÂÃÂÃÂ¾ Enregistrer le profil'}
          </button>
        </div>
      )}
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ END RESTAURANT OWNER PAGE ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

const ASSIST_LANG_LABELS: Record<AssistLang,string> = {fr:'FR',en:'EN',ar:'AR',amz:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£'};
...
function BridgeAssistantPage() {
  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role:'assistant', content: 'ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Service temporairement indisponible. RÃÂÃÂ©essayez dans quelques instants.' }]);
    } finally {
      setLoading(false);
    }
  };
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Error Boundary ÃÂ¢ÃÂÃÂ attrape les crashes React silencieux ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  render() {
    ...
    return (
      <div style={{
        ...
        <div style={{ fontSize: 56, marginBottom: 16 }}>ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ</div>
        ...
        <button
          ...
          ÃÂ°ÃÂÃÂÃÂ Recharger l'application
        </button>
      </div>
    );
  }
...
function AdminStatsPanel({ adminKey }: { adminKey: string }) {
  ...
  const refresh = async () => {
    ...
    try {
      ...
      if (!r.ok) { setErr('ClÃÂÃÂ© admin invalide.'); setStats(null); return; }
      setStats(await r.json()); setErr('');
    } catch { setErr('Erreur rÃÂÃÂ©seau.'); }
  };
  ...
  return (
    <div style={{ marginTop: 24, padding: 16, background: '#ECFDF5', borderRadius: 14, border: '1px solid #A7F3D0' }}>
      <h3 style={{ fontSize: 14, fontWeight: 900, color: '#065F46', marginBottom: 12 }}>ÃÂ°ÃÂÃÂÃÂ Visiteurs Bridge</h3>
          ...
          return (
            <div key={d.day} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <div style={{ minWidth: 90, textAlign: 'right', fontSize: 10, color: '#065F46', fontWeight: 800 }}>
                {d.uniques} pers ÃÂÃÂ· {d.views} vues
              </div>
            </div>
          );
        })}
      ...
      <button onClick={refresh}
        ...
        ÃÂ°ÃÂÃÂÃÂ RafraÃÂÃÂ®chir
      </button>
    </div>
  );
}
...
function AdminCouponsPanel({ adminKey }: { adminKey: string }) {
  ...
  const refresh = async () => {
    ...
    try {
      ...
      if (!r.ok) { setErr('ClÃÂÃÂ© admin invalide pour les coupons.'); setCoupons([]); return; }
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setMsg(d.message || 'Code crÃÂÃÂ©ÃÂÃÂ©.');
  ...
  return (
    <div style={{ marginTop: 24, padding: 16, background: '#FFFBEB', borderRadius: 14, border: '1px solid #FDE68A' }}>
      <h3 style={{ fontSize: 14, fontWeight: 900, color: '#92400E', marginBottom: 4 }}>ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Codes promo</h3>
      <p style={{ fontSize: 11, color: '#A16207', marginBottom: 14 }}>
        CrÃÂÃÂ©ez vos codes ÃÂ¢ÃÂÃÂ vous dÃÂÃÂ©cidez ÃÂÃÂ  qui les envoyer.
      </p>
      ...
      <div style={{ display: 'grid', gap: 8, marginBottom: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <div style={{ flex: 1 }}>
            <label style={labelStyle}>Max utilisations (vide = illimitÃÂÃÂ©)</label>
        ...
        <div>
          <label style={labelStyle}>Note (privÃÂÃÂ©e)</label>
          <input style={inputStyle} value={note} onChange={e => setNote(e.target.value)} placeholder="ex: Pour Khalid - lancement" />
        </div>
        {err && <div style={errStyle}>{err}</div>}
        {msg && <div style={{ padding: '8px 12px', borderRadius: 10, background: '#F0FDF4', border: '1px solid #BBF7D0', color: '#065F46', fontSize: 12, fontWeight: 700 }}>ÃÂ¢ÃÂÃÂ {msg}</div>}
        <button onClick={handleCreate} disabled={busy}
          style={{ ...btn, background: '#92400E', opacity: busy ? 0.7 : 1, marginTop: 4 }}>
          {busy ? 'CrÃÂÃÂ©ation...' : 'ÃÂ¢ÃÂÃÂ CrÃÂÃÂ©er le code'}
        </button>
      </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    {!c.active && <span style={{ fontSize: 10, color: '#DC2626', fontWeight: 700 }}>DÃÂÃÂSACTIVÃÂÃÂ</span>}
                  </div>
                  <div style={{ fontSize: 10, color: '#6B7280', marginTop: 4 }}>
                    UtilisÃÂÃÂ© {c.usedCount}{c.maxUses ? `/${c.maxUses}` : ''} fois
                    {c.expiresAt ? ` ÃÂÃÂ· expire ${new Date(c.expiresAt).toLocaleDateString('fr-FR')}` : ''}
                  </div>
                  {c.note && <div style={{ fontSize: 10, color: '#9CA3AF', marginTop: 2, fontStyle: 'italic' }}>{c.note}</div>}
                </div>
                <div style={{ display: 'flex', gap: 4 }}>
                  <button onClick={() => { navigator.clipboard.writeText(c.code); setMsg(`${c.code} copiÃÂÃÂ© !`); setTimeout(()=>setMsg(''), 2000); }}
                  ...
                  <button onClick={() => handleToggle(c.code)}
                    ...
                    {c.active ? 'ÃÂ¢ÃÂÃÂ¸' : 'ÃÂ¢ÃÂÃÂ¶'}
                  </button>
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Missions / Pub page ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
const MISSION_T = {
  fr: {
    title:'ÃÂ°ÃÂÃÂÃÂ Gagner des diamants', sub:'Regarde des pubs, fais des missions',
    today:"AUJOURD'HUI", dailyCap:'Plafond journalier', of:'sur',
    capReached:'ÃÂ°ÃÂÃÂÃÂ Plafond atteint ! Revenez demain.',
    authNudge:'ÃÂ°ÃÂÃÂÃÂ Connecte-toi pour encaisser tes rÃÂÃÂ©compenses ÃÂ¢ÃÂÃÂ',
    cats:{ video:'ÃÂ°ÃÂÃÂÃÂ¬ PublicitÃÂÃÂ©s vidÃÂÃÂ©o', offerwall:'ÃÂ°ÃÂÃÂÃÂ± Jeux & Offres', social:'ÃÂ°ÃÂÃÂÃÂ£ RÃÂÃÂ©seaux sociaux', survey:'ÃÂ°ÃÂÃÂÃÂ Sondages', fortune:'ÃÂ°ÃÂÃÂÃÂ¡ Roue de la fortune' },
    topBadge:'ÃÂ¢ÃÂ­ÃÂ TOP', timesToday:(c:number,m:number)=>`${c}/${m} fois aujourd'hui`,
    adTitle:'PUBLICITÃÂÃÂ SPONSORISÃÂÃÂE', adWatching:'Visionnage de la publicitÃÂÃÂ© en coursÃÂ¢ÃÂÃÂ¦',
    fortuneRunning:'Roue de la fortune en coursÃÂ¢ÃÂÃÂ¦', waitSec:(s:number)=>`Patiente encore ${s}sÃÂ¢ÃÂÃÂ¦`,
    claim:(d:number)=>`ÃÂ°ÃÂÃÂÃÂ RÃÂÃÂ©clamer ${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`, cancel:'Annuler',
    socialOpened:"La page s'est ouverte dans un nouvel onglet. Effectue l'action puis confirme.",
    socialWait:'ÃÂ¢ÃÂÃÂ³ Attends quelques secondesÃÂ¢ÃÂÃÂ¦',
    socialClaim:(d:number)=>`ÃÂ¢ÃÂÃÂ C'est fait ÃÂ¢ÃÂÃÂ RÃÂÃÂ©clamer ${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`,
    done:'ÃÂ¢ÃÂÃÂ Fait', offerwallTip:'ÃÂ°ÃÂÃÂÃÂ¡ IntÃÂÃÂ©gration Lootably / Offertoro : renseigne',
    offerwallTip2:'dans main.tsx pour afficher l\'offerwall ici.',
    errLogin:'Connecte-toi pour gagner des ÃÂ°ÃÂÃÂÃÂ !', errLimit:'Limite journaliÃÂÃÂ¨re atteinte',
    errDone:'DÃÂÃÂ©jÃÂÃÂ  effectuÃÂÃÂ© !', errNet:'Erreur rÃÂÃÂ©seau', credited:(d:number,h:string)=>`+${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ crÃÂÃÂ©ditÃÂÃÂ©s ! (${h})`,
  },
  en: {
    title:'ÃÂ°ÃÂÃÂÃÂ Earn Diamonds', sub:'Watch ads, complete missions',
    today:'TODAY', dailyCap:'Daily cap', of:'/',
    capReached:'ÃÂ°ÃÂÃÂÃÂ Daily cap reached! Come back tomorrow.',
    authNudge:'ÃÂ°ÃÂÃÂÃÂ Sign in to claim your rewards ÃÂ¢ÃÂÃÂ',
    cats:{ video:'ÃÂ°ÃÂÃÂÃÂ¬ Video Ads', offerwall:'ÃÂ°ÃÂÃÂÃÂ± Games & Offers', social:'ÃÂ°ÃÂÃÂÃÂ£ Social Media', survey:'ÃÂ°ÃÂÃÂÃÂ Surveys', fortune:'ÃÂ°ÃÂÃÂÃÂ¡ Wheel of Fortune' },
    topBadge:'ÃÂ¢ÃÂ­ÃÂ TOP', timesToday:(c:number,m:number)=>`${c}/${m} today`,
    adTitle:'SPONSORED AD', adWatching:'Watching the adÃÂ¢ÃÂÃÂ¦',
    fortuneRunning:'Spinning the wheelÃÂ¢ÃÂÃÂ¦', waitSec:(s:number)=>`Wait ${s}s moreÃÂ¢ÃÂÃÂ¦`,
    claim:(d:number)=>`ÃÂ°ÃÂÃÂÃÂ Claim ${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`, cancel:'Cancel',
    socialOpened:'The page opened in a new tab. Complete the action then confirm.',
    socialWait:'ÃÂ¢ÃÂÃÂ³ Wait a few secondsÃÂ¢ÃÂÃÂ¦',
    socialClaim:(d:number)=>`ÃÂ¢ÃÂÃÂ Done ÃÂ¢ÃÂÃÂ Claim ${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`,
    done:'ÃÂ¢ÃÂÃÂ Done', offerwallTip:'ÃÂ°ÃÂÃÂÃÂ¡ Lootably / Offertoro integration: set',
    offerwallTip2:'in main.tsx to show the offerwall here.',
    errLogin:'Sign in to earn ÃÂ°ÃÂÃÂÃÂ!', errLimit:'Daily limit reached',
    errDone:'Already done!', errNet:'Network error', credited:(d:number,h:string)=>`+${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ credited! (${h})`,
  },
  ar: {
    title:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ³ÃÂÃÂ¨ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂ§ÃÂÃÂª', sub:'ÃÂÃÂ´ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¥ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂ ÃÂÃÂ£ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ² ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂ',
    today:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ', dailyCap:'ÃÂÃÂ§ÃÂÃÂÃÂÃÂ­ÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ', of:'ÃÂÃÂÃÂÃÂ',
    capReached:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂª ÃÂÃÂÃÂÃÂÃÂÃÂ­ÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ! ÃÂÃÂ¹ÃÂÃÂ¯ ÃÂÃÂºÃÂÃÂ¯ÃÂÃÂ§ÃÂÃÂ.',
    authNudge:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ³ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ®ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ­ÃÂÃÂµÃÂÃÂÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ¢ÃÂÃÂªÃÂÃÂ ÃÂ¢ÃÂÃÂ',
    cats:{ video:'ÃÂ°ÃÂÃÂÃÂ¬ ÃÂÃÂ¥ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂÃÂª ÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ', offerwall:'ÃÂ°ÃÂÃÂÃÂ± ÃÂÃÂ£ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ§ÃÂÃÂ¨ ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ±ÃÂÃÂÃÂÃÂ¶', social:'ÃÂ°ÃÂÃÂÃÂ£ ÃÂÃÂ´ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ§ÃÂÃÂª ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂÃÂÃÂ§ÃÂÃÂµÃÂÃÂ', survey:'ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂ³ÃÂÃÂªÃÂÃÂ·ÃÂÃÂÃÂÃÂ§ÃÂÃÂ¹ÃÂÃÂ§ÃÂÃÂª', fortune:'ÃÂ°ÃÂÃÂÃÂ¡ ÃÂÃÂ¹ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂ­ÃÂÃÂ¸' },
    topBadge:'ÃÂ¢ÃÂ­ÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ£ÃÂÃÂÃÂÃÂ¶ÃÂÃÂ', timesToday:(c:number,m:number)=>`${c}/${m} ÃÂÃÂÃÂÃÂ±ÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ`,
    adTitle:'ÃÂÃÂ¥ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ', adWatching:'ÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂÃÂÃÂ´ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¥ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂ¢ÃÂÃÂ¦',
    fortuneRunning:'ÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂ±ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂÃÂ¢ÃÂÃÂ¦', waitSec:(s:number)=>`ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ¸ÃÂÃÂ± ${s}ÃÂÃÂ«ÃÂ¢ÃÂÃÂ¦`,
    claim:(d:number)=>`ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂ­ÃÂÃÂµÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ ${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`, cancel:'ÃÂÃÂ¥ÃÂÃÂÃÂÃÂºÃÂÃÂ§ÃÂÃÂ¡',
    socialOpened:'ÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂ­ÃÂÃÂª ÃÂÃÂ§ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂ­ÃÂÃÂ© ÃÂÃÂÃÂÃÂ ÃÂÃÂªÃÂÃÂ¨ÃÂÃÂÃÂÃÂÃÂÃÂ¨ ÃÂÃÂ¬ÃÂÃÂ¯ÃÂÃÂÃÂÃÂ¯. ÃÂÃÂ£ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ² ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¥ÃÂÃÂ¬ÃÂÃÂ±ÃÂÃÂ§ÃÂÃÂ¡ ÃÂÃÂ«ÃÂÃÂ ÃÂÃÂ£ÃÂÃÂÃÂÃÂÃÂÃÂ¯.',
    socialWait:'ÃÂ¢ÃÂÃÂ³ ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ¸ÃÂÃÂ± ÃÂÃÂ«ÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂ¦',
    socialClaim:(d:number)=>`ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂ ÃÂ¢ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂ­ÃÂÃÂµÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ ${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`,
    done:'ÃÂ¢ÃÂÃÂ ÃÂÃÂªÃÂÃÂ', offerwallTip:'ÃÂ°ÃÂÃÂÃÂ¡ ÃÂÃÂªÃÂÃÂÃÂÃÂ§ÃÂÃÂÃÂÃÂ Lootably: ÃÂÃÂ§ÃÂÃÂ¶ÃÂÃÂ¨ÃÂÃÂ·',
    offerwallTip2:'ÃÂÃÂÃÂÃÂ main.tsx ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ±ÃÂÃÂ¶ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¹ÃÂÃÂ±ÃÂÃÂÃÂÃÂ¶ ÃÂÃÂÃÂÃÂÃÂÃÂ§.',
    errLogin:'ÃÂÃÂ³ÃÂÃÂ¬ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ¯ÃÂÃÂ®ÃÂÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂ¨ ÃÂ°ÃÂÃÂÃÂ!', errLimit:'ÃÂÃÂÃÂÃÂµÃÂÃÂÃÂÃÂª ÃÂÃÂÃÂÃÂÃÂÃÂ­ÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ',
    errDone:'ÃÂÃÂªÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ¬ÃÂÃÂ§ÃÂÃÂ²ÃÂÃÂ ÃÂÃÂ¨ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ¹ÃÂÃÂ!', errNet:'ÃÂÃÂ®ÃÂÃÂ·ÃÂÃÂ£ ÃÂÃÂÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ´ÃÂÃÂ¨ÃÂÃÂÃÂÃÂ©', credited:(d:number,h:string)=>`+${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂÃÂÃÂÃÂÃÂ¶ÃÂÃÂ§ÃÂÃÂÃÂÃÂ©! (${h})`,
  },
  amz: {
    title:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', sub:'ÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ³ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂ ÃÂÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    today:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ°', dailyCap:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', of:'/',
    capReached:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ! ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ.',
    authNudge:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ',
    cats:{ video:'ÃÂ°ÃÂÃÂÃÂ¬ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ³ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂ', offerwall:'ÃÂ°ÃÂÃÂÃÂ± ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂ', social:'ÃÂ°ÃÂÃÂÃÂ£ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂ', survey:'ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', fortune:'ÃÂ°ÃÂÃÂÃÂ¡ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ°' },
    topBadge:'ÃÂ¢ÃÂ­ÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ', timesToday:(c:number,m:number)=>`${c}/${m} ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ°`,
    adTitle:'ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', adWatching:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¥ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂÃÂ¦',
    fortuneRunning:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂ´ÃÂ³ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂÃÂ¦', waitSec:(s:number)=>`ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂµÃÂ ${s}ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂÃÂ¦`,
    claim:(d:number)=>`ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂ ${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`, cancel:'ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂ',
    socialOpened:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂ´ÃÂ³ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ±ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ. ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ.',
    socialWait:'ÃÂ¢ÃÂÃÂ³ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¹ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂÃÂ¦',
    socialClaim:(d:number)=>`ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂ ${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`,
    done:'ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ', offerwallTip:'ÃÂ°ÃÂÃÂÃÂ¡ Lootably: ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ¼ÃÂ¢ÃÂµÃÂ',
    offerwallTip2:'ÃÂ¢ÃÂ´ÃÂ³ main.tsx ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ£ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ.',
    errLogin:'ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ· ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂ´ÃÂ° ÃÂ°ÃÂÃÂÃÂ!', errLimit:'ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ° ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ¡ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ',
    errDone:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂ!', errNet:'ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂ ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂÃÂ¢ÃÂ´ÃÂ½ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ¢ÃÂ¢ÃÂµÃÂ', credited:(d:number,h:string)=>`+${d.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ·ÃÂ¢ÃÂ´ÃÂ°ÃÂ¢ÃÂµÃÂÃÂ¢ÃÂµÃÂ! (${h})`,
  },
};
...
function MissionsPage() {
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Video / Fortune mission flow ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  // ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Social mission flow ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
  ...
  return (
    <div style={S.page}>
      {/* Header */}
      <div style={S.header}>
        <button style={S.back} onClick={() => navigate('/')}>{isAR ? 'ÃÂ¢ÃÂÃÂ' : 'ÃÂ¢ÃÂÃÂ'}</button>
        <div style={{ flex: 1 }}>
        ...
        <div style={{ background: 'rgba(16,185,129,0.12)', border: '1px solid rgba(16,185,129,0.3)', borderRadius: 12, padding: '6px 12px', textAlign: 'center' }}>
          <div style={{ fontSize: 13, fontWeight: 900, color: '#10b981' }}>{todayDiamonds.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ</div>
      ...
      <div style={{ padding: '14px 16px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6, fontSize: 11, color: '#94a3b8' }}>
          ...
          <span style={{ fontWeight: 800, color: pct >= 100 ? '#10b981' : '#f59e0b' }}>
            {todayDiamonds.toLocaleString()} {t.of} {DAILY_CAP.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ
          </span>
        </div>
                  ...
                  <div key={mission.id} style={{ ...S.card(top), opacity: maxed ? 0.45 : 1 }}
                    ...
                    <div style={{ textAlign: isAR ? 'left' : 'right', flexShrink: 0 }}>
                      <div style={S.pill(maxed)}>
                        {maxed ? t.done : `+${mission.rewardDiamonds >= 1000 ? (mission.rewardDiamonds/1000).toFixed(0)+'K' : mission.rewardDiamonds} ÃÂ°ÃÂÃÂÃÂ`}
                      </div>
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.92)', zIndex: 200, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
          <div style={{ width: '100%', maxWidth: 360, background: 'linear-gradient(135deg,#1e293b,#0f172a)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, overflow: 'hidden', marginBottom: 20 }}>
            ...
            <div style={{ height: 180, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12, padding: 20 }}>
              <div style={{ fontSize: 48 }}>{adMission.type === 'fortune' ? 'ÃÂ°ÃÂÃÂÃÂ¡' : 'ÃÂ°ÃÂÃÂÃÂ¬'}</div>
...
function AdminAuthPage() {
  ...
  const callApi = async (path: string) => {
    ...
    try {
      ...
      return data;
    } catch { setError('Erreur rÃÂÃÂ©seau.'); return null; }
  ...
  const handleBan = async () => {
    if (!email.trim() || !adminKey.trim()) { setError('Email et clÃÂÃÂ© admin requis.'); return; }
    if (!window.confirm(`Bannir dÃÂÃÂ©finitivement ${email} ? Il ne pourra plus se connecter ni se rÃÂÃÂ©inscrire.`)) return;
  ...
  const handleUnban = async () => {
    ...
    if (data?.ok) setSuccess(data.message || 'Utilisateur dÃÂÃÂ©banni.');
  };

  const handleDelete = async () => {
    if (!email.trim() || !adminKey.trim()) { setError('Email et clÃÂÃÂ© admin requis.'); return; }
    if (!window.confirm(`Supprimer le compte de ${email} ? Il pourra se rÃÂÃÂ©inscrire avec le mÃÂÃÂªme email.`)) return;
    const data = await callApi('/api/admin/delete-user');
    if (data?.ok) setSuccess(data.message || 'Compte supprimÃÂÃÂ©.');
  };

  return (
    <AuthPageWrapper>
      <AuthCardHeader
        title="ÃÂ°ÃÂÃÂÃÂ AccÃÂÃÂ¨s Admin"
        sub="GÃÂÃÂ©nÃÂÃÂ©rez un lien de connexion direct pour un utilisateur"
      />
      <form onSubmit={handleGenerate} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <FocusInput label="ClÃÂÃÂ© admin (code chauffeur)" value={adminKey} onChange={setAdminKey}
      ...
      {link && (
        <div style={{ marginTop: 20, padding: 16, background: '#F0FDF4', borderRadius: 12, border: '1px solid #BBF7D0' }}>
          <p style={{ fontSize: 11, fontWeight: 800, color: '#065F46', marginBottom: 8, letterSpacing: '0.08em' }}>
            ÃÂ¢ÃÂÃÂ LIEN VALABLE 1 HEURE
          </p>
          ...
          <button
            ...
            ÃÂ°ÃÂÃÂÃÂ Copier le lien
          </button>
          <p style={{ fontSize: 10, color: '#9CA3AF', marginTop: 8, textAlign: 'center' }}>
            Envoyez ce lien ÃÂÃÂ  l'utilisateur via WhatsApp ÃÂ¢ÃÂÃÂ il se connectera automatiquement
          </p>
        </div>
      )}
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ FLOATING WHATSAPP BUTTON ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ

function FloatingWAButton() {
  const [location] = useLocation();
  if (location === '/assistant') return null;
  const msg = encodeURIComponent('Bonjour Bridge Safi, j\'ai besoin d\'aide ÃÂ°ÃÂÃÂÃÂ');
  return (
    <a
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ FLOATING AI ASSISTANT WIDGET ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
function FloatingAssistantWidget() {
  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'assistant', content: 'ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Service temporairement indisponible.' }]);
    } finally { setLoading(false); }
  };
  ...
  return (
    <>
      ...
      {/* Floating bubble ÃÂ¢ÃÂÃÂ sits above WhatsApp button */}
              ...
              <div key={idx} style={{display:'flex',justifyContent:msg.role==='user'?'flex-end':'flex-start',marginBottom:9}}>
                {msg.role==='assistant'&&(
                  <div style={{width:24,height:24,borderRadius:'50%',
                    background:'linear-gradient(135deg,#4f46e5,#7c3aed)',
                    display:'flex',alignItems:'center',justifyContent:'center',
                    flexShrink:0,marginRight:7,marginTop:3,fontSize:11}}>ÃÂ¢ÃÂÃÂ¦</div>
                )}
            ...
            {loading&&(
              <div style={{display:'flex',alignItems:'center',gap:7,marginBottom:9}}>
                <div style={{width:24,height:24,borderRadius:'50%',background:'linear-gradient(135deg,#4f46e5,#7c3aed)',
                  display:'flex',alignItems:'center',justifyContent:'center',fontSize:11}}>ÃÂ¢ÃÂÃÂ¦</div>
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Leaderboard Page ÃÂ¢ÃÂÃÂ classement synchronisÃÂÃÂ© avec le Manager ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
function LeaderboardPage() {
  ...
  const medalEmoji = (i: number) => i === 0 ? 'ÃÂ°ÃÂÃÂ¥ÃÂ' : i === 1 ? 'ÃÂ°ÃÂÃÂ¥ÃÂ' : i === 2 ? 'ÃÂ°ÃÂÃÂ¥ÃÂ' : `${i + 1}.`;
  ...
  return (
    <div style={{minHeight:'100vh',background:'linear-gradient(180deg,#04110A 0%,#071C11 60%,#050F08 100%)',color:'white'}}>
      ...
      <div style={{background:'rgba(0,0,0,0.4)',backdropFilter:'blur(12px)',padding:'14px 20px',display:'flex',alignItems:'center',gap:12,borderBottom:'1px solid rgba(74,222,128,0.15)',position:'sticky',top:0,zIndex:10}}>
        <button onClick={()=>navigate('/game')} style={{background:'none',border:'none',color:'#4ADE80',fontSize:20,cursor:'pointer',padding:'4px',lineHeight:1}}>ÃÂ¢ÃÂÃÂ</button>
        <div>
          <div style={{fontSize:'17px',fontWeight:900,letterSpacing:'0.05em'}}>ÃÂ°ÃÂÃÂÃÂ Classement Safi Runner</div>
          <div style={{fontSize:'11px',color:'rgba(255,255,255,0.4)',marginTop:'1px'}}>SynchronisÃÂÃÂ© avec le Manager ÃÂÃÂ· Objectif : {GAME_TARGET.toLocaleString()} ÃÂ°ÃÂÃÂÃÂ</div>
        </div>
      </div>
        ...
        <div style={{margin:'16px 16px 0',background:'linear-gradient(135deg,rgba(74,222,128,0.12),rgba(5,150,105,0.08))',border:'1px solid rgba(74,222,128,0.3)',borderRadius:'16px',padding:'14px 16px'}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:10}}>
            ...
            <div style={{textAlign:'right'}}>
              <div style={{fontSize:22,fontWeight:900,color:'#4ADE80'}}>{(myPlayer.diamonds||0).toLocaleString()} ÃÂ°ÃÂÃÂÃÂ</div>
          ...
          <div style={{display:'flex',justifyContent:'space-between',marginTop:6,fontSize:11,color:'rgba(255,255,255,0.4)'}}>
            <span>{(myPlayer.diamonds||0).toLocaleString()} ÃÂ°ÃÂÃÂÃÂ gagnÃÂÃÂ©s</span>
            <span>{((myPlayer.missing||0)).toLocaleString()} ÃÂ°ÃÂÃÂÃÂ manquants</span>
          </div>
          {(myPlayer.missing||0) > 0 && (
            <div style={{marginTop:8,padding:'8px 10px',background:'rgba(239,68,68,0.12)',borderRadius:'8px',border:'1px solid rgba(239,68,68,0.2)',fontSize:12,color:'#FCA5A5'}}>
              ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Il manque {(myPlayer.missing||0).toLocaleString()} ÃÂ°ÃÂÃÂÃÂ ÃÂ¢ÃÂÃÂ pÃÂÃÂ©nalitÃÂÃÂ© estimÃÂÃÂ©e : <strong>{myPlayer.amountMAD} DH</strong>
            </div>
          )}
          {(myPlayer.missing||0) <= 0 && (
            <div style={{marginTop:8,padding:'8px 10px',background:'rgba(74,222,128,0.1)',borderRadius:'8px',border:'1px solid rgba(74,222,128,0.2)',fontSize:12,color:'#4ADE80'}}>
              ÃÂ°ÃÂÃÂÃÂ Objectif atteint ! Prochaine livraison <strong>GRATUITE</strong> ÃÂ°ÃÂÃÂÃÂ
            </div>
          )}
        </div>
      )}
      ...
      <div style={{margin:'12px 16px 0',background:'rgba(255,255,255,0.03)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:'12px',padding:'10px 14px',fontSize:12,color:'rgba(255,255,255,0.5)',lineHeight:1.6}}>
        ÃÂ°ÃÂÃÂÃÂ <strong style={{color:'rgba(255,255,255,0.7)'}}>RÃÂÃÂ¨gles :</strong> 3 jours ÃÂÃÂ 2h/jour ÃÂÃÂ· 6 000 ÃÂ°ÃÂÃÂÃÂ par heure ÃÂÃÂ· Objectif : 60 000 ÃÂ°ÃÂÃÂÃÂ ÃÂÃÂ· Manque 10 000 ÃÂ°ÃÂÃÂÃÂ = 5 DH de pÃÂÃÂ©nalitÃÂÃÂ©
      </div>
      ...
      <div style={{padding:'12px 16px 40px'}}>
        ...
        {!loading && players.length === 0 && (
          <div style={{textAlign:'center',padding:'60px 20px',color:'rgba(255,255,255,0.35)'}}>
            ...
            <p>Aucun joueur enregistrÃÂÃÂ©</p>
          </div>
        )}
            ...
            <div key={p.id} style={{background:isMe?'rgba(74,222,128,0.08)':'rgba(255,255,255,0.03)',border:`1px solid ${isMe?'rgba(74,222,128,0.3)':'rgba(255,255,255,0.06)'}`,borderRadius:'14px',padding:'12px 14px',marginBottom:'8px'}}>
              <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:8}}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  ...
                  <div style={{fontSize:11,color:'rgba(255,255,255,0.4)',marginTop:1}}>{p.gamesPlayed} parties jouÃÂÃÂ©es</div>
                </div>
                <div style={{textAlign:'right',flexShrink:0}}>
                  <div style={{fontWeight:900,fontSize:15,color:pct>=100?'#4ADE80':'white'}}>{(p.diamonds||0).toLocaleString()} ÃÂ°ÃÂÃÂÃÂ</div>
                  <div style={{fontSize:10,color:pct>=100?'#4ADE80':p.missing>0?'#FCA5A5':'rgba(255,255,255,0.4)',marginTop:1}}>
                    {pct>=100 ? 'ÃÂ¢ÃÂÃÂ Objectif atteint' : `ÃÂ¢ÃÂÃÂ${(p.missing||0).toLocaleString()} ÃÂ°ÃÂÃÂÃÂ`}
                  </div>
                </div>
              </div>
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Store Owner Page (Tabac / Pharmacie / Fleurs) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
const STORE_INFO: Record<StoreType, {name:string;emoji:string;accent:string}> = {
  tabac:     { name:'Bridge Tabac',     emoji:'ÃÂ°ÃÂÃÂÃÂ¬', accent:'#e94560' },
  pharmacie: { name:'Bridge Pharmacie', emoji:'ÃÂ°ÃÂÃÂÃÂ', accent:'#8B5CF6' },
  fleurs:    { name:'Bridge Fleurs',    emoji:'ÃÂ°ÃÂÃÂÃÂ¸', accent:'#EC4899' },
};
function StoreOwnerPage({ params }: { params?: { type?: string } }) {
    ...
    return (
      <div style={{minHeight:'100vh',background:'#0a0a1a',display:'flex',alignItems:'center',justifyContent:'center',padding:'24px'}}>
        <div style={{background:'#161630',borderRadius:'20px',padding:'40px 32px',maxWidth:'360px',width:'100%',textAlign:'center'}}>
          ...
          <p style={{color:'rgba(255,255,255,0.45)',fontSize:'13px',marginBottom:'32px'}}>Espace propriÃÂÃÂ©taire</p>
          <input type="password" placeholder="Code d'accÃÂÃÂ¨s" value={code}
          ...
          <button onClick={handleLogin} disabled={authLoading || !code}
            ...
            {authLoading ? 'VÃÂÃÂ©rification...' : 'AccÃÂÃÂ©der ÃÂ¢ÃÂÃÂ'}
          </button>
        </div>
      </div>
    );
  ...
  const statusLabel: Record<string,string> = { pending:'ÃÂ¢ÃÂÃÂ³ En attente', accepted:'ÃÂ¢ÃÂÃÂ AcceptÃÂÃÂ©', preparing:'ÃÂ°ÃÂÃÂÃÂ¨ÃÂ¢ÃÂÃÂÃÂ°ÃÂÃÂÃÂ³ En prÃÂÃÂ©paration', ready:'ÃÂ°ÃÂÃÂÃÂ¦ PrÃÂÃÂªt', delivered:'ÃÂ°ÃÂÃÂÃÂ LivrÃÂÃÂ©', cancelled:'ÃÂ¢ÃÂÃÂ AnnulÃÂÃÂ©' };
  ...
  const OrderCard = ({ order }: { order: StoreOrder }) => (
    <div style={{background:'rgba(255,255,255,0.05)',borderRadius:'16px',padding:'16px',marginBottom:'12px',border:`2px solid ${order.status==='pending'?info.accent:'rgba(255,255,255,0.05)'}`}}>
      ...
      <p style={{color:'rgba(255,255,255,0.55)',fontSize:'13px',margin:'0 0 3px'}}>ÃÂ°ÃÂÃÂÃÂ {order.customerPhone}</p>
      <p style={{color:'rgba(255,255,255,0.55)',fontSize:'13px',margin:'0 0 10px'}}>ÃÂ°ÃÂÃÂÃÂ {order.customerAddress}</p>
        ...
        <div style={{background:'rgba(0,0,0,0.3)',borderRadius:'10px',padding:'10px',marginBottom:'10px'}}>
          {order.items.map((item,i) => (
            <div key={i} style={{display:'flex',justifyContent:'space-between',fontSize:'13px',color:'rgba(255,255,255,0.8)',marginBottom:'3px'}}>
              <span>{item.name} ÃÂÃÂ{item.qty}</span><span>{(item.price*item.qty).toFixed(0)} DH</span>
            </div>
          ))}
      ...
      <p style={{color:'rgba(255,255,255,0.4)',fontSize:'12px',margin:'0 0 10px'}}>ÃÂ°ÃÂÃÂÃÂ³ {order.paymentMethod} ÃÂÃÂ· {statusLabel[order.status]||order.status}</p>
      <div style={{display:'flex',gap:'8px',flexWrap:'wrap'}}>
        {order.status==='pending' && <>
          <button onClick={()=>updateStatus(order.ref,'accepted')} style={{flex:1,padding:'9px 12px',borderRadius:'8px',border:'none',background:'#22c55e',color:'white',fontSize:'13px',fontWeight:'600',cursor:'pointer'}}>ÃÂ¢ÃÂÃÂ Accepter</button>
          <button onClick={()=>updateStatus(order.ref,'cancelled')} style={{padding:'9px 14px',borderRadius:'8px',border:'none',background:'#ef4444',color:'white',fontSize:'13px',fontWeight:'600',cursor:'pointer'}}>ÃÂ¢ÃÂÃÂ</button>
        </>}
        {order.status==='accepted' && <button onClick={()=>updateStatus(order.ref,'preparing')} style={{flex:1,padding:'9px',borderRadius:'8px',border:'none',background:'#f59e0b',color:'white',fontSize:'13px',fontWeight:'600',cursor:'pointer'}}>ÃÂ°ÃÂÃÂÃÂ¨ÃÂ¢ÃÂÃÂÃÂ°ÃÂÃÂÃÂ³ En prÃÂÃÂ©paration</button>}
        {order.status==='preparing' && <button onClick={()=>updateStatus(order.ref,'ready')} style={{flex:1,padding:'9px',borderRadius:'8px',border:'none',background:'#8B5CF6',color:'white',fontSize:'13px',fontWeight:'600',cursor:'pointer'}}>ÃÂ°ÃÂÃÂÃÂ¦ PrÃÂÃÂªt pour livraison</button>}
        {order.status==='ready' && <button onClick={()=>updateStatus(order.ref,'delivered')} style={{flex:1,padding:'9px',borderRadius:'8px',border:'none',background:'#06b6d4',color:'white',fontSize:'13px',fontWeight:'600',cursor:'pointer'}}>ÃÂ°ÃÂÃÂÃÂ MarquÃÂÃÂ© livrÃÂÃÂ©</button>}
      </div>
    </div>
  );
      ...
      <div style={{background:'#161630',padding:'14px 20px',display:'flex',justifyContent:'space-between',alignItems:'center',borderBottom:'1px solid rgba(255,255,255,0.08)',position:'sticky',top:0,zIndex:10}}>
        <div>
          ...
          <div style={{fontSize:'12px',marginTop:'2px'}}>
            {pending.length>0 ? <span style={{color:'#ef4444',fontWeight:'600'}}>ÃÂ°ÃÂÃÂÃÂ´ {pending.length} nouvelle{pending.length>1?'s':''} commande{pending.length>1?'s':''}</span> : <span style={{color:'rgba(255,255,255,0.4)'}}>Aucune commande en attente</span>}
          </div>
        </div>
        <button onClick={logout} style={{padding:'7px 13px',borderRadius:'9px',border:'1px solid rgba(255,255,255,0.15)',background:'transparent',color:'rgba(255,255,255,0.6)',fontSize:'12px',cursor:'pointer'}}>DÃÂÃÂ©connexion</button>
      </div>
      <div style={{padding:'16px',maxWidth:'580px',margin:'0 auto'}}>
        {pending.length>0 && <div style={{marginBottom:'24px'}}><h2 style={{color:'#ef4444',fontSize:'14px',fontWeight:'700',marginBottom:'12px',textTransform:'uppercase',letterSpacing:'0.5px'}}>ÃÂ¢ÃÂÃÂ¡ Nouvelles commandes ({pending.length})</h2>{pending.map(o=><OrderCard key={o.ref} order={o}/>)}</div>}
        {active.length>0 && <div style={{marginBottom:'24px'}}><h2 style={{color:'#f59e0b',fontSize:'14px',fontWeight:'700',marginBottom:'12px',textTransform:'uppercase',letterSpacing:'0.5px'}}>ÃÂ°ÃÂÃÂÃÂ En cours ({active.length})</h2>{active.map(o=><OrderCard key={o.ref} order={o}/>)}</div>}
        {done.length>0 && <div><h2 style={{color:'rgba(255,255,255,0.35)',fontSize:'14px',fontWeight:'700',marginBottom:'12px',textTransform:'uppercase',letterSpacing:'0.5px'}}>TerminÃÂÃÂ©es</h2>{done.map(o=><OrderCard key={o.ref} order={o}/>)}</div>}
        {orders.length===0 && <div style={{textAlign:'center',padding:'70px 20px',color:'rgba(255,255,255,0.35)'}}><div style={{fontSize:'52px',marginBottom:'14px'}}>{info.emoji}</div><p style={{fontSize:'16px'}}>Aucune commande pour l'instant</p><p style={{fontSize:'13px',marginTop:'6px'}}>Les nouvelles commandes apparaÃÂÃÂ®tront automatiquement</p></div>}
      </div>
    </div>
  );
}
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Visit tracker (fire once per session) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
(() => {
  try {
