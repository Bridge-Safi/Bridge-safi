...
const _MKT_RESIZE_T='W3sicmVzaXplIjp7Im1vZGUiOiJmaXQiLCJ3aWR0aCI6MzIwLCJoZWlnaHQiOjMyMH19LHsid2VicCI6e319XQ==';
// Décompresse une réf photo produit scrapée (préfixe G:/P:/M:, ou 'X'/'' si pas de photo)
// en URL Glovo CDN complète. G = global-catalog-glovo, P = pim-glovo, M = menus-glovo/products.
const _mktImg=(ref?:string):string=>{
  if(!ref||ref==='X') return '';
  const prefix=ref.charAt(0); const rest=ref.slice(2);
  if(prefix==='M') return _gp(rest);
  if(prefix==='G') return `https://glovo.dhmedia.io/image/global-catalog-glovo/nv-global-catalog/aa/${rest}?t=${_MKT_RESIZE_T}`;
  if(prefix==='P') return `https://glovo.dhmedia.io/image/pim-glovo/${rest}?t=${_MKT_RESIZE_T}`;
  return '';
};
...
const RESTAURANTS: Restaurant[] = [
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"burgers_6",emoji:"\\ud83c\\udf54",names:_n("Burgers"),items:[
        ...
        {id:"food_6_1",names:_n("Big burger"),price:46,photo:_gp("0812c6a3c3e8d79ebefb511aba9790098929d7f5eb6cd5208e1750ba209572ad")},
        {id:"food_6_2",names:_n("Duo burger"),price:43,photo:_gp("")},
        {id:"food_6_3",names:_n("Cheese Burger"),price:35,photo:_gp("8bead6c2da3fa3d766b366a514fe2c69434b98113e7698f5187044b8e946cc90")},
        {id:"food_6_4",names:_n("Chiken burger"),price:33,photo:_gp("c263918396a7e73e4bd12908df6567ba255110be79fdf9bf24cc8dfb5ca3e1e1")},
      ]},
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"crpes_9",emoji:"\\ud83e\\udd5e",names:_n("Crêpes"),items:[
        ...
        {id:"bubb_9_10",names:_n("Crêpe nutella"),price:29,photo:_gp("729db543dd165d09364160454c18787d437e71df35783350022985acbc6b9a21")},
      ]},
      ...
      {id:"jusfrais_15",emoji:"\\ud83e\\uddc3",names:_n("JUS FRAIS"),items:[
        ...
        {id:"bubb_15_3",names:_n("Jus MANGUE"),price:31,photo:_gp("1908d636fa90133933af2bb5966a46d538026c6aae1c98c1f7cae60b4d9687b9")},
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"pizzeriata_5",emoji:"\\ud83c\\udf2e",names:_n("Pizzeria Taco"),items:[
        ...
        {id:"taco_5_1",names:_n("Pizza 4 Fromages"),price:48,photo:_gp("49c790651f338a11b6aa5b5d6d1a2add54d26cb56bd9c373554a7647be355fe9")},
        ...
        {id:"taco_5_5",names:_n("Pizza Thon"),price:39,photo:_gp("a6f149450f04b0796f0b704eb528d59d020c1641484db127bc9f7b138b5053cb")},
        {id:"taco_5_6",names:_n("Pizza Viande Hachée"),price:39,photo:_gp("c8bab7d28a76287509fbf9881dced592ef4556b112def1b34546eb7bacf1c176")},
        {id:"taco_5_7",names:_n("Pizza Poulet"),price:39,photo:_gp("d62a4680568793c57b044e581f358ec5bc5e7c494b3e11e0ee3f5b16c3559fae")},
      ]},
  ...
  },
  {
    ...
    categories:[
      {id:"promotions_0",emoji:"\\ud83c\\udf7d\\ufe0f",names:_n("Promotions"),items:[
        {id:"alib_0_0",names:_n("Pizza Royal"),price:52,photo:_gp("22267271fb0c9eacdbeb4b9a350a92cf7c0be3d9f6ea9f42688b674e3abbe610")},
        {id:"alib_0_1",names:_n("Pizza 4 Saisons"),price:52,photo:_gp("1461c21a4fce9da16624370de0764a22abe275584d614f4a39f58280f09a9d3e")},
      ...
      {id:"salades_2",emoji:"\\ud83e\\udd57",names:_n("Salades"),items:[
        ...
        {id:"alib_2_2",names:_n("Salade Mexicaine"),price:26,photo:_gp("7345b327756926bffc04f6307e9a696f66a337f312631765706b74c1177d81ce")},
        {id:"alib_2_3",names:_n("Salade Niçoise"),price:26,photo:_gp("1edf539064ee899eb3719a1d2d30e05312e47d4ad7e931d41e6d2f992b7cad8b")},
        {id:"alib_2_4",names:_n("Salade Thon"),price:22,photo:_gp("")},
      ]},
      {id:"pizzas_3",emoji:"\\ud83c\\udf55",names:_n("Pizzas"),items:[
        {id:"alib_3_0",names:_n("Pizza Royal"),price:52,photo:_gp("22267271fb0c9eacdbeb4b9a350a92cf7c0be3d9f6ea9f42688b674e3abbe610")},
        {id:"alib_3_1",names:_n("Pizza 4 Saisons"),price:52,photo:_gp("1461c21a4fce9da16624370de0764a22abe275584d614f4a39f58280f09a9d3e")},
        {id:"alib_3_2",names:_n("Pizza Fruits De Mer"),price:48,photo:_gp("f5380597fbdcf4aabb621a0673db0cb00ebab34c08252767c1dbbc1ddedfd310")},
        {id:"alib_3_3",names:_n("Pizza 4 Fromages"),price:39,photo:_gp("49c790651f338a11b6aa5b5d6d1a2add54d26cb56bd9c373554a7647be355fe9")},
        {id:"alib_3_4",names:_n("Pizza Poulet"),price:39,photo:_gp("d62a4680568793c57b044e581f358ec5bc5e7c494b3e11e0ee3f5b16c3559fae")},
        {id:"alib_3_5",names:_n("Pizza Viande Hachée"),price:39,photo:_gp("c8bab7d28a76287509fbf9881dced592ef4556b112def1b34546eb7bacf1c176")},
        {id:"alib_3_6",names:_n("Pizza Cozamia"),price:39,photo:_gp("")},
        {id:"alib_3_7",names:_n("Pizza Végétarienne"),price:39,photo:_gp("350b2e7bb589c372e3658f9d41361e7d819b1cc7ec53024ab852b714ec472b73")},
        {id:"alib_3_8",names:_n("Pizza Thon"),price:39,photo:_gp("a6f149450f04b0796f0b704eb528d59d020c1641484db127bc9f7b138b5053cb")},
        {id:"alib_3_9",names:_n("Pizza Calzone"),price:39,photo:_gp("")},
        {id:"alib_3_10",names:_n("Pizza Margherita"),price:26,photo:_gp("062e7c2b19e72258d006573e350c430bd4621a80619dd205a078d6081efe5dc5")},
      ]},
      {id:"tacos_4",emoji:"\\ud83c\\udf2e",names:_n("Tacos"),items:[
        {id:"alib_4_0",names:_n("Tacos Viande Hachée"),price:48,photo:_gp("b0b0427f0a1f23f84ba87dc9899e509356612df26e74ee8cfa4192c0f74ae94d")},
        {id:"alib_4_1",names:_n("Tacos Crispy"),price:48,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
        {id:"alib_4_2",names:_n("Tacos Ali Baba"),price:52,photo:_gp("647b3fdff62c6bc88aff89eca6f98b342b15f8f3e0bc5615e426afda1908a73b")},
        {id:"alib_4_3",names:_n("Tacos Mixte"),price:52,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
        {id:"alib_4_4",names:_n("Tacos Shawarma"),price:48,photo:_gp("")},
        {id:"alib_4_5",names:_n("Tacos Cordon Bleu"),price:48,photo:_gp("c9b2b1c28120f477d069c0d7cdc5b34fabac0c7ce7a0f66f4beb0b19b78e003d")},
        {id:"alib_4_6",names:_n("Tacos Dinde"),price:39,photo:_gp("4449f611235ca3cd8919e3341c5fb7d0e2055baa31e8b8214625c13efc27f03a")},
        {id:"alib_4_7",names:_n("Tacos Saucisse"),price:39,photo:_gp("")},
        {id:"alib_4_8",names:_n("Tacos Nuggets"),price:39,photo:_gp("4c81f49caeb4dc710838faab4e589557d6db50df5ea6cb37d78b7e3d3501df6f")},
      ]},
      ...
      {id:"sandwiches_6",emoji:"\\ud83e\\udd59",names:_n("Sandwiches"),items:[
        {id:"alib_6_0",names:_n("Sandwich Fruits De Mer"),price:35,photo:_gp("747ddb2f6e26d126de332a0b8f16cf2f246feda3e89506cc82ae39abb4a9f0e0")},
        {id:"alib_6_1",names:_n("Sandwich Mixte"),price:31,photo:_gp("27f849db9169dcc1b733a10104d3a8c84ea6ee179f9028946e66ebfd08d90b02")},
        {id:"alib_6_2",names:_n("Sandwich Viande Hachée"),price:26,photo:_gp("7abd4cbe065c8a5f7d84b8dc9fe54fbdfa9e92c2b19ad18e2aacc7499392e3c6")},
        {id:"alib_6_3",names:_n("Sandwich Dinde"),price:26,photo:_gp("058601e78d2e23c1633dd6fecef105b00ad4f7aa19f45188a6a6db7f3d3e74d2")},
        {id:"alib_6_4",names:_n("Sandwich Saucisse"),price:26,photo:_gp("")},
        {id:"alib_6_5",names:_n("Sandwich Italien"),price:26,photo:_gp("")},
        {id:"alib_6_6",names:_n("Sandwich Thon Spécial"),price:22,photo:_gp("453aefbec218296d350110e9e3d5b7352092bee2f36a861006bc600dd14b8001")},
        {id:"alib_6_7",names:_n("Sandwich Thon"),price:18,photo:_gp("adcace4e3c8a8dd933bf795a1e2546fdec162f4421d6f73bfbc73cabc381d487")},
      ...
      {id:"burgers_7",emoji:"\\ud83c\\udf54",names:_n("Burgers"),items:[
        ...
        {id:"alib_7_6",names:_n("Chicken Burger"),price:39,photo:_gp("5afcfde194295fcbd352fe53be0146b49e21ef951719c8cb18e9abf9a059f70b")},
      ...
      {id:"pasticcios_8",emoji:"\\ud83c\\udf7d\\ufe0f",names:_n("Pasticcios"),items:[
        ...
        {id:"alib_8_1",names:_n("Pasticcio Mixte"),price:48,photo:_gp("646da2ce94d28d0ead968874154845f33d3d142edfef024efa165b48b331fc2f")},
        {id:"alib_8_2",names:_n("Pasticcio Viande Hachée"),price:48,photo:_gp("b01b5b1606d675195a4fdd765d994f52b21722da60572ce76ac5ee36ba388a22")},
        {id:"alib_8_3",names:_n("Pasticcio Dinde"),price:39,photo:_gp("1cd73697d720d3f46f0cf8a5a7c5ae350a507fb3274d0ea7c0f2a866dd804826")},
        {id:"alib_8_4",names:_n("Pasticcio Charcuterie"),price:39,photo:_gp("23492f2c38bf15380896a0a4f86d4474867d98003b0297f451394e18a160630c")},
      ]},
      ...
      {id:"boissons_10",emoji:"\\ud83e\\udd64",names:_n("Boissons"),items:[
        ...
        {id:"alib_10_7",names:_n("Sidi Ali 50cl"),price:7,photo:_gp("1816402e2329fd62f973da44ef9367514b7ee8bc47248e348c789fcb5492eeb6")},
      ]},
    ],
  },
  {
    ...
    categories:[
      ...
      {id:"salades_3",emoji:"\\ud83e\\udd57",names:_n("Salades"),items:[
        ...
        {id:"snac_3_1",names:_n("Cordon bleu"),price:24,photo:_gp("f90e16196aee98934f6abcf690676751a18c017a6fd01961b6054c6a34613772")},
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"salades_1",emoji:"\\ud83e\\udd57",names:_n("Salades"),items:[
        ...
        {id:"amor_1_3",names:_n("Salade Niçoise"),price:46,photo:_gp("1edf539064ee899eb3719a1d2d30e05312e47d4ad7e931d41e6d2f992b7cad8b")},
      ...
      {id:"calzone_3",emoji:"\\ud83c\\udf7d\\ufe0f",names:_n("CALZONE"),items:[
        {id:"amor_3_0",names:_n("Calzone fruits de mer"),price:54,photo:_gp("197f0e48e74e36ec442c8d3e9584645d8bf8f22752d6c97a057beb2dd66a22c5")},
        {id:"amor_3_1",names:_n("Calzone poulet champignon"),price:51,photo:_gp("")},
        {id:"amor_3_2",names:_n("Calzone Thon"),price:47,photo:_gp("197f0e48e74e36ec442c8d3e9584645d8bf8f22752d6c97a057beb2dd66a22c5")},
        {id:"amor_3_3",names:_n("Calzone Végétarienne"),price:44,photo:_gp("")},
      ]},
      {id:"pizzamdopi_4",emoji:"\\ud83c\\udf55",names:_n("Pizza M Dopio"),items:[
        {id:"amor_4_0",names:_n("Pizza Fruit De Mer"),price:87,photo:_gp("12e23932cd30464d64a900c1ace548eea7b5a6a9497b9690bb99c8aa1c162719")},
      ...
      {id:"pasta_6",emoji:"\\ud83c\\udf5d",names:_n("Pasta"),items:[
        ...
        {id:"amor_6_4",names:_n("Pâtes saumon"),price:72,photo:_gp("c8b7a00436b78599975dc323e3d97cd152eded442ee57ca9b58eee95fbe17ff0")},
      ...
      {id:"jus_8",emoji:"\\ud83e\\uddc3",names:_n("Jus"),items:[
        ...
        {id:"amor_8_4",names:_n("JUS D'ORANGE"),price:28,photo:_gp("62fa27dda9cc487fca436a83a0b9084a6e205ecb0284388ce3334d10191f8653")},
      ...
      {id:"boissons_9",emoji:"\\ud83e\\udd64",names:_n("Boissons"),items:[
        ...
        {id:"amor_9_5",names:_n("PEPSI"),price:13,photo:_gp("a74deaa3352413222f0c237d90acb4c248f97680bcc53447f8f24ce4225e613e")},
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"california_22",emoji:"\\ud83c\\udf63",names:_n("California Roll 4pcs"),items:[
        ...
        {id:"cafe_22_5",names:_n("Classic"),price:32,photo:_gp("59ba05acd9d37fcdbe96e0303c6ef69c64bec1a00e0739b482aebdc1a08b14cd")},
      ]},
      ...
      {id:"lesjus_24",emoji:"\\ud83e\\uddc3",names:_n("Les Jus"),items:[
        ...
        {id:"cafe_24_1",names:_n("jus d'avocat"),price:39,photo:_gp("d0c9e5916dd2457a75c33396cfbc512a6ebfd1d2ca11dd4e147c8a293552f1c1")},
        {id:"cafe_24_2",names:_n("jus de mangue"),price:39,photo:_gp("3cad78c8ed86203dff20f7af09143b0d1ff403b7a2703f2dff7424e37130c21c")},
        {id:"cafe_24_3",names:_n("panaché"),price:39,photo:_gp("")},
        {id:"cafe_24_4",names:_n("jus de fraise"),price:35,photo:_gp("c67bbdfe7932105d80ce92a1b61d1d1e24843fdad79ffa00fcaf911c346af6bf")},
        {id:"cafe_24_5",names:_n("jus de citron"),price:31,photo:_gp("")},
        {id:"cafe_24_6",names:_n("jus de banane"),price:31,photo:_gp("bc7c4c224cbe4deb522761fdebdbd9246a2641e5cdeb61068bf55a38e149d731")},
        {id:"cafe_24_7",names:_n("jus de pomme"),price:31,photo:_gp("bc7c4c224cbe4deb522761fdebdbd9246a2641e5cdeb61068bf55a38e149d731")},
        {id:"cafe_24_8",names:_n("jus d'orange"),price:26,photo:_gp("62fa27dda9cc487fca436a83a0b9084a6e205ecb0284388ce3334d10191f8653")},
      ]},
      {id:"boissonsfr_25",emoji:"\\ud83e\\udd64",names:_n("Boissons Fraîches"),items:[
        ...
        {id:"cafe_25_4",names:_n("Oulmès"),price:14,photo:_gp("016298ea66073282c63ac4f9b3ece22318843f459024689327ee734641c5dba1")},
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"california_22",emoji:"\\ud83c\\udf63",names:_n("California Roll 4pcs"),items:[
        ...
        {id:"sush_22_4",names:_n("Classic"),price:32,photo:_gp("59ba05acd9d37fcdbe96e0303c6ef69c64bec1a00e0739b482aebdc1a08b14cd")},
      ]},
      {id:"futomaki5p_23",emoji:"\\ud83c\\udf63",names:_n("FUTOMAKI 5pcs"),items:[
      ...
      {id:"lesjus_24",emoji:"\\ud83e\\uddc3",names:_n("Les Jus"),items:[
        ...
        {id:"sush_24_1",names:_n("jus d'avocat"),price:39,photo:_gp("d0c9e5916dd2457a75c33396cfbc512a6ebfd1d2ca11dd4e147c8a293552f1c1")},
        {id:"sush_24_2",names:_n("jus d'ananas"),price:39,photo:_gp("e35b76b45894f5956ca5dd18d649345d10c3a70c5b8898b8f51698d780877e9b")},
        {id:"sush_24_3",names:_n("jus de mangue"),price:39,photo:_gp("3cad78c8ed86203dff20f7af09143b0d1ff403b7a2703f2dff7424e37130c21c")},
        {id:"sush_24_4",names:_n("panaché"),price:39,photo:_gp("")},
        {id:"sush_24_5",names:_n("jus de fraise"),price:35,photo:_gp("c67bbdfe7932105d80ce92a1b61d1d1e24843fdad79ffa00fcaf911c346af6bf")},
        {id:"sush_24_6",names:_n("jus de citron"),price:31,photo:_gp("")},
        {id:"sush_24_7",names:_n("jus de banane"),price:31,photo:_gp("bc7c4c224cbe4deb522761fdebdbd9246a2641e5cdeb61068bf55a38e149d731")},
        {id:"sush_24_8",names:_n("jus de pomme"),price:31,photo:_gp("bc7c4c224cbe4deb522761fdebdbd9246a2641e5cdeb61068bf55a38e149d731")},
        {id:"sush_24_9",names:_n("jus d'orange"),price:26,photo:_gp("62fa27dda9cc487fca436a83a0b9084a6e205ecb0284388ce3334d10191f8653")},
      ]},
      {id:"boissonsfr_25",emoji:"\\ud83e\\udd64",names:_n("Boissons Fraîches"),items:[
        ...
        {id:"sush_25_5",names:_n("Oulmès"),price:14,photo:_gp("016298ea66073282c63ac4f9b3ece22318843f459024689327ee734641c5dba1")},
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"boissons_10",emoji:"\\ud83e\\udd64",names:_n("Boissons"),items:[
        {id:"losn_10_0",names:_n("Jus de Mangue"),price:33,photo:_gp("3cad78c8ed86203dff20f7af09143b0d1ff403b7a2703f2dff7424e37130c21c")},
        {id:"losn_10_1",names:_n("Jus d'Ananas"),price:33,photo:_gp("e35b76b45894f5956ca5dd18d649345d10c3a70c5b8898b8f51698d780877e9b")},
        {id:"losn_10_2",names:_n("Jus d'orange"),price:26,photo:_gp("62fa27dda9cc487fca436a83a0b9084a6e205ecb0284388ce3334d10191f8653")},
  ...
  },
  {
    ...
    categories:[
      {id:"topdesvent_0",emoji:"\u{1F96A}",names:_n("Top des ventes"),items:[
        ...
        {id:"boca_0_2",names:_n("Tacos Crispy"),price:40,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
      ]},
      ...
      {id:"tacos_2",emoji:"\u{1F32E}",names:_n("Tacos"),items:[
        {id:"boca_2_0",names:_n("Tacos Gratiné"),price:53,photo:_gp("bc0cbbba9d62cec7c46f59006c318e42ac06780915e1f84ad57760d0ba2449a7")},
        {id:"boca_2_1",names:_n("Tacos Viande Hachée"),price:47,photo:_gp("b0b0427f0a1f23f84ba87dc9899e509356612df26e74ee8cfa4192c0f74ae94d")},
        {id:"boca_2_2",names:_n("Tacos Mixte"),price:47,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
        {id:"boca_2_3",names:_n("Tacos Fruits De Mer"),price:47,photo:_gp("")},
        {id:"boca_2_4",names:_n("Tacos Poulet"),price:40,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
        {id:"boca_2_5",names:_n("Tacos Crispy"),price:40,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
      ]},
      ...
      {id:"jus_4",emoji:"\u{1F9C3}",names:_n("Jus Traditionnels"),items:[
        {id:"boca_4_0",names:_n("Jus D'Ananas"),price:31,photo:_gp("e35b76b45894f5956ca5dd18d649345d10c3a70c5b8898b8f51698d780877e9b")},
        {id:"boca_4_1",names:_n("Jus D'Avocat"),price:31,photo:_gp("d0c9e5916dd2457a75c33396cfbc512a6ebfd1d2ca11dd4e147c8a293552f1c1")},
        {id:"boca_4_2",names:_n("Jus De Mangue"),price:31,photo:_gp("3cad78c8ed86203dff20f7af09143b0d1ff403b7a2703f2dff7424e37130c21c")},
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"crepessucrees_3",emoji:"\u{1F36B}",names:_n("Crêpes Sucrées"),items:[
        ...
        {id:"caram_3_4",names:_n("Crêpe Nutella"),price:27,photo:_gp("729db543dd165d09364160454c18787d437e71df35783350022985acbc6b9a21")},
      ]},
  ...
  },
  {
    ...
    categories:[
      {id:"topdesvent_0",emoji:"\u{1F957}",names:_n("Top des ventes"),items:[
        {id:"emer_0_0",names:_n("Sandwich Fruits De Mer"),price:65,photo:_gp("747ddb2f6e26d126de332a0b8f16cf2f246feda3e89506cc82ae39abb4a9f0e0")},
      ...
      {id:"salades_1",emoji:"\u{1F957}",names:_n("Salades"),items:[
        ...
        {id:"emer_1_3",names:_n("Salade César"),price:65,photo:_gp("d02abfcbf9bc767fb45737ec16cba4bbd2ac7692a622a743de376d5a5faa4669")},
        {id:"emer_1_4",names:_n("Salade Marocaine"),price:35,photo:_gp("396facf6e6976177f8bc6262ad70862ae853c23c200d7dec8810b73390d37605")},
      ]},
      {id:"plats_2",emoji:"\u{1F35B}",names:_n("Plats"),items:[
        ...
        {id:"emer_2_3",names:_n("Émincé De Poulet"),price:85,photo:_gp("cd160a41312d771022fda7748fc9e03853298e59f66184832bd7d67ff8960523")},
      ]},
      {id:"pizzas_3",emoji:"\u{1F355}",names:_n("Pizzas"),items:[
        {id:"emer_3_0",names:_n("Pizza Fruits De Mer"),price:95,photo:_gp("f5380597fbdcf4aabb621a0673db0cb00ebab34c08252767c1dbbc1ddedfd310")},
        {id:"emer_3_1",names:_n("Pizza Suprême Poulet"),price:80,photo:_gp("")},
        {id:"emer_3_2",names:_n("Pizza 4 Fromages"),price:80,photo:_gp("49c790651f338a11b6aa5b5d6d1a2add54d26cb56bd9c373554a7647be355fe9")},
        {id:"emer_3_3",names:_n("Pizza Margherita"),price:50,photo:_gp("062e7c2b19e72258d006573e350c430bd4621a80619dd205a078d6081efe5dc5")},
      ]},
      {id:"pates_4",emoji:"\u{1F35D}",names:_n("Pâtes"),items:[
        {id:"emer_4_0",names:_n("Pâtes Fruits De Mer"),price:95,photo:_gp("af8504b6cdc199c22feeea9a003ef2c2e4fd4a1f71bc6bc672978d4b7aacbcdf")},
      ...
      {id:"tacos_5",emoji:"\u{1F32E}",names:_n("Tacos"),items:[
        ...
        {id:"emer_5_1",names:_n("Tacos Mixte"),price:55,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
        {id:"emer_5_2",names:_n("Tacos Poulet"),price:45,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
      ]},
  ...
  },
  {
    ...
    categories:[
      {id:"topdesvent_0",emoji:"\u{1F32E}",names:_n("Top des ventes"),items:[
        ...
        {id:"r4sm_0_2",names:_n("Sandwich Crispy"),price:45,photo:_gp("f8e19cfcec7690fc76021cf7926cd8fcfe8686f10c9965aba55dfdedd91111c5")},
      ]},
      ...
      {id:"sandwich_2",emoji:"\u{1F96A}",names:_n("Sandwich"),items:[
        ...
        {id:"r4sm_2_1",names:_n("Sandwich 4 Saisons"),price:52,photo:_gp("bba754a3a34ec77e972e62136035331b8bdb254a505a48b09d888986a740fae5")},
        {id:"r4sm_2_2",names:_n("Sandwich Poulet"),price:45,photo:_gp("a7eee522341d771bfe3db1f9f00171a034d7c3783509969560de19f0fc8a64ae")},
        {id:"r4sm_2_3",names:_n("Sandwich Crispy"),price:45,photo:_gp("f8e19cfcec7690fc76021cf7926cd8fcfe8686f10c9965aba55dfdedd91111c5")},
      ]},
      {id:"tacos_3",emoji:"\u{1F32E}",names:_n("Tacos"),items:[
        {id:"r4sm_3_0",names:_n("Tacos 4 Saisons"),price:45,photo:_gp("ceb5d2f7364ac4054ace82b6e95a3b0d50c5edf1d8b6f7f86cd5464f0ffffe16")},
        {id:"r4sm_3_1",names:_n("Tacos Cordon Bleu"),price:45,photo:_gp("c9b2b1c28120f477d069c0d7cdc5b34fabac0c7ce7a0f66f4beb0b19b78e003d")},
        {id:"r4sm_3_2",names:_n("Tacos Poulet"),price:40,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
      ]},
      {id:"pizza_4",emoji:"\u{1F355}",names:_n("Pizza"),items:[
        {id:"r4sm_4_0",names:_n("Pizza 4 Saisons"),price:70,photo:_gp("1461c21a4fce9da16624370de0764a22abe275584d614f4a39f58280f09a9d3e")},
        {id:"r4sm_4_1",names:_n("Pizza Royal"),price:60,photo:_gp("22267271fb0c9eacdbeb4b9a350a92cf7c0be3d9f6ea9f42688b674e3abbe610")},
        {id:"r4sm_4_2",names:_n("Pizza Margarita"),price:35,photo:_gp("2c16353057a5dfcc2c5dee6bf7f91e2f113c76cca36b8a041a17c43496043f2f")},
      ]},
  ...
  },
  {
    ...
    categories:[
      {id:"topdesvent_0",emoji:"\u{1F32E}",names:_n("Top des ventes"),items:[
        ...
        {id:"mazar_0_1",names:_n("Tacos Mixte"),price:45,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
        {id:"mazar_0_2",names:_n("Pasticcio Chicken"),price:40,photo:_gp("")},
      ]},
      {id:"tacos_1",emoji:"\u{1F32E}",names:_n("Tacos"),items:[
        {id:"mazar_1_0",names:_n("Tacos Cordon Bleu"),price:48,photo:_gp("c9b2b1c28120f477d069c0d7cdc5b34fabac0c7ce7a0f66f4beb0b19b78e003d")},
        {id:"mazar_1_1",names:_n("Tacos Mazar"),price:48,photo:_gp("")},
        {id:"mazar_1_2",names:_n("Tacos Mixte"),price:45,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
        {id:"mazar_1_3",names:_n("Tacos Chicken"),price:43,photo:_gp("")},
      ]},
      {id:"burgers_2",emoji:"\u{1F354}",names:_n("Burgers"),items:[
        {id:"mazar_2_0",names:_n("Big Burger"),price:50,photo:_gp("0812c6a3c3e8d79ebefb511aba9790098929d7f5eb6cd5208e1750ba209572ad")},
        {id:"mazar_2_1",names:_n("Cheese Burger"),price:37,photo:_gp("8bead6c2da3fa3d766b366a514fe2c69434b98113e7698f5187044b8e946cc90")},
      ]},
      {id:"wraps_3",emoji:"\u{1F32F}",names:_n("Wraps"),items:[
        {id:"mazar_3_0",names:_n("Wrap Cordon Bleu"),price:48,photo:_gp("82d8b46fd3c09d34ce1e431d2051d78ace89d0c9c51091918f6432e03ab1320e")},
      ...
      {id:"pizzas_4",emoji:"\u{1F355}",names:_n("Pizzas"),items:[
        ...
        {id:"mazar_4_2",names:_n("Pizza Margherita"),price:35,photo:_gp("062e7c2b19e72258d006573e350c430bd4621a80619dd205a078d6081efe5dc5")},
      ]},
      {id:"jus_5",emoji:"\u{1F9C3}",names:_n("Jus"),items:[
        {id:"mazar_5_0",names:_n("Zaazaa"),price:48,photo:_gp("4b38b3093e1bb24607c615f717f019efab250c72deddbe71600271e88d89faeb")},
        {id:"mazar_5_1",names:_n("Jus D'Orange"),price:21,photo:_gp("62fa27dda9cc487fca436a83a0b9084a6e205ecb0284388ce3334d10191f8653")},
      ]},
    ],
  },
  {
    ...
    categories:[
      {id:"topdesvent_0",emoji:"\u{1F32E}",names:_n("Top des ventes"),items:[
        ...
        {id:"saida_0_1",names:_n("Tacos Mixte"),price:40,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
      ...
      {id:"pizzas_2",emoji:"\u{1F355}",names:_n("Pizzas"),items:[
        {id:"saida_2_0",names:_n("Pizza Chawarma"),price:45,photo:_gp("5e965d647e76f08fde696e2e85302620b2149771489ed036b8cea2293d732f54")},
        {id:"saida_2_1",names:_n("Pizza 4 Saisons"),price:45,photo:_gp("1461c21a4fce9da16624370de0764a22abe275584d614f4a39f58280f09a9d3e")},
        {id:"saida_2_2",names:_n("Pizza Margarita"),price:35,photo:_gp("2c16353057a5dfcc2c5dee6bf7f91e2f113c76cca36b8a041a17c43496043f2f")},
      ]},
      {id:"tacos_3",emoji:"\u{1F32E}",names:_n("Tacos"),items:[
        {id:"saida_3_0",names:_n("Tacos XXL"),price:60,photo:_gp("")},
        {id:"saida_3_1",names:_n("Tacos Cordon Bleu"),price:45,photo:_gp("c9b2b1c28120f477d069c0d7cdc5b34fabac0c7ce7a0f66f4beb0b19b78e003d")},
        {id:"saida_3_2",names:_n("Tacos Mixte"),price:40,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},
      ]},
      {id:"chawarmas_4",emoji:"\u{1F32F}",names:_n("Chawarmas"),items:[
        {id:"saida_4_0",names:_n("Chawarma Plat Mixte"),price:45,photo:_gp("")},
        {id:"saida_4_1",names:_n("Chawarma Fromage"),price:35,photo:_gp("4f4dda435a2193bfa83aea24ecb54548066fa38c43dd8d2458b64182cb3764bb")},
      ]},
      {id:"jus_5",emoji:"\u{1F9C3}",names:_n("Jus"),items:[
        {id:"saida_5_0",names:_n("Jus D'Ananas"),price:25,photo:_gp("e35b76b45894f5956ca5dd18d649345d10c3a70c5b8898b8f51698d780877e9b")},
  ...
  // \u2500\u2500\u2500 GLOVO IMPORT (-5%) \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
  {
    id:"restaurant-rass-lafaa-asf",name:"Rass Lafaa",
    tagline:_n("Rass Lafaa · Safi"),
    logo:"\ud83c\udf2e",cover:_gp(""),
    cuisine:_n("Tacos, Pizzas & Tajines"),tags:["tacos", "pizza"],
    rating:0,deliveryTime:"20\u201335",minOrder:40,
    address:'Safi, Maroc',
    categories:[
      {id:"sandwiches_0",emoji:"\ud83e\udd6a",names:_n("Sandwiches"),items:[{id:"rasslf_0_0",names:_n("Sandwich Viande Hach\u00e9e"),price:40,photo:_gp("")},{id:"rasslf_0_1",names:_n("Sandwich Poulet"),price:34,photo:_gp("a7eee522341d771bfe3db1f9f00171a034d7c3783509969560de19f0fc8a64ae")},{id:"rasslf_0_2",names:_n("Sandwich Fromage"),price:28,photo:_gp("")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"rasslf_1_0",names:_n("Tacos Viande Hach\u00e9e"),price:46,photo:_gp("")},{id:"rasslf_1_1",names:_n("Tacos Mixte"),price:46,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},{id:"rasslf_1_2",names:_n("Tacos Poulet"),price:40,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")}]},
      {id:"pizzas_2",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"rasslf_2_0",names:_n("Pizza 4 Fromages"),price:63,photo:_gp("49c790651f338a11b6aa5b5d6d1a2add54d26cb56bd9c373554a7647be355fe9")},{id:"rasslf_2_1",names:_n("Pizza Poulet"),price:46,photo:_gp("d62a4680568793c57b044e581f358ec5bc5e7c494b3e11e0ee3f5b16c3559fae")},{id:"rasslf_2_2",names:_n("Pizza Margarita"),price:40,photo:_gp("2c16353057a5dfcc2c5dee6bf7f91e2f113c76cca36b8a041a17c43496043f2f")}]},
      {id:"tajines_3",emoji:"\ud83c\udf72",names:_n("Tajines"),items:[{id:"rasslf_3_0",names:_n("Tajine Poulet"),price:68,photo:_gp("")},{id:"rasslf_3_1",names:_n("Tajine De Viande Et Pruneaux"),price:80,photo:_gp("")}]},
      {id:"boissons_4",emoji:"\ud83e\udd64",names:_n("Boissons"),items:[{id:"rasslf_4_0",names:_n("Coca Cola Canette"),price:14,photo:_gp("")}]},
    ],
  },
  {
    id:"safi-coffee-shop-asf",name:"Safi Coffee Shop",
    tagline:_n("Safi Coffee Shop · Safi"),
    logo:"\u2615",cover:_gp(""),
    cuisine:_n("Breakfast, Tacos & Cr\u00eapes"),tags:["breakfast", "sandwich"],
    rating:0,deliveryTime:"20\u201335",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"safico_0_0",names:_n("Tacos Mixte"),price:57,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},{id:"safico_0_1",names:_n("Tacos Poulet"),price:52,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")}]},
      {id:"pizzas_1",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"safico_1_0",names:_n("Pizza Poulet"),price:66,photo:_gp("d62a4680568793c57b044e581f358ec5bc5e7c494b3e11e0ee3f5b16c3559fae")},{id:"safico_1_1",names:_n("Pizza Margherita"),price:40,photo:_gp("062e7c2b19e72258d006573e350c430bd4621a80619dd205a078d6081efe5dc5")}]},
      {id:"salades_2",emoji:"\ud83e\udd57",names:_n("Salades"),items:[{id:"safico_2_0",names:_n("Salade C\u00e9sar"),price:59,photo:_gp("")},{id:"safico_2_1",names:_n("Salade Marocaine"),price:40,photo:_gp("396facf6e6976177f8bc6262ad70862ae853c23c200d7dec8810b73390d37605")}]},
      {id:"crepes_3",emoji:"\ud83e\udd5e",names:_n("Cr\u00eapes"),items:[{id:"safico_3_0",names:_n("Cr\u00eape Nutella"),price:30,photo:_gp("")},{id:"safico_3_1",names:_n("Cr\u00eape Nature"),price:24,photo:_gp("")}]},
    ],
  },
  {
    id:"endo-safi-asf",name:"Endo Safi",
    tagline:_n("Endo Safi · Safi"),
    logo:"\ud83c\udf2f",cover:_gp(""),
    cuisine:_n("Tacos, Chawarma & Pizza"),tags:["tacos", "grill"],
    rating:0,deliveryTime:"15\u201330",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"endosa_0_0",names:_n("Tacos Sp\u00e9cial"),price:46,photo:_gp("")},{id:"endosa_0_1",names:_n("Tacos Mixte"),price:43,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},{id:"endosa_0_2",names:_n("Tacos Chicken"),price:41,photo:_gp("")}]},
      {id:"burgers_1",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"endosa_1_0",names:_n("Big Burger"),price:48,photo:_gp("0812c6a3c3e8d79ebefb511aba9790098929d7f5eb6cd5208e1750ba209572ad")},{id:"endosa_1_1",names:_n("Cheese Burger"),price:35,photo:_gp("8bead6c2da3fa3d766b366a514fe2c69434b98113e7698f5187044b8e946cc90")}]},
      {id:"chawarma_2",emoji:"\ud83c\udf2f",names:_n("Chawarma"),items:[{id:"endosa_2_0",names:_n("Plat Chawarma"),price:49,photo:_gp("")},{id:"endosa_2_1",names:_n("Chawarma Normal"),price:28,photo:_gp("14ecb07feb579f8e84c4351ed3fa67b7f90a18802a80964ba07acf5ae042325d")}]},
      {id:"pizza_3",emoji:"\ud83c\udf55",names:_n("Pizza"),items:[{id:"endosa_3_0",names:_n("Pizza Royale"),price:57,photo:_gp("f86a6c02e6541c88ae3e0347507d8f27de9c84d74de0c1c466fb09936ea4c09b")},{id:"endosa_3_1",names:_n("Pizza Margarita"),price:33,photo:_gp("2c16353057a5dfcc2c5dee6bf7f91e2f113c76cca36b8a041a17c43496043f2f")}]},
    ],
  },
  {
    id:"tacos-plus-asf",name:"Tacos Plus",
    tagline:_n("Tacos Plus · Safi"),
    logo:"\ud83c\udf2e",cover:_gp(""),
    cuisine:_n("Tacos, Burgers & Pizza"),tags:["tacos", "sandwich"],
    rating:0,deliveryTime:"15\u201330",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"tacosplus_0",emoji:"\ud83c\udf2e",names:_n("Tacos Plus"),items:[{id:"tacosp_0_0",names:_n("Tacos Taco Plus"),price:46,photo:_gp("")},{id:"tacosp_0_1",names:_n("Tacos Mixte"),price:43,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},{id:"tacosp_0_2",names:_n("Tacos Chicken"),price:41,photo:_gp("")}]},
      {id:"burgerplus_1",emoji:"\ud83c\udf54",names:_n("Burger Plus"),items:[{id:"tacosp_1_0",names:_n("Big Burger"),price:48,photo:_gp("0812c6a3c3e8d79ebefb511aba9790098929d7f5eb6cd5208e1750ba209572ad")},{id:"tacosp_1_1",names:_n("Cheese Burger"),price:35,photo:_gp("8bead6c2da3fa3d766b366a514fe2c69434b98113e7698f5187044b8e946cc90")}]},
      {id:"chawarmaplus_2",emoji:"\ud83c\udf2f",names:_n("Chawarma Plus"),items:[{id:"tacosp_2_0",names:_n("Chawarma Plus"),price:42,photo:_gp("")},{id:"tacosp_2_1",names:_n("Chawarma Normal"),price:28,photo:_gp("14ecb07feb579f8e84c4351ed3fa67b7f90a18802a80964ba07acf5ae042325d")}]},
      {id:"pizzaplus_3",emoji:"\ud83c\udf55",names:_n("Pizza Plus"),items:[{id:"tacosp_3_0",names:_n("Pizza Royale"),price:57,photo:_gp("f86a6c02e6541c88ae3e0347507d8f27de9c84d74de0c1c466fb09936ea4c09b")},{id:"tacosp_3_1",names:_n("Pizza Margarita"),price:33,photo:_gp("2c16353057a5dfcc2c5dee6bf7f91e2f113c76cca36b8a041a17c43496043f2f")}]},
    ],
  },
  {
    id:"snack-el-jad-asf",name:"snack el jad",
    tagline:_n("Snack El Jad · Safi"),
    logo:"\ud83c\udf2e",cover:_gp(""),
    cuisine:_n("Tacos, Pizza & Poulet"),tags:["tacos", "chicken"],
    rating:0,deliveryTime:"25\u201340",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"snacke_0_0",names:_n("Taco's Mixte"),price:43,photo:_gp("")},{id:"snacke_0_1",names:_n("Taco's Poulet"),price:38,photo:_gp("")},{id:"snacke_0_2",names:_n("Taco's Viande Hach\u00e9e"),price:38,photo:_gp("")}]},
      {id:"pizza_1",emoji:"\ud83c\udf55",names:_n("Pizza"),items:[{id:"snacke_1_0",names:_n("Pizza Fruits De Mer"),price:48,photo:_gp("f5380597fbdcf4aabb621a0673db0cb00ebab34c08252767c1dbbc1ddedfd310")},{id:"snacke_1_1",names:_n("Pizza Margarita"),price:33,photo:_gp("2c16353057a5dfcc2c5dee6bf7f91e2f113c76cca36b8a041a17c43496043f2f")}]},
      {id:"burger_2",emoji:"\ud83c\udf54",names:_n("Burger"),items:[{id:"snacke_2_0",names:_n("Fristo Burger"),price:43,photo:_gp("")},{id:"snacke_2_1",names:_n("Cheese Burger"),price:28,photo:_gp("8bead6c2da3fa3d766b366a514fe2c69434b98113e7698f5187044b8e946cc90")}]},
      {id:"poulet_3",emoji:"\ud83c\udf57",names:_n("Poulet"),items:[{id:"snacke_3_0",names:_n("Nusf Djaja"),price:66,photo:_gp("")},{id:"snacke_3_1",names:_n("Rbaa Djaj"),price:33,photo:_gp("")}]},
    ],
  },
  {
    id:"la-quatrieme-saison-asf",name:"La Quatri\u00e8me Saison",
    tagline:_n("La Quatri\u00e8me Saison · Safi"),
    logo:"\ud83c\udf2f",cover:_gp(""),
    cuisine:_n("Chawarma, Tacos & Pizza"),tags:["grill", "tacos"],
    rating:0,deliveryTime:"10\u201325",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"chawarma_0",emoji:"\ud83c\udf2f",names:_n("Chawarma"),items:[{id:"laquat_0_0",names:_n("Chawarma Big Size"),price:42,photo:_gp("")},{id:"laquat_0_1",names:_n("Chawarma Normal"),price:28,photo:_gp("14ecb07feb579f8e84c4351ed3fa67b7f90a18802a80964ba07acf5ae042325d")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"laquat_1_0",names:_n("Tacos Mixte"),price:43,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},{id:"laquat_1_1",names:_n("Tacos Chicken"),price:41,photo:_gp("")}]},
      {id:"pizza_2",emoji:"\ud83c\udf55",names:_n("Pizza"),items:[{id:"laquat_2_0",names:_n("Pizza Poulet"),price:43,photo:_gp("d62a4680568793c57b044e581f358ec5bc5e7c494b3e11e0ee3f5b16c3559fae")},{id:"laquat_2_1",names:_n("Pizza Margarita"),price:33,photo:_gp("2c16353057a5dfcc2c5dee6bf7f91e2f113c76cca36b8a041a17c43496043f2f")}]},
      {id:"burger_3",emoji:"\ud83c\udf54",names:_n("Burger"),items:[{id:"laquat_3_0",names:_n("Big Burger"),price:48,photo:_gp("0812c6a3c3e8d79ebefb511aba9790098929d7f5eb6cd5208e1750ba209572ad")}]},
    ],
  },
  {
    id:"tanini-snack-asf",name:"TANINI SNACK",
    tagline:_n("Tanini Snack · Safi"),
    logo:"\ud83e\udd90",cover:_gp(""),
    cuisine:_n("Mkila & Fruits de mer"),tags:["seafood"],
    rating:0,deliveryTime:"15\u201330",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"mkila_0",emoji:"\ud83e\udd58",names:_n("Mkila"),items:[{id:"tanini_0_0",names:_n("Mkila Mix"),price:39,photo:_gp("")},{id:"tanini_0_1",names:_n("Mkila Sipiya"),price:30,photo:_gp("")}]},
      {id:"sandwich_1",emoji:"\ud83e\udd6a",names:_n("Sandwich"),items:[{id:"tanini_1_0",names:_n("Sandwich Mix"),price:34,photo:_gp("")},{id:"tanini_1_1",names:_n("Sandwich Crevette"),price:30,photo:_gp("")}]},
      {id:"burgers_2",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"tanini_2_0",names:_n("Burger Viande"),price:52,photo:_gp("")},{id:"tanini_2_1",names:_n("Burger Seafood"),price:48,photo:_gp("")}]},
    ],
  },
  {
    id:"la-barque-bleue-asf",name:"Restaurant La Barque Bleue",
    tagline:_n("La Barque Bleue · Safi"),
    logo:"\ud83d\udea3",cover:_gp(""),
    cuisine:_n("Poisson, Ftour & Mqilat"),tags:["seafood", "breakfast"],
    rating:0,deliveryTime:"15\u201330",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"ftour_0",emoji:"\ud83c\udf5e",names:_n("Petit D\u00e9jeuner"),items:[{id:"labarq_0_0",names:_n("Ftour Fassi"),price:52,photo:_gp("")},{id:"labarq_0_1",names:_n("Ftour Mesfioui"),price:76,photo:_gp("")}]},
      {id:"mqilat_1",emoji:"\ud83e\udd58",names:_n("Mqilat"),items:[{id:"labarq_1_0",names:_n("Mqila Fruits De Mer Sp\u00e9cial"),price:62,photo:_gp("")},{id:"labarq_1_1",names:_n("Mqila Khlii"),price:33,photo:_gp("")}]},
      {id:"plats_2",emoji:"\ud83c\udf57",names:_n("Plat Poulet"),items:[{id:"labarq_2_0",names:_n("1/2 Poulet"),price:81,photo:_gp("")},{id:"labarq_2_1",names:_n("1/4 Poulet"),price:43,photo:_gp("")}]},
      {id:"pasticcio_3",emoji:"\ud83c\udf5d",names:_n("Pasticcio"),items:[{id:"labarq_3_0",names:_n("Pasticcio Poulet"),price:38,photo:_gp("311e7decd2e4a5c4975178557a6102439228d1ce609aba9c3dd9b92b9833805b")}]},
    ],
  },
  {
    id:"ltacos",name:"L'Tacos",
    tagline:_n("L'Tacos · Safi"),
    logo:"\ud83c\udf2e",cover:_gp(""),
    cuisine:_n("Tacos & Burgers"),tags:["tacos"],
    rating:0,deliveryTime:"15\u201330",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"ltacos_0_0",names:_n("Tacos XXL"),price:57,photo:_gp("")},{id:"ltacos_0_1",names:_n("Tacos Mixte"),price:43,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},{id:"ltacos_0_2",names:_n("Tacos Chicken"),price:38,photo:_gp("")}]},
      {id:"burgers_1",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"ltacos_1_0",names:_n("Widadi Burger"),price:48,photo:_gp("")},{id:"ltacos_1_1",names:_n("Chicken Burger"),price:33,photo:_gp("5afcfde194295fcbd352fe53be0146b49e21ef951719c8cb18e9abf9a059f70b")}]},
      {id:"jus_2",emoji:"\ud83e\udde3",names:_n("Jus"),items:[{id:"ltacos_2_0",names:_n("Jus De Mangue"),price:24,photo:_gp("3cad78c8ed86203dff20f7af09143b0d1ff403b7a2703f2dff7424e37130c21c")},{id:"ltacos_2_1",names:_n("Jus Panach\u00e9"),price:19,photo:_gp("")}]},
    ],
  },
  {
    id:"snack-chiraz-asf",name:"Snack Chiraz",
    tagline:_n("Snack Chiraz · Safi"),
    logo:"\ud83c\udf2e",cover:_gp(""),
    cuisine:_n("Tacos, Burgers & Pizzas"),tags:["tacos", "sandwich"],
    rating:0,deliveryTime:"10\u201325",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"snackc_0_0",names:_n("Tacos CHIRAZ"),price:48,photo:_gp("")},{id:"snackc_0_1",names:_n("Tacos Mixte"),price:45,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")}]},
      {id:"burgers_1",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"snackc_1_0",names:_n("Big Burger"),price:43,photo:_gp("0812c6a3c3e8d79ebefb511aba9790098929d7f5eb6cd5208e1750ba209572ad")},{id:"snackc_1_1",names:_n("Chicken Burger"),price:32,photo:_gp("5afcfde194295fcbd352fe53be0146b49e21ef951719c8cb18e9abf9a059f70b")}]},
      {id:"chawarmas_2",emoji:"\ud83c\udf2f",names:_n("Chawarmas"),items:[{id:"snackc_2_0",names:_n("Chawarma Extra"),price:40,photo:_gp("4f98273db9aa45b048dc56005617178f44856484a8b3ec5bac21a94ff1467256")}]},
      {id:"pizzas_3",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"snackc_3_0",names:_n("Pizza Royale"),price:59,photo:_gp("f86a6c02e6541c88ae3e0347507d8f27de9c84d74de0c1c466fb09936ea4c09b")},{id:"snackc_3_1",names:_n("Pizza Margherita"),price:32,photo:_gp("062e7c2b19e72258d006573e350c430bd4621a80619dd205a078d6081efe5dc5")}]},
    ],
  },
  {
    id:"calypso-medina-asf-1ppb6",name:"Calypso Medina",
    tagline:_n("Calypso Medina · Safi"),
    logo:"\ud83c\udf63",cover:_gp(""),
    cuisine:_n("Sushi & Asiatique"),tags:["asian", "sushi"],
    rating:0,deliveryTime:"15\u201330",minOrder:40,
    address:'Safi, Maroc',
    categories:[
      {id:"aromaki_0",emoji:"\ud83c\udf63",names:_n("Aromaki"),items:[{id:"calyps_0_0",names:_n("Aromaki Crevettes"),price:57,photo:_gp("")},{id:"calyps_0_1",names:_n("Aromaki Saumon"),price:62,photo:_gp("")}]},
      {id:"california_1",emoji:"\ud83c\udf63",names:_n("California Rolls"),items:[{id:"calyps_1_0",names:_n("California Classic"),price:33,photo:_gp("")}]},
      {id:"maki_2",emoji:"\ud83c\udf63",names:_n("Maki"),items:[{id:"calyps_2_0",names:_n("Maki Saumon"),price:48,photo:_gp("")}]},
      {id:"thai_3",emoji:"\ud83c\udf5c",names:_n("Plat Tha\u00ef"),items:[{id:"calyps_3_0",names:_n("Wok Crevettes"),price:76,photo:_gp("")}]},
    ],
  },
  {
    id:"lacosta-food-asf",name:"LACOSTA FOOD",
    tagline:_n("Lacosta Food · Safi"),
    logo:"\ud83e\udd90",cover:_gp(""),
    cuisine:_n("Fruits de mer"),tags:["seafood"],
    rating:0,deliveryTime:"15\u201330",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"plats_0",emoji:"\ud83e\udd58",names:_n("Plats Principaux"),items:[{id:"lacost_0_0",names:_n("Cozamia Fruit De Mer"),price:46,photo:_gp("")},{id:"lacost_0_1",names:_n("Crevettes Pil Pil"),price:40,photo:_gp("")},{id:"lacost_0_2",names:_n("M9ila La Costa"),price:34,photo:_gp("")}]},
      {id:"salades_1",emoji:"\ud83e\udd57",names:_n("Salades"),items:[{id:"lacost_1_0",names:_n("Salade Fruit De Mer"),price:46,photo:_gp("")}]},
    ],
  },
  {
    id:"la-dolce-vita-asf",name:"La Dolce Vita",
    tagline:_n("La Dolce Vita · Safi"),
    logo:"\ud83c\udf2e",cover:_gp(""),
    cuisine:_n("Tacos, Sandwichs & Mkila"),tags:["tacos", "sandwich"],
    rating:0,deliveryTime:"15\u201330",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"sandwichs_0",emoji:"\ud83e\udd6a",names:_n("Sandwichs"),items:[{id:"ladolc_0_0",names:_n("Sandwich Viande Hach\u00e9e"),price:52,photo:_gp("")},{id:"ladolc_0_1",names:_n("Sandwich Poulet"),price:47,photo:_gp("a7eee522341d771bfe3db1f9f00171a034d7c3783509969560de19f0fc8a64ae")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"ladolc_1_0",names:_n("Tacos Cordon Bleu"),price:52,photo:_gp("c9b2b1c28120f477d069c0d7cdc5b34fabac0c7ce7a0f66f4beb0b19b78e003d")},{id:"ladolc_1_1",names:_n("Tacos Poulet"),price:43,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")}]},
      {id:"mkilas_2",emoji:"\ud83e\udd58",names:_n("Mkilas"),items:[{id:"ladolc_2_0",names:_n("Mkila Royal"),price:48,photo:_gp("")}]},
      {id:"burgers_3",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"ladolc_3_0",names:_n("Burger Classique"),price:52,photo:_gp("")}]},
    ],
  },
  {
    id:"restaurant-trigonia-coffee-asf",name:"TRIGONIA COFFEESHOP",
    tagline:_n("Trigonia Coffeeshop · Safi"),
    logo:"\u2615",cover:_gp(""),
    cuisine:_n("Coffee & Cocktails"),tags:["coffee"],
    rating:0,deliveryTime:"15\u201330",minOrder:25,
    address:'Safi, Maroc',
    categories:[
      {id:"coffee_0",emoji:"\u2615",names:_n("Coffee"),items:[{id:"restau_0_0",names:_n("Caf\u00e9 Espresso"),price:19,photo:_gp("")},{id:"restau_0_1",names:_n("Americano"),price:19,photo:_gp("")}]},
      {id:"iced_1",emoji:"\ud83e\uddca",names:_n("Iced Drinks"),items:[{id:"restau_1_0",names:_n("Iced Latte"),price:30,photo:_gp("")}]},
      {id:"cocktails_2",emoji:"\ud83c\udf79",names:_n("Virgin Cocktails"),items:[{id:"restau_2_0",names:_n("Virgin Mojito"),price:26,photo:_gp("")}]},
    ],
  },
  {
    id:"dreams-food-asf",name:"Dreams Food",
    tagline:_n("Dreams Food · Safi"),
    logo:"\ud83c\udf54",cover:_gp(""),
    cuisine:_n("Burgers, Tacos & Pizzas"),tags:["burger", "tacos"],
    rating:0,deliveryTime:"20\u201335",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"burgers_0",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"dreams_0_0",names:_n("Dreams Burger"),price:61,photo:_gp("")},{id:"dreams_0_1",names:_n("Chicken Burger"),price:48,photo:_gp("5afcfde194295fcbd352fe53be0146b49e21ef951719c8cb18e9abf9a059f70b")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"dreams_1_0",names:_n("Tacos Mixte"),price:63,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},{id:"dreams_1_1",names:_n("Tacos Poulet"),price:43,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")}]},
      {id:"pizzas_2",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"dreams_2_0",names:_n("Pizza Poulet"),price:48,photo:_gp("d62a4680568793c57b044e581f358ec5bc5e7c494b3e11e0ee3f5b16c3559fae")},{id:"dreams_2_1",names:_n("Pizza Margherita"),price:33,photo:_gp("062e7c2b19e72258d006573e350c430bd4621a80619dd205a078d6081efe5dc5")}]},
      {id:"plats_3",emoji:"\ud83c\udf57",names:_n("Plats"),items:[{id:"dreams_3_0",names:_n("Plat Marco Polo"),price:66,photo:_gp("")}]},
    ],
  },
  {
    id:"romanesca-asf",name:"ROMANESCA",
    tagline:_n("Romanesca · Safi"),
    logo:"\ud83c\udf55",cover:_gp(""),
    cuisine:_n("Pizzas, Pastas & Italien"),tags:["pizza", "italian"],
    rating:0,deliveryTime:"15\u201330",minOrder:40,
    address:'Safi, Maroc',
    categories:[
      {id:"pizzas_0",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"romane_0_0",names:_n("Pizza Tuna"),price:81,photo:_gp("")},{id:"romane_0_1",names:_n("Pizza Romargherita"),price:62,photo:_gp("")}]},
      {id:"pastas_1",emoji:"\ud83c\udf5d",names:_n("Pastas"),items:[{id:"romane_1_0",names:_n("Penne Alfredo"),price:75,photo:_gp("")},{id:"romane_1_1",names:_n("Spaguetti Bolognaise"),price:75,photo:_gp("")}]},
      {id:"salades_2",emoji:"\ud83e\udd57",names:_n("Salades"),items:[{id:"romane_2_0",names:_n("Salade C\u00e9sar Poulet"),price:56,photo:_gp("")}]},
      {id:"burgers_3",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"romane_3_0",names:_n("Burger Viande Hach\u00e9e"),price:62,photo:_gp("")}]},
    ],
  },
  {
    id:"pizzeria-milano-asf",name:"pizzeria milano",
    tagline:_n("Pizzeria Milano · Safi"),
    logo:"\ud83c\udf55",cover:_gp(""),
    cuisine:_n("Pizzas, Tacos & Burgers"),tags:["pizza", "tacos"],
    rating:0,deliveryTime:"15\u201330",minOrder:30,
    address:'Safi, Maroc',
    categories:[
      {id:"pizzas_0",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"pizzer_0_0",names:_n("Pizza Fruits De Mer"),price:40,photo:_gp("f5380597fbdcf4aabb621a0673db0cb00ebab34c08252767c1dbbc1ddedfd310")},{id:"pizzer_0_1",names:_n("Pizza Poulet"),price:36,photo:_gp("d62a4680568793c57b044e581f358ec5bc5e7c494b3e11e0ee3f5b16c3559fae")},{id:"pizzer_0_2",names:_n("Pizza Margarita"),price:25,photo:_gp("2c16353057a5dfcc2c5dee6bf7f91e2f113c76cca36b8a041a17c43496043f2f")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"pizzer_1_0",names:_n("Tacos Mixte"),price:43,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")},{id:"pizzer_1_1",names:_n("Tacos Poulet"),price:36,photo:_gp("c209a3c6b3ddeca6b7bdb162e0cc53228fe1d35ab0f32ccf8a5dc61649431169")}]},
      {id:"burgers_2",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"pizzer_2_0",names:_n("Cheese Burger"),price:29,photo:_gp("8bead6c2da3fa3d766b366a514fe2c69434b98113e7698f5187044b8e946cc90")}]},
      {id:"chawarmas_3",emoji:"\ud83c\udf2f",names:_n("Chawarmas"),items:[{id:"pizzer_3_0",names:_n("Chawarma Mixte"),price:34,photo:_gp("23f1f808805076eb5954a2aedb03059a74b6a8c96d4551bd59545e24e689bd30")}]},
    ],
  },
];
    ...
    return(
      <button onClick={onClick}
        ...
        <div className="relative h-36 overflow-hidden">
          ...
          {isFeatured&&(
            <div className="absolute top-2.5 right-2.5 flex items-center gap-0.5 px-2 py-1 rounded-full" style={{background:'#D9C5A0'}}>
              <span className="text-[10px]">⭐</span>
              <span className="text-[10px] font-black" style={{color:'#065F46'}}>#1</span>
            </div>
          )}
          <div className="absolute bottom-0 left-0 right-0 px-3 pb-2.5">
            <h3 className={`font-black text-white text-sm leading-tight mb-0.5 ${fClass}`}>{r.name}</h3>
            <p className={`text-white/65 text-[11px] leading-tight line-clamp-1 ${fClass}`}>{r.tagline[lang]}</p>
          </div>
        </div>
        <div className="px-3 py-2.5 flex items-center justify-between gap-1">
          ...
          <div className="flex items-center gap-1 px-2 py-1 rounded-full flex-shrink-0" style={{background:'#F0FDF4'}}>
...
function HomePage({lang,t,onSelectRestaurant}:{lang:Lang;t:typeof T.fr;onSelectRestaurant:(r:Restaurant)=>void}) {
  ...
  const shuffledRestaurants = useMemo(() => {
    const mcdo = RESTAURANTS.find(r => r.id === 'mcdonalds-safi');
    const others = RESTAURANTS.filter(r => r.id !== 'mcdonalds-safi');
    const arr = [...others];
  ...
  return (
    <div>
      ...
      {/* Restaurant cards — 1 par ligne, McDo en grande carte, le reste en taille moyenne */}
      {filtered.length===0
        ? (
...
function driverDisplayName(name?:string):string{
  if(!name) return '';
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-end sm:items-center justify-center p-0 sm:p-4" style={{background:'rgba(0,0,0,0.55)'}} onClick={onClose}>
      ...
      <div id="bridge-receipt-print" onClick={(e:any)=>e.stopPropagation()}
        ...
        <div className="px-6 py-4 receipt-noprint flex gap-2" style={{borderTop:'1px solid #eee'}}>
          <button onClick={()=>window.print()} disabled={loading||!data}
            ...
            🖨️ {lang==='ar'?'طباعة':lang==='en'?'Print':'Imprimer'}
          </button>
          <button onClick={()=>window.print()} disabled={loading||!data}
            className="flex-1 py-3 rounded-2xl font-black text-sm transition-all active:scale-95"
            style={{background:'#fff',border:`1.5px solid ${accent}`,color:accentDark,cursor:loading?'default':'pointer',opacity:loading?0.6:1}}>
            💾 {lang==='ar'?'حفظ PDF':lang==='en'?'Save PDF':'Enregistrer PDF'}
          </button>
        </div>
      </div>
    </div>
...
function TrackingPage({lang,t,orderRef}:{lang:Lang;t:typeof T.fr;orderRef:string}) {
  ...
  return (
    <div className="px-5">
      ...
      <div className="rounded-3xl p-4 mb-5" style={{background:'var(--c-bg)',border:'1.5px solid var(--c-border)',boxShadow:'0 2px 12px rgba(0,0,0,0.06)'}}>
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <p className="text-sm font-bold" style={{color:'var(--c-text)'}}>
            {isDelivered
              ? <span style={{color:'#065F46'}}>{lang==='ar'?'تم التوصيل بنجاح':lang==='en'?'Delivered successfully':'Livraison effectuée 🎉'}</span>
              : <>{t.eta}: <span style={{color:'#065F46'}}>{isLive?'📡 GPS en direct':'En attente du livreur'}</span></>
            }
          </p>
        </div>
      </div>
      ...
      {/* Livraison terminée — remplace la carte GPS */}
      {isDelivered&&(
        <div className="rounded-3xl p-6 mb-5 text-center" style={{background:'linear-gradient(135deg,#F0FDF4,#DCFCE7)',border:'1.5px solid #86EFAC',boxShadow:'0 4px 20px rgba(5,150,105,0.12)'}}>
          <div className="text-5xl mb-3">✅</div>
          <p className={`text-lg font-black mb-1 ${fClass}`} style={{color:'#065F46'}}>
            {lang==='ar'?'تم التوصيل بنجاح!':lang==='en'?'Delivered successfully!':'Livraison effectuée !'}
          </p>
          <p className="text-xs mb-5" style={{color:'#059669'}}>
      ...
      {/* GPS status info — masquée après livraison */}
...
const PHARMA_CATALOG:MedEntry[]=[
  ...
  {id:'effera',    name:'Efferalgan 500mg',         desc:'Effervescent 16 cp',        price:22.00, cat:'douleur', emoji:'🫧'},
  {id:'dafal',     name:'Dafalgan 1g Effervescent', desc:'Paracétamol fort 8 cp',     price:23.00, cat:'douleur', emoji:'🫧'},
  {id:'aspegic',   name:'Aspégic 500mg',            desc:'Aspirine sachets ×10',      price:17.50, cat:'douleur', emoji:'💊'},
  {id:'advil',     name:'Advil 400mg',              desc:'Ibuprofène 14 cp',          price:28.50, cat:'douleur', emoji:'💊'},
  {id:'nurofen',   name:'Nurofen 200mg',            desc:'Ibuprofène 24 cp',          price:36.00, cat:'douleur', emoji:'💊'},
  {id:'voltarene', name:'Voltarène Gel 1%',         desc:'Anti-inflammatoire 50g',    price:57.00, cat:'douleur', emoji:'🧴'},
  // ── 🤢 Digestif & Estomac ──
  {id:'smecta',    name:'Smecta',                   desc:'Diarrhée sachets ×10',      price:38.00, cat:'digestif', emoji:'🟡'},
  ...
  {id:'maalox',    name:'Maalox Suspension',        desc:'Antiacide 250ml',           price:46.50, cat:'digestif', emoji:'🥛'},
  {id:'gaviscon',  name:'Gaviscon Advance',          desc:'Brûlures 30 cp',            price:57.00, cat:'digestif', emoji:'💊'},
  {id:'lacteol',   name:'Lacteol Fort',             desc:'Probiotique 10 sachets',    price:52.00, cat:'digestif', emoji:'🦠'},
  {id:'charbon',   name:'Charbon Activé',           desc:'Intoxication 20 cp',        price:25.00, cat:'digestif', emoji:'⬛'},
  {id:'duphalac',  name:'Duphalac',                 desc:'Laxatif sirop 200ml',       price:50.00, cat:'digestif', emoji:'🍶'},
  {id:'motilium',  name:'Motilium 10mg',            desc:'Nausées 30 cp',             price:43.50, cat:'digestif', emoji:'💊'},
  // ── 🤧 Rhume, Toux & Gorge ──
  {id:'actifed',   name:'Actifed',                  desc:'Rhume 16 cp',               price:38.00, cat:'rhume', emoji:'🤧'},
  {id:'fervex',    name:'Fervex',                   desc:'Grippe 8 sachets',          price:43.50, cat:'rhume', emoji:'🫗'},
  {id:'rhinathiol',name:'Rhinathiol Sirop',          desc:'Expectorant 250ml',         price:46.50, cat:'rhume', emoji:'🍶'},
  {id:'toplexil',  name:'Toplexil Sirop',           desc:'Toux sèche 250ml',          price:41.00, cat:'rhume', emoji:'🍶'},
  {id:'strepsils', name:'Strepsils Miel-Citron',    desc:'Pastilles gorge ×24',       price:32.50, cat:'rhume', emoji:'🍯'},
  {id:'neocodion', name:'Néo-Codion',               desc:'Toux 30 cp',                price:38.00, cat:'rhume', emoji:'💊'},
  {id:'physiomer', name:'Physiomer Spray',           desc:'Nez bouché 135ml',          price:59.50, cat:'rhume', emoji:'💨'},
  // ── 🩹 Plaies & Peau ──
  {id:'biafine',   name:'Biafine Émulsion',         desc:'Brûlures 93g',              price:59.50, cat:'peau', emoji:'🧴'},
  {id:'bepanthen', name:'Bepanthen Pommade',        desc:'Cicatrisant 100g',          price:70.00, cat:'peau', emoji:'🧴'},
  ...
  {id:'mercuro',   name:'Éosine Aqueuse',           desc:'Désinfectant 2× 2ml',       price:14.50, cat:'peau', emoji:'🔴'},
  // ── 💊 Vitamines & Compléments ──
  {id:'vitc',      name:'Vitamine C 1000mg',        desc:'Effervescent ×20',          price:32.50, cat:'vitamines', emoji:'🍊'},
  {id:'supradyn',  name:'Supradyn',                 desc:'Multivitamines 30 cp',      price:70.00, cat:'vitamines', emoji:'💛'},
  {id:'magne-b6',  name:'Magné B6',                desc:'Magnésium 60 cp',           price:57.00, cat:'vitamines', emoji:'💊'},
  {id:'becozyme',  name:'Becozyme C Forte',         desc:'Vitamines B+C 30 cp',       price:46.50, cat:'vitamines', emoji:'💊'},
  {id:'vitd3',     name:'Vitamine D3 1000UI',       desc:'Gouttes 10ml',              price:45.50, cat:'vitamines', emoji:'☀️'},
  {id:'zinc',      name:'Zinc 15mg',                desc:'Immunité 30 cp',            price:35.00, cat:'vitamines', emoji:'💊'},
  // ── 👁️ Yeux & Nez ──
  {id:'rhinomer',  name:'Rhinomer Spray',           desc:'Lavage nasal 135ml',        price:50.00, cat:'yeux', emoji:'👃'},
  {id:'visine',    name:'Visine Yeux Rouges',       desc:'Collyre 15ml',              price:38.00, cat:'yeux', emoji:'👁️'},
  {id:'collyre-b', name:'Collyre Bleu',             desc:'Décongestionnant 10ml',     price:27.50, cat:'yeux', emoji:'🔵'},
  {id:'artelac',   name:'Artelac Gouttes',          desc:'Larmes artificielles 10ml', price:56.00, cat:'yeux', emoji:'💧'},
  // ── 🧴 Parapharmacie ──
  {id:'avene-solaire',  name:'Avène Solaire SPF50+',      desc:'Crème peau sensible 50ml',   price:155.50, cat:'parapharmacie', emoji:'☀️'},
  {id:'nivea-sun',      name:'Nivea Sun Lait SPF30',       desc:'Protection solaire 200ml',   price:101.50, cat:'parapharmacie', emoji:'🧴', img:'https://commons.wikimedia.org/wiki/Special:FilePath/Nivea%20Lotion.jpg?width=200'},
  ...
  {id:'cetaphil',       name:'Cetaphil Gel Nettoyant',     desc:'Peau sensible 125ml',         price:117.50, cat:'parapharmacie', emoji:'🧴'},
  {id:'klorane',        name:'Klorane Shampooing',         desc:'Usage fréquent 200ml',        price:80.50,  cat:'parapharmacie', emoji:'🧴'},
  {id:'uriage-eau',     name:'Uriage Eau Thermale',        desc:'Spray apaisant 150ml',        price:69.50,  cat:'parapharmacie', emoji:'💧'},
  {id:'nivea-lait',     name:'Nivea Lait Corporel',        desc:'Hydratant 400ml',             price:48.00,  cat:'parapharmacie', emoji:'🧴', img:'https://commons.wikimedia.org/wiki/Special:FilePath/Nivea%20Lotion.jpg?width=200'},
  {id:'dove-savon',     name:'Dove Savon Pain',            desc:'Beauté hydratant 100g',       price:19.50,  cat:'parapharmacie', emoji:'🧼'},
  {id:'pampers-t3',     name:'Pampers Couches Taille 3',   desc:'Paquet ×36',                  price:91.00,  cat:'parapharmacie', emoji:'🍼'},
  {id:'pampers-ling',   name:'Pampers Lingettes Bébé',     desc:'Paquet ×64',                  price:27.00,  cat:'parapharmacie', emoji:'🍼'},
  {id:'serum-phy',      name:'Sérum Physiologique',        desc:'Unidoses ×40',                price:30.00,  cat:'parapharmacie', emoji:'💧'},
  {id:'coton-tiges',    name:'Coton-Tiges',                desc:'Boîte ×100',                  price:16.00,  cat:'parapharmacie', emoji:'🧻'},
  {id:'gel-hydro',      name:'Gel Hydroalcoolique',        desc:'Flacon 100ml',                price:23.50,  cat:'parapharmacie', emoji:'🧴'},
  {id:'vichy-norma',    name:'Vichy Normaderm Gel',        desc:'Peau à imperfections 200ml',  price:139.00, cat:'parapharmacie', emoji:'🧴'},
...
function PharmaciePage({onBack,lang,cycleLang,profile,saveProfile,onOrderSuccess}:{onBack:()=>void;lang:Lang;cycleLang:()=>void;profile:UserProfile;saveProfile:(p:UserProfile)=>void;onOrderSuccess?:(ref:string)=>void}) {
  ...
  const catTabs:{key:MedEntry['cat'];label:string;emoji:string}[]=[
    ...
    {key:'parapharmacie', label:lang==='ar'?'شبه صيدلية':lang==='en'?'Parapharmacy':'Parapharmacie', emoji:'🧴'},
  ];
...
function ServiceSelectPage({onSelect,onBack,lang,cycleLang,profile,saveProfile}:{onSelect:(s:'delivery'|'taxi'|'tabac'|'fleurs'|'pharmacie'|'boulangerie'|'souk'|'supermarche')=>void;onBack:()=>void;lang:Lang;cycleLang:()=>void;profile:UserProfile;saveProfile:(p:UserProfile)=>void}) {
  ...
  // Coupe-circuit temporaire de la vidéo pub (consommait trop de bande passante Railway)
  const AD_VIDEO_ENABLED = false;
  ...
  <div className={`absolute top-3 z-50 ${isAR?'right-3':'left-3'}`}>
    ...
    >
      ...
      <div className="relative flex flex-col items-center w-full max-w-2xl mx-auto pt-20 pb-8 px-4">
                  ...
                  <button onClick={()=>choose('pharmacie')} style={{background:'none',border:'none',cursor:'pointer',padding:0,transform:isPh?'scale(0.97)':'scale(1)',transition:'transform 0.2s cubic-bezier(.34,1.56,.64,1)',opacity:0.82,animation:'svcFadeUp 0.45s ease-out 0.16s both'}}>
                    <div style={{
                      ...
                      <div style={{textAlign:'left',flex:1}}>
                        ...
                        <p style={{color:'rgba(255,255,255,0.8)',fontSize:9,fontWeight:700,margin:'0 0 1px'}}>🌙 Ouverte la nuit · 💊 Disponible 24h/24</p>
                        <p style={{color:'rgba(255,255,255,0.5)',fontSize:8,margin:0}}>{t.pharmaeSub}</p>
                      </div>
                    </div>
                  </button>
                );
        ...
        {/* Vidéo désactivée temporairement (2026-07-10) : la lecture auto + boucle
            consommait trop de bande passante Railway. Repasser AD_VIDEO_ENABLED
            à true pour la réactiver. */}
        {AD_VIDEO_ENABLED && (
...
const TABAC_CATALOG:CigEntry[] = [
  ...
  {id:'dunhill',     brand:'Dunhill',      name:'Dunhill International',  price:35.50, cat:'premium', img:'https://commons.wikimedia.org/wiki/Special:FilePath/Virgin_Dunhill_menthol_cigarettes_pack_%28without_warnings%29.jpg?width=200',c1:'#7C1A2E',c2:'#4A0F1A',label:'INT\'L'},
  // ── International ──
  {id:'camel',       brand:'Camel',        name:'Camel Classic',          price:32.50, cat:'intl',    img:'https://commons.wikimedia.org/wiki/Special:FilePath/Camel_cigarette_pack_%28softpack%29_on_white_background.jpg?width=200',c1:'#C8943B',c2:'#8B6419',label:'CLASSIC'},
  {id:'camel-blue',  brand:'Camel',        name:'Camel Blue',             price:32.50, cat:'intl',    img:'https://commons.wikimedia.org/wiki/Special:FilePath/Camel_blue_cigarettes_%28China%29.jpg?width=200',c1:'#2156A4',c2:'#133B7A',label:'BLUE'},
  ...
  {id:'lm-blue',     brand:'L&M',          name:'L&M Blue Label',         price:26.50, cat:'intl',    img:'https://commons.wikimedia.org/wiki/Special:FilePath/L-and-M-blue.jpg?width=200',c1:'#1B4FA0',c2:'#0D3070',label:'BLUE'},
  {id:'kent',        brand:'Kent',         name:'Kent HD Blue',           price:27.50, cat:'intl',    img:'https://commons.wikimedia.org/wiki/Special:FilePath/Kent_Mintec_cigarettes.JPG?width=200',c1:'#00539C',c2:'#003070',label:'HD BLUE'},
  {id:'gaul',        brand:'Gauloises',    name:'Gauloises Blondes',      price:27.50, cat:'intl',    img:'https://commons.wikimedia.org/wiki/Special:FilePath/Gauloises_Blondes.JPG?width=200',c1:'#2459A9',c2:'#123A7A',label:'BLONDES'},
  ...
  {id:'chest',       brand:'Chesterfield', name:'Chesterfield Red',       price:24.50, cat:'intl',    img:'https://commons.wikimedia.org/wiki/Special:FilePath/Chesterfield_Red.JPG?width=200',c1:'#8B1C2C',c2:'#5A0E18',label:'RED'},
...
const SOUK_CATALOG:SoukItem[]=[
  ...
  {id:'sm5',name:"Miel D'Oranger (Chahdat Souss)", desc:'100% naturel, pot artisanal', price:124, cat:'miel', emoji:'🍯'},
  {id:'sm6',name:'Miel De Thym (Chahdat Souss)', desc:'Pot artisanal, Souss', price:332, cat:'miel', emoji:'🍯'},
  {id:'sm7',name:"Huile D'Argan Alimentaire (Chahdat Souss)", desc:'Pure, pressée traditionnellement', price:142, cat:'miel', emoji:'🌿'},
];
...
interface MarketItem {id:string;name:string;desc:string;price:number;originalPrice?:number;cat:'fruits'|'boucherie'|'laitier'|'boissons'|'epicerie'|'snacking'|'sucre'|'surgeles';emoji:string;imgRef?:string;}

const MARJANE_CATALOG:MarketItem[]=[
  {id:"mrj0",name:"Bahia Eau de table 5L",desc:"Boisson",price:8.95,cat:"boissons",emoji:"💧",imgRef:"G:d1121dee-7d91-4289-9cf1-2e69c57ef2bd.png",originalPrice:9.95},
  {id:"mrj1",name:"Yaourt à boire au jus de grenadine 8x165g - RAÏBI JAMILA",desc:"Produit laitier",price:18.95,cat:"laitier",emoji:"🧀",imgRef:"G:ea90d5bd-121f-4be2-a7db-af7ba5218559.jpg",originalPrice:19.95},
  {id:"mrj2",name:"Dessert vanille Liégeois 200g - OMIRA MILCHI",desc:"Épicerie",price:8.5,cat:"epicerie",emoji:"🧂",imgRef:"G:ba3c58f8-3530-45c0-81d0-90e54b46cdd5.jpg",originalPrice:9.15},
  {id:"mrj3",name:"Sel de cuisine iode 1Kg - CEBEROS",desc:"Épicerie",price:10.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b843296792badc11cb6b9a.jpeg",originalPrice:11.45},
  {id:"mrj4",name:"Crunchips saveur fromage et oignon 2x100g - LORENZ",desc:"Produit laitier",price:24.37,cat:"laitier",emoji:"🧀",imgRef:"G:a34c7d0c-bb78-449d-a3e9-71280d6d74d1.png",originalPrice:27.75},
  {id:"mrj5",name:"Aïn Saïss Eau minérale 5L",desc:"Boisson",price:11.2,cat:"boissons",emoji:"💧",imgRef:"G:75b911d0-f62f-411a-88e1-cce9bec5aa14.png",originalPrice:11.95},
  {id:"mrj6",name:"Tranche fromage fondu light x12 200g - OR BLANC",desc:"Produit laitier",price:19.5,cat:"laitier",emoji:"🧀",imgRef:"M:c21d3c583d8e27ec8a28c91d1c15876b716e722f9a1a8d30e7854f475b4c84cd",originalPrice:20.25},
  {id:"mrj7",name:"Sauce algerienne 290g - STAR",desc:"Épicerie",price:21.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83dd36792badc11c7bd2a.jpg",originalPrice:22.5},
  {id:"mrj8",name:"Aïn Atlas Eau minérale 1,5L",desc:"Boisson",price:3.95,cat:"boissons",emoji:"💧",imgRef:"P:69b83c636792badc11c6b573.jpg",originalPrice:4.5},
  {id:"mrj9",name:"Fromage râpé Emmental 100g - OR BLANC",desc:"Produit laitier",price:18.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b83c496792badc11c6a2c6.jpg",originalPrice:19},
  {id:"mrj10",name:"Tranche fromage fondu Mozzarella x12 200g - OR BLANC",desc:"Produit laitier",price:19.5,cat:"laitier",emoji:"🧀",imgRef:"P:64b66f2f9a6e474c914e56cf.jpeg",originalPrice:20.25},
  {id:"mrj11",name:"Aquafina Eau de table 33cl",desc:"Boisson",price:1.5,cat:"boissons",emoji:"💧",imgRef:"G:03846146-9c7d-4df7-a358-f6769f869041.png",originalPrice:1.9},
  {id:"mrj12",name:"Jus de fruits au lait orange et à la fraise Fawakih 900ml - CHERGUI",desc:"Produit laitier",price:11.95,cat:"laitier",emoji:"🧀",imgRef:"G:16340cda-6bdd-45a9-883f-bb64c84b90af.jpeg",originalPrice:12.95},
  {id:"mrj13",name:"Champignons émincés 3x 185g - MARJANE",desc:"Épicerie",price:23.5,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8429b6792badc11cb0c6d.jpeg",originalPrice:29.95},
  {id:"mrj14",name:"Tranche fromage fondu hamburger x12 200g - OR BLANC",desc:"Produit laitier",price:16.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b83c496792badc11c6a2f6.jpg",originalPrice:17},
  {id:"mrj15",name:"Fromage frais nature sucré 8x80g - GERVAIS",desc:"Produit laitier",price:18.95,cat:"laitier",emoji:"🧀",imgRef:"G:2e53e3fb-9931-4096-b335-ffecf7151063.webp",originalPrice:23.95},
  {id:"mrj16",name:"Sidi Ali Eau minérale 2L",desc:"Boisson",price:4.95,cat:"boissons",emoji:"💧",imgRef:"G:37305fb1-dcec-4245-a464-7ab1b5f5e234.jpg",originalPrice:5.25},
  {id:"mrj17",name:"Tranche fromage fondu Emmental x12 200g - OR BLANC",desc:"Produit laitier",price:16.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b83c496792badc11c6a2f5.jpg",originalPrice:17},
  {id:"mrj18",name:"Pack génoises au chocolat Kinder Délice 10x39g - KINDER",desc:"Sucré",price:49.95,cat:"sucre",emoji:"🍬",imgRef:"P:696a62c184c41be0782672c0.jpg",originalPrice:61.3},
  {id:"mrj19",name:"Beurre doux frais 1kg - JAOUDA",desc:"Produit laitier",price:86.9,cat:"laitier",emoji:"🧀",imgRef:"G:843e161c-d183-41b6-b4dd-b70edbd8b349.jpeg",originalPrice:98.95},
  {id:"mrj20",name:"Plateau œufs frais x30 unités - NATUR ŒUF",desc:"Épicerie",price:18.95,cat:"epicerie",emoji:"🧂",imgRef:"G:27639693-9117-4e7e-9333-e4ca337cc808.jpeg"},
  {id:"mrj21",name:"Viande hachée de bœuf 500g",desc:"Boucherie / volaille fraîche",price:54.9,cat:"boucherie",emoji:"🥩",imgRef:"P:699f4adf4d512ba358c584e4.webp"},
  {id:"mrj22",name:"Banane 1Kg",desc:"Fruit ou légume frais",price:21.9,cat:"fruits",emoji:"🍎",imgRef:"P:693038063bed1b9013a3b118.jpeg"},
  {id:"mrj23",name:"Pack Aquafina Eau de table 6 x 1,5L",desc:"Boisson",price:28.65,cat:"boissons",emoji:"💧",imgRef:"G:3774e594-c973-4adc-96f5-6f8bbe721259.jpg"},
  {id:"mrj24",name:"Fromage frais sucré 8x80g - PERLY",desc:"Produit laitier",price:23.95,cat:"laitier",emoji:"🧀",imgRef:"G:c4dbf990-6dd3-4d54-9cbb-c8c0961f9fa2.jpeg"},
  {id:"mrj25",name:"Viande hachée maigre de bœuf 500g",desc:"Boucherie / volaille fraîche",price:64.9,cat:"boucherie",emoji:"🥩",imgRef:"P:699f4adf4d512ba358c584e2.webp"},
  {id:"mrj26",name:"Salim Lait Entier UHT 6x500ml",desc:"Produit laitier",price:36,cat:"laitier",emoji:"🧀",imgRef:"G:5228823b-111a-4f54-9f64-71b59b779b4d.jpg"},
  {id:"mrj27",name:"Fromage frais nature 8x80g - PERLY",desc:"Produit laitier",price:23.95,cat:"laitier",emoji:"🧀",imgRef:"G:52ec0433-8df7-4a68-b499-0ec8ad845142.jpeg"},
  {id:"mrj28",name:"Kiwi moyen calibre 500g",desc:"Fruit ou légume frais",price:26.9,cat:"fruits",emoji:"🍎",imgRef:"P:6929f24f196a61f6254ed3a8.jpg"},
  {id:"mrj29",name:"Viande hachée de dinde nature 500g",desc:"Boucherie / volaille fraîche",price:22.9,cat:"boucherie",emoji:"🥩",imgRef:"G:18af0148-3da2-4055-9b99-57699e01c997.webp"},
  {id:"mrj30",name:"Fromage frais à tartiner 2x190g - JEBLI",desc:"Produit laitier",price:23.5,cat:"laitier",emoji:"🧀",imgRef:"G:89bc21be-5af7-4bca-aac8-0ae14ed55170.png",originalPrice:29.95},
  {id:"mrj31",name:"Nouilles piquantes au poulet et aux quatres fromages 145g - SAMYANG",desc:"Produit laitier",price:17.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b847c76792badc11ce7008.png",originalPrice:21.95},
  {id:"mrj32",name:"Filets de dinde 500g",desc:"Épicerie",price:22.9,cat:"epicerie",emoji:"🧂",imgRef:"G:e844f079-6beb-4818-9bb6-0a48577dba8c.jpg"},
  {id:"mrj33",name:"Chips en tuiles saveur paprika 165g - PRINGLES",desc:"Snacking",price:21.9,cat:"snacking",emoji:"🥔",imgRef:"X"},
  {id:"mrj34",name:"Poulet x1 environ 1,25Kg - FILIERE M",desc:"Boucherie / volaille fraîche",price:37.5,cat:"boucherie",emoji:"🥩",imgRef:"P:69b8546818eef1ea28050cea.jpg"},
  {id:"mrj35",name:"Chips en tuiles saveur crème et oignon 165g - PRINGLES",desc:"Produit laitier",price:21.95,cat:"laitier",emoji:"🧀",imgRef:"P:66bb772050de48cf8e7421dd.jpg"},
  {id:"mrj36",name:"Pommes frites 7/7 1Kg - CLOCK",desc:"Surgelés",price:22.95,cat:"surgeles",emoji:"🧊",imgRef:"G:ec388b93-6eec-4c2d-a40b-9237f27e1320.jpg"},
  {id:"mrj37",name:"Chips en tuiles saveur barbecue 165g - PRINGLES",desc:"Snacking",price:21.9,cat:"snacking",emoji:"🥔",imgRef:"G:d2e8ae82-07f4-4011-8a34-a1d0329dddb1.jpg"},
  {id:"mrj38",name:"Beurre doux en plaquette 200g - BADAOUIA",desc:"Produit laitier",price:19.95,cat:"laitier",emoji:"🧀",imgRef:"G:e6c81d82-3327-4495-878f-27d72e97e0ac.jpeg",originalPrice:27},
  {id:"mrj39",name:"Orange à jus en filet 2Kg",desc:"Boisson",price:13.9,cat:"boissons",emoji:"💧",imgRef:"P:68273318aebbde8d01a4b864.webp"},
  {id:"mrj40",name:"Orange à jus 1Kg",desc:"Boisson",price:7.9,cat:"boissons",emoji:"💧",imgRef:"P:68c2cf3d70ab038f43a3888b.jpg"},
  {id:"mrj41",name:"Citron jaune 500g",desc:"Fruit ou légume frais",price:9.9,cat:"fruits",emoji:"🍎",imgRef:"G:7d593702-d9cb-46a6-8bbb-538dd458a17c.jpg"},
  {id:"mrj42",name:"Beefsteak de bœuf 500g - FILIÈRE M",desc:"Boucherie / volaille fraîche",price:79.9,cat:"boucherie",emoji:"🥩",imgRef:"G:0afbb9dd-33ed-4076-a3b2-d51a66701e40.jpg"},
  {id:"mrj43",name:"Cervelle de bœuf à la pièce",desc:"Boucherie / volaille fraîche",price:79.9,cat:"boucherie",emoji:"🥩",imgRef:"G:01ac5dd5-1835-416f-b0ba-fc4c12a80e2f.jpg"},
  {id:"mrj44",name:"Faux filet de bœuf 250g - FILIERE M",desc:"Épicerie",price:41.9,cat:"epicerie",emoji:"🧂",imgRef:"P:69b840b06792badc11c9b8cd.jpeg"},
  {id:"mrj45",name:"Steak de rumsteak 500G",desc:"Boucherie / volaille fraîche",price:71.9,cat:"boucherie",emoji:"🥩",imgRef:"G:c5cd7195-6600-4694-b714-82dfe9a62294.jpg"},
  {id:"mrj46",name:"Merguez de bœuf 500g - FILIERE M",desc:"Boucherie / volaille fraîche",price:39.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69b8546818eef1ea28050ce4.jpg"},
  {id:"mrj47",name:"Brochettes de bœuf 500g - FILIERE M",desc:"Boucherie / volaille fraîche",price:79.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69b8546818eef1ea28050ce8.jpg"},
  {id:"mrj48",name:"Saucisses de bœuf aux fines herbes 500g",desc:"Boucherie / volaille fraîche",price:52.9,cat:"boucherie",emoji:"🥩",imgRef:"G:afb155c2-bef2-432e-b021-9f60b9807279.jpg"},
  {id:"mrj49",name:"Viande tagine de bœuf avec os 500g - FILIÈRE M",desc:"Boucherie / volaille fraîche",price:44.9,cat:"boucherie",emoji:"🥩",imgRef:"P:694586e09c1267124549d42d.jpeg"},
  {id:"mrj50",name:"Epaule de bœuf avec os 500g - FILIERE M",desc:"Épicerie",price:67.9,cat:"epicerie",emoji:"🧂",imgRef:"P:694128c7e68e7e72831bbb59.jpg"},
  {id:"mrj51",name:"Brochettes de boeuf aux trois poivres 500g - FILIERE M",desc:"Boucherie / volaille fraîche",price:79.9,cat:"boucherie",emoji:"🥩",imgRef:"G:17bd1dea-20ed-4b3a-9479-64ae3068bcae.webp"},
  {id:"mrj52",name:"Emincé de boeuf rouge mariné 500g - FILIERE M",desc:"Boucherie / volaille fraîche",price:72.9,cat:"boucherie",emoji:"🥩",imgRef:"G:8f32c559-53e8-47db-b40d-a2e960d68454.webp"},
  {id:"mrj53",name:"Jarret de bœuf avec os 500g - FILIERE M",desc:"Boucherie / volaille fraîche",price:68.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69b8546818eef1ea28050ce6.jpg"},
  {id:"mrj54",name:"Côte de bœuf 500g - FILIERE M",desc:"Épicerie",price:71.9,cat:"epicerie",emoji:"🧂",imgRef:"G:8c239715-9fb7-4177-b9cb-3a06e185b662.webp"},
  {id:"mrj55",name:"Tagine de bœuf avec os 500G",desc:"Épicerie",price:44.9,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8546818eef1ea28050cc6.jpg"},
  {id:"mrj56",name:"Saucisses de boeuf piquantes 500g",desc:"Boucherie / volaille fraîche",price:52.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69b84f4818eef1ea2801d85f.jpeg"},
  {id:"mrj57",name:"Saucisses 500g",desc:"Boucherie / volaille fraîche",price:52.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69412933747bce307ddbbf61.jpg"},
  {id:"mrj58",name:"Jarret de bœuf sans os 500g - FILIERE M",desc:"Boucherie / volaille fraîche",price:78.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69b8546818eef1ea28050d04.jpg"},
  {id:"mrj59",name:"Tagine de bœuf avec os 1kg",desc:"Épicerie",price:89.9,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8546818eef1ea28050cd6.jpg"},
  {id:"mrj60",name:"Brochettes de boeuf rouge marinées 500g - FILIERE M",desc:"Boucherie / volaille fraîche",price:79.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69b8546818eef1ea28050cd1.jpg"},
  {id:"mrj61",name:"Viande tagine de boeuf sans os 1Kg - FILIERE M",desc:"Boucherie / volaille fraîche",price:149.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69b8546818eef1ea28050ce3.jpg"},
  {id:"mrj62",name:"Filet de bœuf 500g - FILIÈRE M",desc:"Épicerie",price:109.9,cat:"epicerie",emoji:"🧂",imgRef:"G:8c8109c6-615d-4a52-ad41-860caf15de6d.jpg"},
  {id:"mrj63",name:"Émincé de boeuf rouge mariné au thym et romarin 500g",desc:"Boucherie / volaille fraîche",price:72.9,cat:"boucherie",emoji:"🥩",imgRef:"P:694128c7e68e7e72831bbb55.jpg"},
  {id:"mrj64",name:"Brochettes de bœuf marinee au thym romarin 500g",desc:"Boucherie / volaille fraîche",price:79.9,cat:"boucherie",emoji:"🥩",imgRef:"P:6a31731733f719ba1a91add8.jpg"},
  {id:"mrj65",name:"Merguez de boeuf cocktail 500g",desc:"Boucherie / volaille fraîche",price:49.9,cat:"boucherie",emoji:"🥩",imgRef:"P:693038063bed1b9013a3b13a.webp"},
  {id:"mrj66",name:"Ris de bœuf 250g",desc:"Épicerie",price:29.9,cat:"epicerie",emoji:"🧂",imgRef:"G:b82fbff0-db1a-4d88-a08a-e12c8e9cefca.webp"},
  {id:"mrj67",name:"La rate de bœuf 250g",desc:"Épicerie",price:24.9,cat:"epicerie",emoji:"🧂",imgRef:"G:a2abfa1a-0fc0-45b4-8035-8a06bcccabd5.webp"},
  {id:"mrj68",name:"Émincé de boeuf rouge mariné au thym et romarin 500g - FILIERE M",desc:"Boucherie / volaille fraîche",price:72.9,cat:"boucherie",emoji:"🥩",imgRef:"P:69c2ba398d65ba599a45147a.png"},
  {id:"mrj69",name:"Emince de bœuf nature 500G",desc:"Épicerie",price:65.9,cat:"epicerie",emoji:"🧂",imgRef:"G:703e0076-e1c8-485c-9917-d9175f0b5bc9.jpg"},
  {id:"mrj70",name:"Fromage gouda nature en tranches 100g - MARJANE",desc:"Produit laitier",price:6.6,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee49d.webp"},
  {id:"mrj71",name:"Fromage Gouda nature en tranches 100g - GRAN CŒUR",desc:"Produit laitier",price:18,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4d1.webp"},
  {id:"mrj72",name:"Fromage Emmental en morceau 100g - PRÉSIDENT",desc:"Produit laitier",price:27,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4b0.webp"},
  {id:"mrj73",name:"Fromage Gouda nature râpé 100g - GRAN CŒUR",desc:"Produit laitier",price:18,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4da.webp"},
  {id:"mrj74",name:"Fromage Gouda nature en tranches 100g - KROON",desc:"Produit laitier",price:18.6,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c7.webp"},
  {id:"mrj75",name:"Fromage gouda cumin en tranches 100g - MARJANE",desc:"Produit laitier",price:15.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4be.webp"},
  {id:"mrj76",name:"Fromage maasdam en tranches 100g - MARJANE",desc:"Produit laitier",price:15.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4cb.webp"},
  {id:"mrj77",name:"Fromage Brie en morceau 100g - PRÉSIDENT",desc:"Produit laitier",price:29,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4af.webp"},
  {id:"mrj78",name:"Fromage gouda chili bloc 100g - MARJANE",desc:"Produit laitier",price:13.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4ce.webp"},
  {id:"mrj79",name:"Fromage fumé en bloc 100g - MARJANE",desc:"Produit laitier",price:11,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c5.webp"},
  {id:"mrj80",name:"Fromage Edam râpé 100g - KROON",desc:"Produit laitier",price:16.4,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4db.webp"},
  {id:"mrj81",name:"Fromage fumé en tranches 100g - MARJANE",desc:"Produit laitier",price:27.8,cat:"laitier",emoji:"🧀",imgRef:"P:692d6bc6a88cecefa58baf9e.jpg"},
  {id:"mrj82",name:"Fromage Edam râpé 100g - MARJANE",desc:"Produit laitier",price:11.6,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4d7.webp"},
  {id:"mrj83",name:"Fromage Gouda au cumin en tranches 100g - GRAN CŒUR",desc:"Produit laitier",price:18.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee49b.webp"},
  {id:"mrj84",name:"Fromage Edam 45% m.g. râpé 100g - OR BLANC",desc:"Produit laitier",price:12.8,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a0.webp"},
  {id:"mrj85",name:"Fromage râpé Mozzarella 100g - LE BERGER",desc:"Produit laitier",price:6.6,cat:"laitier",emoji:"🧀",imgRef:"P:69b8546818eef1ea28050cdb.jpg"},
  {id:"mrj86",name:"Fromage Edam 45% m.g.en tranches 100g - OR BLANC",desc:"Produit laitier",price:15,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4aa.webp"},
  {id:"mrj87",name:"Fromage maasdam râpé 100g - MARJANE",desc:"Produit laitier",price:14.25,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4d5.webp"},
  {id:"mrj88",name:"Fromage Edam en tranches 100g - MARJANE",desc:"Produit laitier",price:11.6,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a2.webp"},
  {id:"mrj89",name:"Fromage Ricotta 0% en morceau 100g - FROMADEL",desc:"Produit laitier",price:11,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c4.webp"},
  {id:"mrj90",name:"Fromage mozzarella en bloc 100g - LE BERGER",desc:"Produit laitier",price:8.9,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f7b4ea467f81cee496.webp"},
  {id:"mrj91",name:"Fromage Mozzarella râpé 100g - OR BLANC",desc:"Produit laitier",price:12.8,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4b5.webp"},
  {id:"mrj92",name:"Fromage Edam en morceau 100g - GRAN CŒUR",desc:"Produit laitier",price:9.99,cat:"laitier",emoji:"🧀",imgRef:"P:69b841396792badc11ca181d.jpeg"},
  {id:"mrj93",name:"Fromage Mozzarella en tranches 100g - OR BLANC",desc:"Produit laitier",price:12.8,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a4.webp"},
  {id:"mrj94",name:"Fromage blanc régime sans sel 100g - LE BERGER",desc:"Produit laitier",price:6.6,cat:"laitier",emoji:"🧀",imgRef:"P:69b8546818eef1ea28050cfa.jpg"},
  {id:"mrj95",name:"Fromage Fumé nature en tranche 100g - GRAN CŒUR",desc:"Produit laitier",price:6.7,cat:"laitier",emoji:"🧀",imgRef:"P:68c2cf3d70ab038f43a388a2.jpg"},
  {id:"mrj96",name:"Fromage cheddar en bloc 100g - MARJANE",desc:"Produit laitier",price:15.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a6.webp"},
  {id:"mrj97",name:"Fromage blanc ail et fines herbes 100g - LE BERGER",desc:"Produit laitier",price:6.7,cat:"laitier",emoji:"🧀",imgRef:"P:69b8546818eef1ea28050cd8.jpg"},
  {id:"mrj98",name:"Fromage mozzarella en tranches 100g - MARJANE",desc:"Produit laitier",price:12.75,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee497.webp"},
  {id:"mrj99",name:"Fromage Tomme noire des Pyrénées en tranches 100g - BONGRAIN SAVECIA",desc:"Produit laitier",price:27.8,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a1.webp"},
  {id:"mrj100",name:"Fromage maasdam en bloc 100g - MARJANE",desc:"Produit laitier",price:14.25,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4ab.webp"},
  {id:"mrj101",name:"Fromage gouda cumin bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:13.9,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee49c.webp"},
  {id:"mrj102",name:"Fromage fumé piquant chili en tranche 100g - GRAN CŒUR",desc:"Produit laitier",price:6.6,cat:"laitier",emoji:"🧀",imgRef:"P:69b8546818eef1ea28050ce9.jpg"},
  {id:"mrj103",name:"Fromage gouda nature 100g - JACKS CHEESE",desc:"Produit laitier",price:12.9,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4ac.webp"},
  {id:"mrj104",name:"Fromage gouda nature bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:12.9,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee498.webp"},
  {id:"mrj105",name:"Fromage gouda pesto en bloc 100g - MARJANE",desc:"Produit laitier",price:23.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee49e.webp"},
  {id:"mrj106",name:"Fromage fumé râpé 100g - MARJANE",desc:"Produit laitier",price:20.5,cat:"laitier",emoji:"🧀",imgRef:"P:692d6bc6a88cecefa58baf95.jpg"},
  {id:"mrj107",name:"Fromage gouda bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:11.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a8.webp"},
  {id:"mrj108",name:"Fromage Gouda nature râpé 100g - KROON",desc:"Produit laitier",price:18.6,cat:"laitier",emoji:"🧀",imgRef:"P:692d6bc6a88cecefa58baf91.jpg"},
  {id:"mrj109",name:"Fromage maasdam bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:12.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a9.webp"},
  {id:"mrj110",name:"Fromage de chèvre en bûche 100g - LA P'TITE CHEVRE",desc:"Produit laitier",price:12.8,cat:"laitier",emoji:"🧀",imgRef:"P:693038063bed1b9013a3b157.png"},
  {id:"mrj111",name:"Fromage gouda chili râpé 100g - MARJANE",desc:"Produit laitier",price:19.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee49f.webp"},
  {id:"mrj112",name:"Fromage de chevre doux bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:27.95,cat:"laitier",emoji:"🧀",imgRef:"P:692d6bc6a88cecefa58baf84.jpg"},
  {id:"mrj113",name:"Fromage râpé gouda cumin 100g - JACKS CHEESE",desc:"Produit laitier",price:13.9,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee499.webp"},
  {id:"mrj114",name:"Fromage en tranches gouda aux truffes noirs 100g - JACKS CHEESE",desc:"Produit laitier",price:35.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a3.webp"},
  {id:"mrj115",name:"Fromage gouda aux truffes noirs bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:35.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a5.webp"},
  {id:"mrj116",name:"Fromage chevre herbes italiens 100g - JACKS CHEESE",desc:"Produit laitier",price:29.95,cat:"laitier",emoji:"🧀",imgRef:"P:692d6bc6a88cecefa58baf97.jpg"},
  {id:"mrj117",name:"Fromage râpé maasdam 100g - JACKS CHEESE",desc:"Produit laitier",price:12.95,cat:"laitier",emoji:"🧀",imgRef:"P:692d6bc6a88cecefa58baf88.jpg"},
  {id:"mrj118",name:"Fromage en tranches gouda jalapeno 100g - JACKS CHEESE",desc:"Produit laitier",price:21.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4a7.webp"},
  {id:"mrj119",name:"Fromage tricolore bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:35.5,cat:"laitier",emoji:"🧀",imgRef:"P:692d6bc6a88cecefa58baf8b.jpg"},
  {id:"mrj120",name:"Fromage gouda wasabi bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:23.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee49a.webp"},
  {id:"mrj121",name:"Fromage Mozzarella râpé 100g - MARJANE",desc:"Produit laitier",price:12.8,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4df.webp"},
  {id:"mrj122",name:"Fromage cheddar en tranches 100g - MARJANE",desc:"Produit laitier",price:17.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4bc.webp"},
  {id:"mrj123",name:"Fromage cheddar râpé 100g - MARJANE",desc:"Produit laitier",price:17.5,cat:"laitier",emoji:"🧀",imgRef:"P:692d699a8af21f994028fc2b.jpg"},
  {id:"mrj124",name:"Fromage gouda nature râpé 100g - MARJANE",desc:"Produit laitier",price:14.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c6.webp"},
  {id:"mrj125",name:"Fromage gouda chili en tranches 100g - MARJANE",desc:"Produit laitier",price:21.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c3.webp"},
  {id:"mrj126",name:"Fromage Edam en tranches 100g - KROON",desc:"Produit laitier",price:16.4,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4b8.webp"},
  {id:"mrj127",name:"Fromage gouda pesto en tranches 100g - MARJANE",desc:"Produit laitier",price:23.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c0.webp"},
  {id:"mrj128",name:"Fromage Edam en morceau 100g - MARJANE",desc:"Produit laitier",price:11.6,cat:"laitier",emoji:"🧀",imgRef:"P:69b853cb18eef1ea2804af4e.png"},
  {id:"mrj129",name:"Fromage mozzarella en bloc 100g - MARJANE",desc:"Produit laitier",price:12.75,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4cd.webp"},
  {id:"mrj130",name:"Fromage gouda nature bloc 100g - MARJANE",desc:"Produit laitier",price:27.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4b4.webp"},
  {id:"mrj131",name:"Fromage gouda cumin râpé 100g - MARJANE",desc:"Produit laitier",price:13.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4b7.webp"},
  {id:"mrj132",name:"Fromage gouda cumin en bloc 100g - MARJANE",desc:"Produit laitier",price:21.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4d3.webp"},
  {id:"mrj133",name:"Fromage gouda pesto râpé 100g - MARJANE",desc:"Produit laitier",price:23.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4dc.webp"},
  {id:"mrj134",name:"Fromage Maasdam en morceau 100g - KROON",desc:"Produit laitier",price:17.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b841396792badc11ca180a.png"},
  {id:"mrj135",name:"Fromage Edam 45% m.g. en morceau 100g - OR BLANC",desc:"Produit laitier",price:15,cat:"laitier",emoji:"🧀",imgRef:"P:69b841396792badc11ca1820.jpeg"},
  {id:"mrj136",name:"Fromage Mozzarella en morceau 100g - OR BLANC",desc:"Produit laitier",price:12.8,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4ae.webp"},
  {id:"mrj137",name:"Fromage Gouda cumin en tranches 100g - KROON",desc:"Produit laitier",price:18.6,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4cf.webp"},
  {id:"mrj138",name:"Fromage Emmental râpé 100g - PRÉSIDENT",desc:"Produit laitier",price:17,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c2.webp"},
  {id:"mrj139",name:"Fromage Emmental en tranches 100g - PRÉSIDENT",desc:"Produit laitier",price:27,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4b6.webp"},
  {id:"mrj140",name:"Fromage Edam en morceau 100g - KROON",desc:"Produit laitier",price:16.4,cat:"laitier",emoji:"🧀",imgRef:"P:69b841396792badc11ca181c.jpeg"},
  {id:"mrj141",name:"Fromage Gouda cumin en morceau 100g - KROON",desc:"Produit laitier",price:18.6,cat:"laitier",emoji:"🧀",imgRef:"P:69b841396792badc11ca1813.jpeg"},
  {id:"mrj142",name:"Fromage Gouda nature en morceau 100g - KROON",desc:"Produit laitier",price:18.6,cat:"laitier",emoji:"🧀",imgRef:"P:69b841396792badc11ca1810.jpeg"},
  {id:"mrj143",name:"Fromage Maasdam râpé 100g - KROON",desc:"Produit laitier",price:17.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4d6.webp"},
  {id:"mrj144",name:"Fromage Maasdam en tranches 100g - KROON",desc:"Produit laitier",price:17.5,cat:"laitier",emoji:"🧀",imgRef:"P:692d699a8af21f994028fc2c.jpg"},
  {id:"mrj145",name:"Fromage Gouda cumin râpé 100g - KROON",desc:"Produit laitier",price:18.6,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4e0.webp"},
  {id:"mrj146",name:"Fromage Edam râpé 100g - GRAN CŒUR",desc:"Produit laitier",price:14.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4b2.webp"},
  {id:"mrj147",name:"Fromage Maasdam en tranches 100g - GRAN CŒUR",desc:"Produit laitier",price:15.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c8.webp"},
  {id:"mrj148",name:"Fromage Maasdam en morceau 100g - GRAN CŒUR",desc:"Produit laitier",price:15.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b841396792badc11ca180b.jpeg"},
  {id:"mrj149",name:"Fromage Edam en tranches 100g - GRAN CŒUR",desc:"Produit laitier",price:14.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c1.webp"},
  {id:"mrj150",name:"Fromage fumé nature 200g - GRAN CŒUR",desc:"Produit laitier",price:27.8,cat:"laitier",emoji:"🧀",imgRef:"P:69b8411e6792badc11ca0521.jpeg"},
  {id:"mrj151",name:"Fromage Maasdam râpé 100g - GRAN CŒUR",desc:"Produit laitier",price:15.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4d2.webp"},
  {id:"mrj152",name:"Fromage Gouda au cumin en morceau 100g - GRAN CŒUR",desc:"Produit laitier",price:18.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b841396792badc11ca1815.jpeg"},
  {id:"mrj153",name:"Fromage Gouda nature en morceau 100g - GRAN CŒUR",desc:"Produit laitier",price:18,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4ad.webp"},
  {id:"mrj154",name:"Fromage Edam Boule Environ 500G - Gran Cœur",desc:"Produit laitier",price:12.8,cat:"laitier",emoji:"🧀",imgRef:"P:69b8411e6792badc11ca0506.jpeg"},
  {id:"mrj155",name:"Fromage fumé au poivre en tranche 100g - GRAN COEUR",desc:"Produit laitier",price:42.8,cat:"laitier",emoji:"🧀",imgRef:"P:69b8546818eef1ea28050cef.jpg"},
  {id:"mrj156",name:"Fromage en tranches gouda cumin 100g - JACKS CHEESE",desc:"Produit laitier",price:13.9,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4bf.webp"},
  {id:"mrj157",name:"Fromage en tranche fumé red chili 100g - JACKS CHEESE",desc:"Produit laitier",price:16.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4dd.webp"},
  {id:"mrj158",name:"Fromage maasdam en tranches 100g - JACKS CHEESE",desc:"Produit laitier",price:12.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4cc.webp"},
  {id:"mrj159",name:"Fromage fumé red chili bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:16.95,cat:"laitier",emoji:"🧀",imgRef:"P:692d699a8af21f994028fc49.jpg"},
  {id:"mrj160",name:"Fromage en tranches de chevre doux 100g - JACKS CHEESE",desc:"Produit laitier",price:27.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4ca.webp"},
  {id:"mrj161",name:"Fromage gouda aux herbes italiens en tranches 100g - JACKS CHEESE",desc:"Produit laitier",price:21.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4bb.webp"},
  {id:"mrj162",name:"Fromage râpé gouda bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:11.5,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4d8.webp"},
  {id:"mrj163",name:"Fromage gouda aux herbes italiens bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:21.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4ba.webp"},
  {id:"mrj164",name:"Fromage gouda jalapeno bloc 100g - JACKS CHEESE",desc:"Produit laitier",price:21.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4b9.webp"},
  {id:"mrj165",name:"Fromage en tranches chevre herbes italiens 100g - JACKS CHEESE",desc:"Produit laitier",price:29.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4c9.webp"},
  {id:"mrj166",name:"Fromage gouda nutmix en tranches 100g - JACKS CHEESE",desc:"Produit laitier",price:27.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4d0.webp"},
  {id:"mrj167",name:"Fromage en tranches gouda wasabi 100g - JACKS CHEESE",desc:"Produit laitier",price:23.95,cat:"laitier",emoji:"🧀",imgRef:"P:695e49f8b4ea467f81cee4bd.webp"},
  {id:"mrj168",name:"Ciel Pack 12x1.5l",desc:"Boisson",price:60,cat:"boissons",emoji:"💧",imgRef:"G:f71bb97a-ffe2-4356-a30a-048c3d468510.png"},
  {id:"mrj169",name:"Sidi Harazem Eau minérale 12x50cl",desc:"Boisson",price:30.15,cat:"boissons",emoji:"💧",imgRef:"G:defbeaba-dabd-4b27-a87f-1fc4fb3ef1fd.webp"},
  {id:"mrj170",name:"Ciel Eau De Table 6x1,5l",desc:"Boisson",price:30,cat:"boissons",emoji:"💧",imgRef:"X"},
  {id:"mrj171",name:"Huile de table 1L - FAYZ",desc:"Épicerie",price:16.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83e236792badc11c7f5dd.jpeg"},
  {id:"mrj172",name:"Huile de tournesol 1L - HUILOR",desc:"Épicerie",price:18.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b841546792badc11ca2b19.jpeg"},
  {id:"mrj173",name:"Huile de table trois graines 0,5L - LESIEUR",desc:"Épicerie",price:8.95,cat:"epicerie",emoji:"🧂",imgRef:"P:66226f7602070d9c6a19b39d.jpg"},
  {id:"mrj174",name:"Huile de table équilibré 5L - LESIEUR",desc:"Épicerie",price:88.5,cat:"epicerie",emoji:"🧂",imgRef:"P:69b841546792badc11ca2b16.jpeg"},
  {id:"mrj175",name:"Huile de table trois graines 2L - LESIEUR",desc:"Épicerie",price:35.8,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83dee6792badc11c7d02d.jpg"},
  {id:"mrj176",name:"Huile de table trois graines 1L - LESIEUR",desc:"Épicerie",price:17.95,cat:"epicerie",emoji:"🧂",imgRef:"P:64b673a39a6e474c914e5d89.jpeg"},
  {id:"mrj177",name:"Huile de tournesol 5L- HUILOR",desc:"Épicerie",price:94.5,cat:"epicerie",emoji:"🧂",imgRef:"P:69b841546792badc11ca2b18.jpeg"},
  {id:"mrj178",name:"Huilor Blend 2 En 1 Huile 100% Végétale 1l",desc:"Épicerie",price:44.95,cat:"epicerie",emoji:"🧂",imgRef:"G:f3e3b110-8b67-4ce5-8647-81a2bcaff5d5.png"},
  {id:"mrj179",name:"Huile de tournesol 2L - HUILOR",desc:"Épicerie",price:37.9,cat:"epicerie",emoji:"🧂",imgRef:"P:66226f7802070d9c6a19b3a3.jpg"},
  {id:"mrj180",name:"Huile de table 5L - FAYZ",desc:"Épicerie",price:81.95,cat:"epicerie",emoji:"🧂",imgRef:"G:f6fbfd3d-c7f4-4997-8c62-8296615c6319.webp"},
  {id:"mrj181",name:"Huile de table 0,5L - LOUSRA",desc:"Épicerie",price:9.75,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842f06792badc11cb45e3.jpeg"},
  {id:"mrj182",name:"Huile de table 1L - LOUSRA",desc:"Épicerie",price:18.8,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842f06792badc11cb45e1.jpeg"},
  {id:"mrj183",name:"Huile de tournesol 1L - ZOHOR",desc:"Épicerie",price:19.85,cat:"epicerie",emoji:"🧂",imgRef:"P:69b84f0d18eef1ea2801b2b4.jpeg"},
  {id:"mrj184",name:"Huile de table 2L - FAYZ",desc:"Épicerie",price:33.95,cat:"epicerie",emoji:"🧂",imgRef:"G:2c9f7d69-0345-4a4a-86cf-ec980d2a0b07.webp"},
  {id:"mrj185",name:"Huile de table 100% végétale 1L - CRISTAL",desc:"Épicerie",price:18,cat:"epicerie",emoji:"🧂",imgRef:"P:69b841546792badc11ca2b1c.jpeg"},
  {id:"mrj186",name:"Huile de table 0,5L - LIO",desc:"Épicerie",price:9.75,cat:"epicerie",emoji:"🧂",imgRef:"M:3d03d8fce50fc5815baaf77d77019e5c19157d1203c221ee17e7acc8af01efda"},
  {id:"mrj187",name:"Huile de table 2L - LOUSRA",desc:"Épicerie",price:37.4,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842f06792badc11cb45e2.jpeg"},
  {id:"mrj188",name:"Huile de table 0,5L - OLEOR",desc:"Épicerie",price:9,cat:"epicerie",emoji:"🧂",imgRef:"P:64b673a59a6e474c914e5d8d.jpeg"},
  {id:"mrj189",name:"Huile de table 1L - OLEOR",desc:"Épicerie",price:17.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83dee6792badc11c7d010.jpg"},
  {id:"mrj190",name:"Huile de table 100% végétale 5L - CRISTAL",desc:"Épicerie",price:88.95,cat:"epicerie",emoji:"🧂",imgRef:"G:25b0d089-d64c-4735-9cba-de829ef2616b.webp"},
  {id:"mrj191",name:"Huiles de table Surchoix 1L - LIO",desc:"Épicerie",price:18.8,cat:"epicerie",emoji:"🧂",imgRef:"M:e161aa29b4eecc36ee6c9d9d8753ae38fdef9695d2037f4584cec16277f99249"},
  {id:"mrj192",name:"Huile de tournesol 5L - ZOHOR",desc:"Épicerie",price:95.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842f06792badc11cb45df.jpeg"},
  {id:"mrj193",name:"Huile de table 0,5L - CRISTAL",desc:"Épicerie",price:9,cat:"epicerie",emoji:"🧂",imgRef:"P:66226f7602070d9c6a19b39f.jpg"},
  {id:"mrj194",name:"Huile de table 2L - OLEOR",desc:"Épicerie",price:35.95,cat:"epicerie",emoji:"🧂",imgRef:"P:64b673a69a6e474c914e5d8f.jpeg"},
  {id:"mrj195",name:"Huile de table 5L - OLEOR",desc:"Épicerie",price:86.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b841546792badc11ca2b1d.jpeg"},
  {id:"mrj196",name:"Huile de table 100% végétale 2L - CRISTAL",desc:"Épicerie",price:35.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b841546792badc11ca2b1b.jpeg"},
  {id:"mrj197",name:"Huile de table 5L - LOUSRA",desc:"Épicerie",price:90.1,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842f06792badc11cb45e0.jpeg"},
  {id:"mrj198",name:"Huile de table 5L - LIO",desc:"Épicerie",price:89.2,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842f06792badc11cb45de.jpeg"},
  {id:"mrj199",name:"Huiles de table Surchoix 2L - LIO",desc:"Épicerie",price:37.4,cat:"epicerie",emoji:"🧂",imgRef:"M:a33b87385994b64560581fab6f3e7ae3de57fece9d8ada70398094de6d710a37"},
  {id:"mrj200",name:"Chips en tuilles crème et oignon 40g - PRINGLES",desc:"Produit laitier",price:10.9,cat:"laitier",emoji:"🧀",imgRef:"G:37681403-5586-464a-b3bc-ee02a8c9a3d0.png"},
  {id:"mrj201",name:"Chips cheese 2x75g - CHIO",desc:"Snacking",price:24.95,cat:"snacking",emoji:"🥔",imgRef:"P:6a2a967baa4093af866a64f0.webp",originalPrice:26.95},
  {id:"mrj202",name:"Chips salées 97g - LAY'S",desc:"Snacking",price:14.95,cat:"snacking",emoji:"🥔",imgRef:"G:112d5157-161a-42b1-aab9-6cf07997efee.png",originalPrice:15},
  {id:"mrj203",name:"Chips saveur fromage et oignon épicé 97g - LAY S",desc:"Produit laitier",price:15,cat:"laitier",emoji:"🧀",imgRef:"G:93d73cfb-7852-448b-9e60-ee6971782143.png"},
  {id:"mrj204",name:"Leader chips saveur kebab 90g - LEADER FOOD",desc:"Snacking",price:11.1,cat:"snacking",emoji:"🥔",imgRef:"P:65f4936da23f29d8ae5955b9.jpg"},
  {id:"mrj205",name:"Chips en tuiles saveur paprika 40g - PRINGLES",desc:"Snacking",price:10.9,cat:"snacking",emoji:"🥔",imgRef:"P:69b84ef018eef1ea2801a00a.jpg"},
  {id:"mrj206",name:"Chips saveur kebab 97g - LAY S",desc:"Snacking",price:15,cat:"snacking",emoji:"🥔",imgRef:"G:d1795bb4-5716-4bc8-a0dd-1e8fdcff2378.png"},
  {id:"mrj207",name:"Chips saveur fromage 97g - LAY'S",desc:"Produit laitier",price:15,cat:"laitier",emoji:"🧀",imgRef:"G:16e35f1f-4f0f-453f-aa75-1e4fde4362d5.png"},
  {id:"mrj208",name:"Crunchips saveur barbecue 100g - LORENZ",desc:"Snacking",price:18.6,cat:"snacking",emoji:"🥔",imgRef:"P:64b6709e9a6e474c914e592d.jpeg"},
  {id:"mrj209",name:"Chips saveur paprika 100g - MARJANE",desc:"Snacking",price:11.95,cat:"snacking",emoji:"🥔",imgRef:"P:69b843296792badc11cb6bd6.jpeg"},
  {id:"mrj210",name:"Chips saveur fines herbes 100g - MARJANE",desc:"Snacking",price:10.95,cat:"snacking",emoji:"🥔",imgRef:"P:69b843296792badc11cb6bd2.jpeg"},
  {id:"mrj211",name:"Crunchips salées 100g - LORENZ",desc:"Snacking",price:18.8,cat:"snacking",emoji:"🥔",imgRef:"P:69b83cb26792badc11c6ee1f.JPG"},
  {id:"mrj212",name:"Leader chips saveur kebab 35g - LEADER FOOD",desc:"Snacking",price:3.2,cat:"snacking",emoji:"🥔",imgRef:"P:69b841fd6792badc11ca9d39.JPG"},
  {id:"mrj213",name:"Chips en tuiles saveur barbecue 40g - PRINGLES",desc:"Snacking",price:10.9,cat:"snacking",emoji:"🥔",imgRef:"G:c3bf3d98-db9b-43c2-88b7-5e65456d0ed6.png"},
  {id:"mrj214",name:"Chips saveur fromage et oignon 100g - MARJANE",desc:"Produit laitier",price:11.95,cat:"laitier",emoji:"🧀",imgRef:"P:69b843296792badc11cb6bd5.jpeg"},
  {id:"mrj215",name:"Chips salées 40g - MARJANE",desc:"Snacking",price:5.95,cat:"snacking",emoji:"🥔",imgRef:"P:69b843296792badc11cb6bd8.jpeg"},
  {id:"mrj216",name:"Bret'S - Chips au Fromage Sav. 125 Grs",desc:"Produit laitier",price:29.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b8400e6792badc11c94800.png"},
  {id:"mrj217",name:"Crunchips X-Cut saveur champignons 85g - LORENZ",desc:"Snacking",price:21.65,cat:"snacking",emoji:"🥔",imgRef:"P:69b83cb36792badc11c6ee26.jpeg"},
  {id:"mrj218",name:"Leader chips saveur chili 85g - LEADER FOOD",desc:"Snacking",price:11.1,cat:"snacking",emoji:"🥔",imgRef:"P:65f47ed9e48e3f1c82c6c6cf.jpg"},
  {id:"mrj219",name:"Crunchips saveur paprika 100g - LORENZ",desc:"Snacking",price:18.8,cat:"snacking",emoji:"🥔",imgRef:"P:69b83c986792badc11c6db6c.jpg"},
  {id:"mrj220",name:"Chips en tuiles saveur Original nature 40g - PRINGLES",desc:"Snacking",price:10.9,cat:"snacking",emoji:"🥔",imgRef:"G:a670158c-9f38-4716-b09f-dd710e97ccac.png"},
  {id:"mrj221",name:"Chips en tuiles saveur Original nature 165g - PRINGLES",desc:"Snacking",price:21.95,cat:"snacking",emoji:"🥔",imgRef:"G:2b8977d7-6731-481c-bef9-ead9817567aa.png"},
  {id:"mrj222",name:"Crunchips saveur fromage et oignon 100g - LORENZ",desc:"Produit laitier",price:18.8,cat:"laitier",emoji:"🧀",imgRef:"P:69b83c986792badc11c6db6a.jpg"},
  {id:"mrj223",name:"Crunchips saveur sel et vinaigre 100g - LORENZ",desc:"Snacking",price:18.8,cat:"snacking",emoji:"🥔",imgRef:"P:64b670a59a6e474c914e593a.jpeg"},
  {id:"mrj224",name:"Crunchips X-Cut salées 85g - LORENZ",desc:"Snacking",price:21.65,cat:"snacking",emoji:"🥔",imgRef:"P:69b83cb36792badc11c6ee28.JPG"},
  {id:"mrj225",name:"Chips en tuiles sel et vinaigre 165g - PRINGLES",desc:"Snacking",price:21.9,cat:"snacking",emoji:"🥔",imgRef:"P:656dea35c8e2245b73d26a43.jpg"},
  {id:"mrj226",name:"Crunchips X-Cut saveur paprika 85g - LORENZ",desc:"Snacking",price:21.65,cat:"snacking",emoji:"🥔",imgRef:"P:69b83cb36792badc11c6ee29.JPG"},
  {id:"mrj227",name:"Crunchips X-Cut saveur fromage et oignon 85g - LORENZ",desc:"Produit laitier",price:21.65,cat:"laitier",emoji:"🧀",imgRef:"P:69b83cb36792badc11c6ee27.jpg"},
  {id:"mrj228",name:"Chips salées 100g - MARJANE",desc:"Snacking",price:10.95,cat:"snacking",emoji:"🥔",imgRef:"P:69b843296792badc11cb6bd3.jpeg"},
  {id:"mrj229",name:"Chips Paprika 40g - MARJANE",desc:"Snacking",price:5.95,cat:"snacking",emoji:"🥔",imgRef:"P:699f4bc24d512ba358c5f95f.webp"},
  {id:"mrj230",name:"Chips saveur piment doux chili 100g - MARJANE",desc:"Snacking",price:11.95,cat:"snacking",emoji:"🥔",imgRef:"P:69b843296792badc11cb6bd9.jpeg"},
  {id:"mrj231",name:"Chips Hot spicy 40g - MARJANE",desc:"Snacking",price:5.95,cat:"snacking",emoji:"🥔",imgRef:"P:69b8530a18eef1ea28043e6b.webp"},
  {id:"mrj232",name:"Chips saveur chili et citron 97g - LAY'S",desc:"Snacking",price:15,cat:"snacking",emoji:"🥔",imgRef:"G:e3fe6d61-dc5d-461a-9515-8dec32241573.png"},
  {id:"mrj233",name:"Chips salées 45g - LAY'S",desc:"Snacking",price:6.95,cat:"snacking",emoji:"🥔",imgRef:"G:a1cb95df-043d-4e97-935a-e26b0fb7a883.webp"},
  {id:"mrj234",name:"Leader chips salées 85g - LEADER FOOD",desc:"Snacking",price:11.1,cat:"snacking",emoji:"🥔",imgRef:"P:65f47edae48e3f1c82c6c6d1.jpg"},
  {id:"mrj235",name:"Leader chips saveur fromage 85g - LEADER FOOD",desc:"Produit laitier",price:11,cat:"laitier",emoji:"🧀",imgRef:"P:65f47ed9e48e3f1c82c6c6cd.jpg"},
  {id:"mrj236",name:"Chips lisse Campesina Leader Chips 85g - LEADER FOOD",desc:"Snacking",price:11.1,cat:"snacking",emoji:"🥔",imgRef:"P:65f47edde48e3f1c82c6c6d7.jpg"},
  {id:"mrj237",name:"CHIPS SAVEUR POULET BRAISE BRETS 125G",desc:"Snacking",price:29.5,cat:"snacking",emoji:"🥔",imgRef:"P:69b8400e6792badc11c947fe.jpg"},
  {id:"mrj238",name:"Leader chips saveur paprika 90g - LEADER FOOD",desc:"Snacking",price:11.1,cat:"snacking",emoji:"🥔",imgRef:"P:65f47edce48e3f1c82c6c6d5.jpg"},
  {id:"mrj239",name:"Leader chips chili 35g - LEADER FOOD",desc:"Snacking",price:3.2,cat:"snacking",emoji:"🥔",imgRef:"G:964e5ed3-24ea-4cde-b4c1-ff17e8df4a9a.png"},
  {id:"mrj240",name:"Chips salées 30g - LEADER CHIPS",desc:"Snacking",price:3,cat:"snacking",emoji:"🥔",imgRef:"P:69b84ef018eef1ea2801a00b.jpeg"},
  {id:"mrj241",name:"Chips tuiles saveur paprika sans huile de palme sans gluten Curvies 170g - SCHÄR",desc:"Snacking",price:47.2,cat:"snacking",emoji:"🥔",imgRef:"P:69f4de4f390b5523455257ad.png"},
  {id:"mrj242",name:"Chips en tuiles Original sans huile de palme sans gluten Curvies 170g - SCHÄR",desc:"Snacking",price:47.2,cat:"snacking",emoji:"🥔",imgRef:"P:69f4de4f390b5523455257ac.png"},
  {id:"mrj243",name:"Crunchips WOW Jalapeno & Cream Cheese 80g - LORENZ",desc:"Snacking",price:21.5,cat:"snacking",emoji:"🥔",imgRef:"P:64b670a49a6e474c914e5938.jpeg"},
  {id:"mrj244",name:"Crunchips Wow paprika & sour cream 80g - LORENZ",desc:"Snacking",price:21.5,cat:"snacking",emoji:"🥔",imgRef:"P:69b83cb36792badc11c6ee2a.jpg"},
  {id:"mrj245",name:"Chips sour cream 2x75g - CHIO",desc:"Snacking",price:24.95,cat:"snacking",emoji:"🥔",imgRef:"P:6a2a967baa4093af866a64f4.webp",originalPrice:26.95},
  {id:"mrj246",name:"Chips red paprika 2x75g - CHIO",desc:"Snacking",price:24.95,cat:"snacking",emoji:"🥔",imgRef:"P:6a2a967baa4093af866a64ed.webp",originalPrice:26.95},
  {id:"mrj247",name:"Chips hot peperoni 2x75g - CHIO",desc:"Snacking",price:24.95,cat:"snacking",emoji:"🥔",imgRef:"P:6a2a967baa4093af866a64f1.webp",originalPrice:26.95},
  {id:"mrj248",name:"Bounty Barre de Chocolat à La Noix de Coco 57g",desc:"Sucré",price:8.5,cat:"sucre",emoji:"🍬",imgRef:"G:f33fc107-c86b-41db-87c0-c32241166d21.jpg"},
  {id:"mrj249",name:"Chocolat au Lait Fourré Lait et Biscuit 30g - NOOCO",desc:"Produit laitier",price:3.9,cat:"laitier",emoji:"🧀",imgRef:"G:e880ddb9-b9f3-4e93-9798-38606e98b8fd.webp"},
  {id:"mrj250",name:"Kitkat 2 Finger Milk Chocolate Bar",desc:"Sucré",price:41.8,cat:"sucre",emoji:"🍬",imgRef:"P:69b852b318eef1ea2804071a.png"},
  {id:"mrj251",name:"Gaufrette au cacao fourrée au lait crémeux Tronky T1 18g - KINDER",desc:"Produit laitier",price:5,cat:"laitier",emoji:"🧀",imgRef:"P:64b6757d9a6e474c914e603c.jpeg"},
  {id:"mrj252",name:"Barre chocolatée Mars 51g - MARS",desc:"Sucré",price:7.9,cat:"sucre",emoji:"🍬",imgRef:"G:854186a1-acd2-46ef-b1ef-85f24d9a4e53.jpg"},
  {id:"mrj253",name:"Barre de chocolat blanc Kinder Bueno White 43g - KINDER",desc:"Sucré",price:9.9,cat:"sucre",emoji:"🍬",imgRef:"X"},
  {id:"mrj254",name:"Twix Barres Biscuitées Nappées de Caramel et Chocolat au Lait 50g",desc:"Produit laitier",price:6.95,cat:"laitier",emoji:"🧀",imgRef:"P:696a62a984c41be078266c0e.jpg"},
  {id:"mrj255",name:"Barres chocolatées fourrées cacahuètes et caramel 50g - SNICKERS",desc:"Snacking",price:7.9,cat:"snacking",emoji:"🥔",imgRef:"G:20d5d7fa-81f2-4176-9845-cf6ce31da92e.png"},
  {id:"mrj256",name:"Snickers Barre Chocolatée aux Cacahuètes 57g",desc:"Snacking",price:6.95,cat:"snacking",emoji:"🥔",imgRef:"P:69b84de718eef1ea2800f716.jpg"},
  {id:"mrj257",name:"Barre chocolat fourré MINISNIKERS 270GR - 927",desc:"Sucré",price:45.95,cat:"sucre",emoji:"🍬",imgRef:"P:69b83f2e6792badc11c8b1f3.png"},
  {id:"mrj258",name:"Barre nougat et peanuts Extrem 36g x5 unités - EXCELO",desc:"Sucré",price:9.9,cat:"sucre",emoji:"🍬",imgRef:"G:56d825a6-5ed5-4c76-85ad-b91931553317.webp"},
  {id:"mrj259",name:"Barres de chocolat et caramel Twix 50g - TWIX",desc:"Sucré",price:7.95,cat:"sucre",emoji:"🍬",imgRef:"P:69b83ef86792badc11c88cae.jpg"},
  {id:"mrj260",name:"Barre caramel et peanuts Extrem 36g x5 unités - EXCELO",desc:"Sucré",price:9.9,cat:"sucre",emoji:"🍬",imgRef:"G:5905d502-8504-4eb7-9ba1-c599184a20d0.webp"},
  {id:"mrj261",name:"Barre nougat et caramel Extrem 36g x5 unités - EXCELO",desc:"Sucré",price:9.9,cat:"sucre",emoji:"🍬",imgRef:"G:d4d7ccc1-2152-4594-b963-b7df1e09fd17.webp"},
  {id:"mrj262",name:"Chocolat Cœur au Lait 30g - NOOCO",desc:"Produit laitier",price:3.95,cat:"laitier",emoji:"🧀",imgRef:"G:b95b0c73-7c9a-40f7-8316-3922cffacae1.webp"},
  {id:"mrj263",name:"Barre crispy caramel et cacahuètes 40g + croustillant - NOOCO",desc:"Snacking",price:18.95,cat:"snacking",emoji:"🥔",imgRef:"P:698de411a103af8801758b3d.webp"},
  {id:"mrj264",name:"Barre chocolat fourré BOUNTY 5x57g",desc:"Sucré",price:42.5,cat:"sucre",emoji:"🍬",imgRef:"P:67e32aebc78ed87b457fbfed.jpg"},
  {id:"mrj265",name:"Gaufrettes croustillantes enrobée chocolat au lait 2 Finger 12x17,7g -KITKAT",desc:"Produit laitier",price:44.85,cat:"laitier",emoji:"🧀",imgRef:"P:6907913adc922bc676cb5a8a.jpg"},
  {id:"mrj266",name:"Barre chocolatée à la noix de coco 57g - BOUNTY",desc:"Sucré",price:9.9,cat:"sucre",emoji:"🍬",imgRef:"X"},
  {id:"mrj267",name:"Barres au nougat et caramel 4+1 gratuit 225g - NOOCO",desc:"Sucré",price:19.8,cat:"sucre",emoji:"🍬",imgRef:"P:698de3166fa3f0c4ccd62e9b.webp"},
  {id:"mrj268",name:"Frites au four 600g - MARJANE",desc:"Surgelés",price:18.95,cat:"surgeles",emoji:"🧊",imgRef:"P:69b84f0d18eef1ea2801b2a4.jpg"},
  {id:"mrj269",name:"Bouchées de fromage cheddar et jalapeno 250g - FRIPOZO",desc:"Surgelés",price:37.5,cat:"surgeles",emoji:"🧊",imgRef:"P:64b0305c029a70713cc29ad4.jpeg"},
  {id:"mrj270",name:"Pomme frites surgelés 1Kg - MARJANE",desc:"Surgelés",price:25.5,cat:"surgeles",emoji:"🧊",imgRef:"G:b6d10f49-1d0c-49d2-80d8-e11ef18035ba.jpg",originalPrice:26.95},
  {id:"mrj271",name:"Pommes frites surgelés Marjane 2,5Kg",desc:"Surgelés",price:67.95,cat:"surgeles",emoji:"🧊",imgRef:"P:69b8534a18eef1ea28046479.webp"},
  {id:"mrj272",name:"Sac isotherme 20L - MARJANE",desc:"Épicerie",price:11.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8534a18eef1ea28046476.webp"},
  {id:"mrj273",name:"Pommes frites allumettes 1Kg - ECOFROST",desc:"Surgelés",price:24.95,cat:"surgeles",emoji:"🧊",imgRef:"P:6907913adc922bc676cb5a91.jpg"},
  {id:"mrj274",name:"Nachos farcis au fromage 250g - FRIPOZO",desc:"Surgelés",price:40.95,cat:"surgeles",emoji:"🧊",imgRef:"P:656dffb8c8e2245b73d5f368.png"},
  {id:"mrj275",name:"Broccoli 1Kg - BERGO",desc:"Épicerie",price:41.95,cat:"epicerie",emoji:"🧂",imgRef:"G:9efe6016-147c-4498-87a3-57b2f4460bc4.webp"},
  {id:"mrj276",name:"Petit pois King Génération 450g",desc:"Épicerie",price:21,cat:"epicerie",emoji:"🧂",imgRef:"P:6530f4ad37e8808a60620da2.jpg"},
  {id:"mrj277",name:"Epinards 450g - KING",desc:"Épicerie",price:21.2,cat:"epicerie",emoji:"🧂",imgRef:"P:657889ee1f81af24d450c764.jpg"},
  {id:"mrj278",name:"Haricots verts extra fins 400g - FINDUS",desc:"Épicerie",price:41.15,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83fb26792badc11c90f2c.jpg"},
  {id:"mrj279",name:"Pommes duchesse 750g - CASINO",desc:"Épicerie",price:39.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8471b6792badc11cdffd6.jpg"},
  {id:"mrj280",name:"Pomme noisettes 750g - LUTASO",desc:"Fruit ou légume frais",price:39.3,cat:"fruits",emoji:"🍎",imgRef:"P:67613162cd130c3a80844054.jpg"},
  {id:"mrj281",name:"Pommes noisettes 350g - SAINT ELOI",desc:"Épicerie",price:19.95,cat:"epicerie",emoji:"🧂",imgRef:"P:699f4ce74d512ba358c6950c.jpg"},
  {id:"mrj282",name:"Les Pom' Dauphines 500g - SAINT ELOI",desc:"Épicerie",price:36.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b853cb18eef1ea2804af4b.jpg"},
  {id:"mrj283",name:"Café moulu epicé 200g - ASTA",desc:"Épicerie",price:29.25,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb327c.jpeg"},
  {id:"mrj284",name:"Café soluble classic 45g - NESCAFÉ",desc:"Épicerie",price:22.95,cat:"epicerie",emoji:"🧂",imgRef:"G:f701d46e-529f-472f-add7-2d35a643c9c5.jpg"},
  {id:"mrj285",name:"Café moulu pur arabica Java Timor 200g - LES CAFÉS DUBOIS",desc:"Épicerie",price:44.5,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83d046792badc11c7278f.jpg"},
  {id:"mrj286",name:"Café moulu Ambassadeur 225g - LES CAFÉS DUBOIS",desc:"Épicerie",price:45.4,cat:"epicerie",emoji:"🧂",imgRef:"G:fae0baf1-2663-4316-b8e5-ea49810fd260.webp"},
  {id:"mrj287",name:"Café moulu pure origine Colombie pur arabica Java Timor 200g - LES CAFÉS DUBOIS",desc:"Épicerie",price:58.1,cat:"epicerie",emoji:"🧂",imgRef:"P:69b849f16792badc11cfe703.jpg"},
  {id:"mrj288",name:"Café moulu Capriccio 200g - LES CAFÉS DUBOIS",desc:"Épicerie",price:29.95,cat:"epicerie",emoji:"🧂",imgRef:"G:b945ca27-83e5-4ac0-a9ae-00785f254d93.jpg"},
  {id:"mrj289",name:"Stick 3 en 1 crem 18g - NESCAFÉ",desc:"Épicerie",price:2,cat:"epicerie",emoji:"🧂",imgRef:"P:69b840e76792badc11c9dee5.jpeg"},
  {id:"mrj290",name:"Café soluble classic 90g - NESCAFÉ",desc:"Épicerie",price:30.95,cat:"epicerie",emoji:"🧂",imgRef:"G:5fe2c029-a808-4918-a30f-26723178da4f.jpg",originalPrice:41.85},
  {id:"mrj291",name:"Café soluble gold 47,5g - NESCAFÉ",desc:"Épicerie",price:39.75,cat:"epicerie",emoji:"🧂",imgRef:"P:69b840e76792badc11c9dede.jpeg"},
  {id:"mrj292",name:"Café soluble Gold Espresso Original 100g - NESCAFÉ",desc:"Épicerie",price:70,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83b986792badc11c6203d.jpeg"},
  {id:"mrj293",name:"Café cappriccio sélection spéciale 225g - LES CAFÉS DUBOIS",desc:"Épicerie",price:35.7,cat:"epicerie",emoji:"🧂",imgRef:"M:f629b9c6479ba4452e1d97196ca2be8e41d3dd1355c0e9174a01c629e40d9e8b"},
  {id:"mrj294",name:"CAFE SOLUBLE BOCAL 190G NESCAFE",desc:"Épicerie",price:75.95,cat:"epicerie",emoji:"🧂",imgRef:"G:1ac8a2ad-a832-4ee0-9945-4220acce3e88.jpg"},
  {id:"mrj295",name:"2 boîtes café soluble Java Timor 45g -50% sur la 2ème - LES CAFÉS DUBOIS",desc:"Épicerie",price:45.5,cat:"epicerie",emoji:"🧂",imgRef:"P:699f429f4d512ba358c10f66.png"},
  {id:"mrj296",name:"Nescafé Café Instantané Classique 210g",desc:"Épicerie",price:77,cat:"epicerie",emoji:"🧂",imgRef:"G:a7ce4239-b5f7-49a8-a23d-29003f09d4b9.jpg"},
  {id:"mrj297",name:"Nescafé Café Instantané Classique 130g",desc:"Épicerie",price:51.5,cat:"epicerie",emoji:"🧂",imgRef:"G:8ff994ae-ed8d-4e39-a969-f24a4aaa3178.jpg"},
  {id:"mrj298",name:"2 paquets de café moulu grand arôme Capriccio x225g - LES CAFÉS DUBOIS",desc:"Épicerie",price:56.9,cat:"epicerie",emoji:"🧂",imgRef:"P:6579d85dc8e2245b73e9b43b.jpeg"},
  {id:"mrj299",name:"Café moulu pure origine Brésil Java Timor 2x200g - LES CAFÉS DUBOIS",desc:"Épicerie",price:91.95,cat:"epicerie",emoji:"🧂",imgRef:"G:ca04c7cc-ea47-4c0d-a4cd-c14035bb4a19.webp",originalPrice:107},
  {id:"mrj300",name:"Café soluble dynamic 45g - ASTA",desc:"Épicerie",price:18.7,cat:"epicerie",emoji:"🧂",imgRef:"G:bf104ed5-4c2e-4687-8d6f-59ef189a5fe6.jpg"},
  {id:"mrj301",name:"Café soluble classic 190g - NESCAFÉ",desc:"Épicerie",price:76.95,cat:"epicerie",emoji:"🧂",imgRef:"G:017023f0-c1d1-4c38-acbe-9428db157697.jpg"},
  {id:"mrj302",name:"Café moulu Arabica 200g - FAYZ",desc:"Épicerie",price:28.95,cat:"epicerie",emoji:"🧂",imgRef:"G:6cebd080-94c4-4706-bcb0-489ee587af44.webp"},
  {id:"mrj303",name:"Café moulu club boîte hermétique 250g - LAVAZZA",desc:"Épicerie",price:111.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8405f6792badc11c98066.jpeg"},
  {id:"mrj304",name:"Café moulu arabica raffiné 200g - ASTA",desc:"Épicerie",price:36.15,cat:"epicerie",emoji:"🧂",imgRef:"G:0f9cdeb7-a4e8-44eb-9bbd-3b196e17ee32.webp"},
  {id:"mrj305",name:"Café moulu tonique généreux 200g - ASTA",desc:"Épicerie",price:27.9,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb3278.jpeg"},
  {id:"mrj306",name:"Café Ness Ness 3 en 1 8 sticks x 18g - ASTA",desc:"Épicerie",price:17.9,cat:"epicerie",emoji:"🧂",imgRef:"G:53f1acbb-198b-4d2c-a9b4-4a8777d21ec7.webp"},
  {id:"mrj307",name:"Café mono origine Brésil 200g - MARJANE",desc:"Épicerie",price:44.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8530a18eef1ea28043e3b.webp"},
  {id:"mrj308",name:"Café en grains 1Kg - MARJANE",desc:"Épicerie",price:195.95,cat:"epicerie",emoji:"🧂",imgRef:"G:d7bb7323-f05e-4a86-bdce-7df8babe2ed8.webp"},
  {id:"mrj309",name:"Café soluble Classic 190g - MARJANE",desc:"Épicerie",price:56.95,cat:"epicerie",emoji:"🧂",imgRef:"G:840fda91-782e-4a89-ac53-63bcd76bf944.webp"},
  {id:"mrj310",name:"Café mono origine Ethiopie 200g - MARJANE",desc:"Épicerie",price:47.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8530a18eef1ea28043e3c.webp"},
  {id:"mrj311",name:"Café soluble sélection Gold 190g - MARJANE",desc:"Épicerie",price:61.95,cat:"epicerie",emoji:"🧂",imgRef:"G:c35c791a-8a9c-446e-9041-784aafad1a80.webp"},
  {id:"mrj312",name:"Café mono origine Colombie 200g - MARJANE",desc:"Épicerie",price:49.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8530a18eef1ea28043e3a.webp"},
  {id:"mrj313",name:"Café soluble gold 95g - NESCAFÉ",desc:"Épicerie",price:66.25,cat:"epicerie",emoji:"🧂",imgRef:"P:69b840e76792badc11c9dedf.jpeg"},
  {id:"mrj314",name:"Café moulu Qualità Rossa 250g - LAVAZZA",desc:"Épicerie",price:100.45,cat:"epicerie",emoji:"🧂",imgRef:"P:67e45a93c7cc7173cb9e7a50.jpg"},
  {id:"mrj315",name:"Café moulu Qualità Oro 250g - LAVAZZA",desc:"Épicerie",price:108.65,cat:"epicerie",emoji:"🧂",imgRef:"P:69f1dcc067c393222845fbae.jpg"},
  {id:"mrj316",name:"Café soluble dynamic 190g - ASTA",desc:"Épicerie",price:54.8,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb328c.JPG"},
  {id:"mrj317",name:"2 paquets de café moulu Tonique + 1 paquet Force 100g offert - ASTA",desc:"Épicerie",price:59.5,cat:"epicerie",emoji:"🧂",imgRef:"P:69b847716792badc11ce381b.webp"},
  {id:"mrj318",name:"Café soluble lyophilisé Java Timor 45g - LES CAFÉS DUBOIS",desc:"Épicerie",price:25.95,cat:"epicerie",emoji:"🧂",imgRef:"P:64b6725b9a6e474c914e5bca.jpeg"},
  {id:"mrj319",name:"Café en grains Moka 250g - CAFÉS CARRION",desc:"Épicerie",price:36.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb3289.jpeg"},
  {id:"mrj320",name:"Café moulu Del mundo riche et doux 225g - CAFÉS CARRION",desc:"Épicerie",price:30.2,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb327f.jpeg"},
  {id:"mrj321",name:"Café moulu Grano de Oro 250g - CAFÉS CARRION",desc:"Épicerie",price:52,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb327b.jpeg"},
  {id:"mrj322",name:"Café soluble Crema Java Timor 40g - LES CAFÉS DUBOIS",desc:"Épicerie",price:25.95,cat:"epicerie",emoji:"🧂",imgRef:"P:64b6725c9a6e474c914e5bcb.jpeg"},
  {id:"mrj323",name:"Café moulu Moka 225g - CAFÉS CARRION",desc:"Épicerie",price:31.9,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb3277.jpeg"},
  {id:"mrj324",name:"Café moulu Annachoua 200g - CAFÉS CARRION",desc:"Épicerie",price:26.6,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb327e.jpeg"},
  {id:"mrj325",name:"Café moulu Pur origine Brésil pur arabica Java Timor 225g - LES CAFÉS DUBOIS",desc:"Épicerie",price:54.6,cat:"epicerie",emoji:"🧂",imgRef:"P:64b672649a6e474c914e5bd7.jpeg"},
  {id:"mrj326",name:"Café soluble lyophilisé Java Timor 80g - LES CAFÉS DUBOIS",desc:"Épicerie",price:45.65,cat:"epicerie",emoji:"🧂",imgRef:"G:aeb38ddf-d0c4-459b-b873-dbb2d6896549.webp"},
  {id:"mrj327",name:"Café en grains Arabica Supérieur 250g - CAFÉS CARRION",desc:"Épicerie",price:47.7,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb328a.jpeg"},
  {id:"mrj328",name:"Café moulu Brasil 200g - CAFÉS CARRION",desc:"Épicerie",price:25.35,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb3279.jpeg"},
  {id:"mrj329",name:"Café moulu Pausa intense et corsé 200g - CAFÉS CARRION",desc:"Épicerie",price:25.35,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb327a.jpeg"},
  {id:"mrj330",name:"Café moulu Intense rouge 200g - CARTE NOIRE",desc:"Épicerie",price:60.85,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83d046792badc11c7278c.jpg"},
  {id:"mrj331",name:"Café moulu original 200g - CARTE NOIRE",desc:"Épicerie",price:60.85,cat:"epicerie",emoji:"🧂",imgRef:"P:69b83d046792badc11c72790.jpeg"},
  {id:"mrj332",name:"Café soluble original 100g - CARTE NOIRE",desc:"Épicerie",price:82.75,cat:"epicerie",emoji:"🧂",imgRef:"P:69b840e76792badc11c9dee1.jpeg"},
  {id:"mrj333",name:"Café soluble gold lyophilisé 45g - ASTA BLACK",desc:"Épicerie",price:27.15,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb328e.jpeg"},
  {id:"mrj334",name:"Café Soluble Gold Lyophilisé 190G - Asta Black",desc:"Épicerie",price:78.2,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb328d.jpg"},
  {id:"mrj335",name:"Café moulu 200g - CAFÉ TAÏBA",desc:"Épicerie",price:30.4,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb327d.jpeg"},
  {id:"mrj336",name:"Café moulu 2 x200g + paquet de café moulu 100g - TAIBA",desc:"Épicerie",price:61.95,cat:"epicerie",emoji:"🧂",imgRef:"G:f08bb45f-284d-4d37-ad90-1caba9bad317.webp"},
  {id:"mrj337",name:"Café gold cappuccino saveur noisette x8 sachets - MOKATE",desc:"Épicerie",price:19.95,cat:"epicerie",emoji:"🧂",imgRef:"G:c0f76dde-cde4-4578-ae81-af0deeed885a.webp"},
  {id:"mrj338",name:"Chicorée soluble au chocolat 200g - LEROUX",desc:"Sucré",price:61.75,cat:"sucre",emoji:"🍬",imgRef:"P:69b840e76792badc11c9dee3.jpeg"},
  {id:"mrj339",name:"Chicorée soluble vanille 100g - LEROUX",desc:"Épicerie",price:62.2,cat:"epicerie",emoji:"🧂",imgRef:"P:65fdad4acddd88736bfbad88.jpg"},
];

const CARREFOUR_CATALOG:MarketItem[]=[
  {id:"crf0",name:"Oignon Rouge 6 Pièces - Filière Qualité",desc:"Fruit ou légume frais",price:17.95,cat:"fruits",emoji:"🍎",imgRef:"G:60a5adc2-e874-4924-93d3-9bee7b30fc61.jpg",originalPrice:22.95},
  {id:"crf1",name:"Kiwi 500g",desc:"Fruit ou légume frais",price:11.48,cat:"fruits",emoji:"🍎",imgRef:"P:6729cd622499ebd608d912b2.jpg",originalPrice:19.98},
  {id:"crf2",name:"Pack Fromage Frais Nature Sans Sucre Perly 8x85g.",desc:"Produit laitier",price:19.95,cat:"laitier",emoji:"🧀",imgRef:"G:e22c6998-4c09-47ec-a3d9-d3aabb6a5b81.jpg",originalPrice:23.95},
  {id:"crf3",name:"Gouda Nature Acheese 100g",desc:"Épicerie",price:11,cat:"epicerie",emoji:"🧂",imgRef:"G:5b46e7d2-e4e6-4a56-a9c3-f1212169d7a4.jpg",originalPrice:14.9},
  {id:"crf4",name:"Sel De Cuisine Iode 1Kg - Ceberos",desc:"Épicerie",price:10.5,cat:"epicerie",emoji:"🧂",imgRef:"G:c01158c0-dacf-42ae-9540-b667fdb2872f.jpg",originalPrice:12.25},
  {id:"crf5",name:"Fromage Tranches Spécial Viva 24 tranches",desc:"Produit laitier",price:17.95,cat:"laitier",emoji:"🧀",imgRef:"P:6751d8c6d633f672ae93108d.jpg",originalPrice:19.5},
  {id:"crf6",name:"Eau Minérale Ain Saiss 2L",desc:"Boisson",price:4.95,cat:"boissons",emoji:"💧",imgRef:"G:63bf8d2c-35af-4e74-9a4c-4d029845d102.jpg",originalPrice:5.95},
  {id:"crf7",name:"Jaouda Jben Fromage à Tartiner Pack 2x160g",desc:"Produit laitier",price:19.95,cat:"laitier",emoji:"🧀",imgRef:"G:c4a2dc65-553e-4322-bb4b-adc1d84085a1.JPG",originalPrice:23.95},
  {id:"crf8",name:"Poire Barquette 500g",desc:"Fruit ou légume frais",price:11.95,cat:"fruits",emoji:"🍎",imgRef:"P:6729cedb18005e5c06a90106.jpg",originalPrice:22.5},
  {id:"crf9",name:"Tomate Cerise Mixte Barquette Azura Carton 9 unités 250g",desc:"Fruit ou légume frais",price:8.95,cat:"fruits",emoji:"🍎",imgRef:"G:4b3a703f-073e-4409-825c-88f70a6c9c1c.jpg",originalPrice:9.95},
  {id:"crf10",name:"Tomate Cerise Mélangée Azura Barquette 250g",desc:"Fruit ou légume frais",price:4.95,cat:"fruits",emoji:"🍎",imgRef:"G:7f9f3c8a-1e08-449f-a513-20b42424eea2.jpg",originalPrice:9.95},
  {id:"crf11",name:"Crevettes rouges 100/200 Landauer 800g",desc:"Boucherie / volaille fraîche",price:38.9,cat:"boucherie",emoji:"🥩",imgRef:"G:65e6d1c0-0990-456d-9e22-34d68d969731.jpg",originalPrice:44.95},
  {id:"crf12",name:"Fromage Emmental Classique Carrefour, 200g",desc:"Produit laitier",price:33.95,cat:"laitier",emoji:"🧀",imgRef:"G:71527b52-e1c9-464d-897f-952b8d97b41d.jpg",originalPrice:38.5},
  {id:"crf13",name:"Frites 9/9 Fun Fries 1kg",desc:"Surgelés",price:22.95,cat:"surgeles",emoji:"🧊",imgRef:"G:bc3788be-175d-4984-8f44-0cb9b9f7a55a.jpg",originalPrice:26.9},
  {id:"crf14",name:"Mozzarella goût Edam Bloc Cocina Viva 100g",desc:"Épicerie",price:5.9,cat:"epicerie",emoji:"🧂",imgRef:"P:6901eedf2a52e31389b2550a.jpg",originalPrice:7},
  {id:"crf15",name:"Bâtonnets Glace à L'Eau Ice Jets Carrefour 8x480ml",desc:"Surgelés",price:25.9,cat:"surgeles",emoji:"🧊",imgRef:"G:10e5a99b-1c38-4495-9344-22ed9bc8f8a2.jpg",originalPrice:32.4},
  {id:"crf16",name:"Noix De Coco A La Pièce",desc:"Fruit ou légume frais",price:12.95,cat:"fruits",emoji:"🍎",imgRef:"G:6de5a1fb-746d-486c-91fb-8f7cfd3cdcfb.jpg",originalPrice:17.95},
  {id:"crf17",name:"Pack Fromage Frais Nature Sucre Gervais 8 x 110g",desc:"Produit laitier",price:19.95,cat:"laitier",emoji:"🧀",imgRef:"G:be5b9a28-515d-4958-953d-11670be247b4.jpg",originalPrice:23.95},
  {id:"crf18",name:"Tomate Cerise All Orange Barquette 250g",desc:"Fruit ou légume frais",price:4.95,cat:"fruits",emoji:"🍎",imgRef:"G:02305a9b-34ac-4bf7-9b62-c20239d88cae.jpg",originalPrice:9.95},
  {id:"crf19",name:"Oeufs Twimen Plateau 15 unités.",desc:"Produit laitier",price:11.95,cat:"laitier",emoji:"🧀",imgRef:"G:7ece25e4-50e5-46c1-9dbc-1e9101bf5d8d.jpg",originalPrice:21.95},
  {id:"crf20",name:"Viande Hachée de Dinde NatureÂ 500g",desc:"Boucherie / volaille fraîche",price:25.95,cat:"boucherie",emoji:"🥩",imgRef:"G:d37dc026-c4ea-49ca-aea1-95ab910664a0.jpg"},
  {id:"crf21",name:"Filet de Dinde 500g.",desc:"Boucherie / volaille fraîche",price:24.45,cat:"boucherie",emoji:"🥩",imgRef:"G:3638cb3d-ef64-4cea-ace8-6bb7c8d10570.png"},
  {id:"crf22",name:"Pack Lait UHT Entier Jaouda 1L 6 unités",desc:"Produit laitier",price:61.95,cat:"laitier",emoji:"🧀",imgRef:"G:8e166331-674c-4568-8895-6d88b181bde5.jpg",originalPrice:65.95},
  {id:"crf23",name:"Pack Fromage Frais Nature Sucré Perly 8x85g",desc:"Produit laitier",price:19.95,cat:"laitier",emoji:"🧀",imgRef:"G:270fe472-1ccb-4d16-837d-9f34955f01a4.jpg",originalPrice:23.95},
  {id:"crf24",name:"Filets de Poulet Barquette 500g.",desc:"Épicerie",price:33.95,cat:"epicerie",emoji:"🧂",imgRef:"G:50f94720-af68-4e3e-9bce-74916e25ffec.jpg"},
  {id:"crf25",name:"Œufs Twimen Plateau 30 unités",desc:"Épicerie",price:19.5,cat:"epicerie",emoji:"🧂",imgRef:"G:2787a414-f14f-4df6-8ffc-2c73f2be8f2c.jpg",originalPrice:49.95},
  {id:"crf26",name:"Thon à l'Huile Végétale Tam 3x80g",desc:"Épicerie",price:26.9,cat:"epicerie",emoji:"🧂",imgRef:"G:a5253f6d-8c8a-48f4-947c-b9eb335ba5a3.jpg",originalPrice:27.95},
  {id:"crf27",name:"Viande Hachée de Bœuf Nature 500g.",desc:"Boucherie / volaille fraîche",price:64.45,cat:"boucherie",emoji:"🥩",imgRef:"G:52dd3488-c6f4-4d49-889b-0ab13c7ccabb.jpg"},
  {id:"crf28",name:"Filet de Poulet 500g.",desc:"Boucherie / volaille fraîche",price:32.95,cat:"boucherie",emoji:"🥩",imgRef:"G:95ce6c53-a490-4627-9538-083c7be5f32b.jpg"},
  {id:"crf29",name:"Poulet EntierÂ au kg",desc:"Boucherie / volaille fraîche",price:29.9,cat:"boucherie",emoji:"🥩",imgRef:"G:35a974bd-b650-4e33-a2b9-abacf963f941.jpg"},
  {id:"crf30",name:"Magnum Double Chocolat 90ml",desc:"Surgelés",price:17.95,cat:"surgeles",emoji:"🧊",imgRef:"G:0d4f48b3-f82a-4b0c-940e-45d8dbb3e7e4.jpg",originalPrice:22.5},
  {id:"crf31",name:"Pringles Chips Barbecue - 165g /19863",desc:"Snacking",price:23.95,cat:"snacking",emoji:"🥔",imgRef:"G:d2e8ae82-07f4-4011-8a34-a1d0329dddb1.jpg"},
  {id:"crf32",name:"Brochettes de Filet de Dinde 500g",desc:"Boucherie / volaille fraîche",price:25.95,cat:"boucherie",emoji:"🥩",imgRef:"G:84dcece7-a398-48c6-b476-8c741b2e5b6b.jpg"},
  {id:"crf33",name:"Madeleine Longue Marbrée Pâtisserie Tradition 250g",desc:"Sucré",price:22.95,cat:"sucre",emoji:"🍬",imgRef:"P:69b84e9718eef1ea280167f8.jpg",originalPrice:27.95},
  {id:"crf34",name:"Pringles Crème Sure Et Oignon - 165g /17600",desc:"Produit laitier",price:21.95,cat:"laitier",emoji:"🧀",imgRef:"G:8be0c4f3-d2d1-4359-824b-461bc8105991.jpg"},
  {id:"crf35",name:"Matinales Œufs Fermiers x6",desc:"Épicerie",price:22.95,cat:"epicerie",emoji:"🧂",imgRef:"G:705117f5-f93a-40e7-bbca-5e9efc4d092b.jpg"},
  {id:"crf36",name:"Orange A Jus 500g.",desc:"Boisson",price:3.48,cat:"boissons",emoji:"💧",imgRef:"G:b137cd45-186d-46f0-976f-9d6927805820.jpg"},
  {id:"crf37",name:"Pamplemousse 500g - Filière Qualité",desc:"Épicerie",price:4.25,cat:"epicerie",emoji:"🧂",imgRef:"G:580f5269-ba63-43d5-bac2-4ed7c51abcd3.jpg"},
  {id:"crf38",name:"Citron Vert 250g",desc:"Fruit ou légume frais",price:3.74,cat:"fruits",emoji:"🍎",imgRef:"G:4da75c85-b214-47d1-b30e-96f3603ff920.jpg",originalPrice:3.88},
  {id:"crf39",name:"Orange à Jus 500g",desc:"Boisson",price:1.98,cat:"boissons",emoji:"💧",imgRef:"P:6729cd202499ebd608d911bb.jpg",originalPrice:5.48},
  {id:"crf40",name:"Citron Jaune 250g",desc:"Fruit ou légume frais",price:3.99,cat:"fruits",emoji:"🍎",imgRef:"G:efb15f7a-7fe4-44e0-a7a5-de8320bf5aee.jpg"},
  {id:"crf41",name:"Citron Jaune Filet 1Kg.",desc:"Fruit ou légume frais",price:13.95,cat:"fruits",emoji:"🍎",imgRef:"G:ed8d30c9-7d65-464c-8faf-63869391429a.jpg"},
  {id:"crf42",name:"Faux Filet de Boeuf 500g - Filière Qualité",desc:"Boucherie / volaille fraîche",price:74.95,cat:"boucherie",emoji:"🥩",imgRef:"G:c66dd270-1265-4947-98b3-f8f0a922596f.jpg"},
  {id:"crf43",name:"Jarret de Bœuf à Os 500g - Filière Qualité",desc:"Boucherie / volaille fraîche",price:58.45,cat:"boucherie",emoji:"🥩",imgRef:"G:14220387-302d-44aa-bb06-5461d3eb1f59.jpg"},
  {id:"crf44",name:"Tagine Sans Os de Bœuf 500g - Filière Qualité.",desc:"Épicerie",price:64.45,cat:"epicerie",emoji:"🧂",imgRef:"G:185cdbf0-bb66-4285-80a7-fb5b12892900.jpg"},
  {id:"crf45",name:"Edam Boule Acheese 100g",desc:"Épicerie",price:12.2,cat:"epicerie",emoji:"🧂",imgRef:"G:5607ae11-a0fd-43fd-8107-ee44e3f19717.jpg"},
  {id:"crf46",name:"Parmesan Fromital 100g.",desc:"Épicerie",price:24.08,cat:"epicerie",emoji:"🧂",imgRef:"P:69b84c8218eef1ea280014a5.jpg"},
  {id:"crf47",name:"Fromage Fumé Nature Acheese 100g",desc:"Produit laitier",price:13.29,cat:"laitier",emoji:"🧀",imgRef:"G:33e58e65-ab01-4281-8376-4f2aecaf31f0.jpg"},
  {id:"crf48",name:"Mozzarella Bloc Le Berger 100g",desc:"Épicerie",price:6.9,cat:"epicerie",emoji:"🧂",imgRef:"G:294026fe-246b-40ff-8922-246bd8b5cb98.jpg",originalPrice:8.9},
  {id:"crf49",name:"Fromage Blanc Ail et Fines Herbes Le Berger 100g",desc:"Produit laitier",price:6.7,cat:"laitier",emoji:"🧀",imgRef:"G:1ae1b51e-2f55-472a-ab29-d602f39ab717.jpg"},
  {id:"crf50",name:"Mozzarella Bloc or Blanc 100g",desc:"Épicerie",price:12.8,cat:"epicerie",emoji:"🧂",imgRef:"G:7769f1cc-caca-4ea0-b3e9-7e1795ac1787.jpg"},
  {id:"crf51",name:"Fromage Gouda Naure Irish 100g",desc:"Produit laitier",price:14,cat:"laitier",emoji:"🧀",imgRef:"P:69b8508518eef1ea2802a518.jpg",originalPrice:18.73},
  {id:"crf52",name:"Mozzarella en Boules Le Berger 100g",desc:"Épicerie",price:13.8,cat:"epicerie",emoji:"🧂",imgRef:"G:eca3ebcd-cbdc-4f35-a569-5026bd9f85d5.jpg"},
  {id:"crf53",name:"Gouda au Pesto Vert Acheese 100g",desc:"Épicerie",price:22,cat:"epicerie",emoji:"🧂",imgRef:"G:1eac59ee-507c-478c-953d-fc7b1539d058.jpg"},
  {id:"crf54",name:"Fromage Cheddar Bloc Orange Grand Coeur 100g",desc:"Produit laitier",price:15.8,cat:"laitier",emoji:"🧀",imgRef:"P:69b8508518eef1ea2802a511.jpg"},
  {id:"crf55",name:"Emmental Bloc Acheese 100g",desc:"Épicerie",price:14.79,cat:"epicerie",emoji:"🧂",imgRef:"G:28bddb49-e4cb-4bd2-89a2-9c8da60c46a9.jpg"},
  {id:"crf56",name:"Gouda au Poivre Acheese 100g",desc:"Épicerie",price:16.79,cat:"epicerie",emoji:"🧂",imgRef:"G:4ec006b6-424a-4386-bcdf-ed631be0618c.jpg"},
  {id:"crf57",name:"Fromage Tomme des Pyrénées Noire Fromital 100g",desc:"Produit laitier",price:10.5,cat:"laitier",emoji:"🧀",imgRef:"G:a47adae7-d891-4455-9dd6-6012775e3548.jpg"},
  {id:"crf58",name:"Fromage Maasdam En Morceau 100G - Kroon",desc:"Produit laitier",price:14.5,cat:"laitier",emoji:"🧀",imgRef:"G:710748c9-9727-40a7-b593-cef92f7a7320.png",originalPrice:17.48},
  {id:"crf59",name:"Cheesarella Spécial Pizza Khayrat 100g",desc:"Épicerie",price:10.5,cat:"epicerie",emoji:"🧂",imgRef:"G:3f16cb61-4173-4839-9cce-9b8f4d5cc32c.jpg"},
  {id:"crf60",name:"Maasdam Acheese 100g",desc:"Épicerie",price:10.95,cat:"epicerie",emoji:"🧂",imgRef:"G:836d178b-54ba-44af-ae83-d55c66740d02.jpg",originalPrice:13.2},
  {id:"crf61",name:"Mozzarella Bloc Pizzaiolo Viva 100g",desc:"Épicerie",price:6.3,cat:"epicerie",emoji:"🧂",imgRef:"P:6901eedf2a52e31389b2550b.jpg",originalPrice:7.39},
  {id:"crf62",name:"Fromage Gouda Nature En Tranches 100G - Kroon",desc:"Produit laitier",price:14,cat:"laitier",emoji:"🧀",imgRef:"G:b20649ee-cb6b-4fbe-b968-edc0f498b1f4.png",originalPrice:18.6},
  {id:"crf63",name:"Fromage Fumé Nature Gran Cœur 100g",desc:"Produit laitier",price:19.25,cat:"laitier",emoji:"🧀",imgRef:"G:e8f3bbae-7e11-4605-a611-511fe9b11a79.jpg"},
  {id:"crf64",name:"Fromage Fumé aux Fines Herbes 100g",desc:"Produit laitier",price:12.9,cat:"laitier",emoji:"🧀",imgRef:"G:4c163a2a-23b2-48a5-9ede-a1b2c988bbbb.jpg",originalPrice:15.1},
  {id:"crf65",name:"Brie 60% Mg Maubert 100g",desc:"Épicerie",price:16.9,cat:"epicerie",emoji:"🧂",imgRef:"G:4b3b75d6-52bd-4809-bfcb-42426dabe3ec.jpg",originalPrice:19.89},
  {id:"crf66",name:"Bûche de Chèvre La Petite Chèvre 100g",desc:"Épicerie",price:16.85,cat:"epicerie",emoji:"🧂",imgRef:"G:77c8ef39-da23-409b-9cbd-e27d3e59fc29.jpg"},
  {id:"crf67",name:"Manchego 6 Mois Mancha Dorada 100g",desc:"Épicerie",price:48.5,cat:"epicerie",emoji:"🧂",imgRef:"G:e96ddb31-6f0e-4feb-99bc-97f1eb8d9649.jpg"},
  {id:"crf68",name:"Fromage Gouda Cumin En Tranches 100G - Kroon",desc:"Produit laitier",price:14,cat:"laitier",emoji:"🧀",imgRef:"G:001c8579-0f77-40e2-99b5-90d406543e92.png",originalPrice:18.6},
  {id:"crf69",name:"Ricotta Le Berger 100g",desc:"Épicerie",price:8.84,cat:"epicerie",emoji:"🧂",imgRef:"G:a2c32262-f52a-4924-adc7-f30fee0d56a2.jpg"},
  {id:"crf70",name:"Fromage Blanc Light Le Berger 100g",desc:"Produit laitier",price:5.9,cat:"laitier",emoji:"🧀",imgRef:"G:12d5e26b-d641-4c8f-b871-5bc386c03e82.jpg",originalPrice:6.6},
  {id:"crf71",name:"Fromage Blanc Light Sans Sel Le Berger 100g",desc:"Produit laitier",price:6.6,cat:"laitier",emoji:"🧀",imgRef:"G:ac0e82e1-27b6-44dd-9292-dc82fe4c3987.jpg"},
  {id:"crf72",name:"Fromage Edam Spécial Pizza Le Berger 100g",desc:"Produit laitier",price:7.5,cat:"laitier",emoji:"🧀",imgRef:"G:5216e66d-2f68-4bfb-883f-1021962fc0e4.jpg"},
  {id:"crf73",name:"Edam Boule Gran Cœur 100g",desc:"Épicerie",price:11,cat:"epicerie",emoji:"🧂",imgRef:"G:1e3048de-5409-4354-8888-9856b30abcd1.jpg",originalPrice:13.25},
  {id:"crf74",name:"Gouda au Cumin Gran Cœur 100g.",desc:"Épicerie",price:19.25,cat:"epicerie",emoji:"🧂",imgRef:"G:29d80d7f-b348-4787-96b3-2b0a9f86a5c7.jpg"},
  {id:"crf75",name:"Maasdam Gran Cœur 100g",desc:"Épicerie",price:17.66,cat:"epicerie",emoji:"🧂",imgRef:"G:03f55b9f-dd48-4c80-a2fb-0bc61b5fc048.jpg"},
  {id:"crf76",name:"Gouda Nature Gran Cœur 100g",desc:"Épicerie",price:18.73,cat:"epicerie",emoji:"🧂",imgRef:"G:0e5d4f2e-0af3-4132-91d7-09651be06745.jpg"},
  {id:"crf77",name:"Fromage de Chèvre Gran Cœur 100g",desc:"Produit laitier",price:29.6,cat:"laitier",emoji:"🧀",imgRef:"G:840359d4-6f57-457a-82e1-78bcc2562d7c.jpg"},
  {id:"crf78",name:"Gouda Chili Piquant Gran Cœur 100g",desc:"Épicerie",price:24.2,cat:"epicerie",emoji:"🧂",imgRef:"G:379153fc-d9ca-439e-8074-55d5075c92cd.jpg"},
  {id:"crf79",name:"Fromage Bleu Fromital 100g",desc:"Produit laitier",price:11.9,cat:"laitier",emoji:"🧀",imgRef:"G:8434fec0-9124-4450-b42c-02967067e510.jpg"},
  {id:"crf80",name:"Fromage Maasdam Irish 100g",desc:"Produit laitier",price:15.1,cat:"laitier",emoji:"🧀",imgRef:"P:69b8508518eef1ea2802a519.jpg"},
  {id:"crf81",name:"Bleu Bergader 100g",desc:"Épicerie",price:17.9,cat:"epicerie",emoji:"🧂",imgRef:"G:4582a9ca-df6d-4791-9010-b57269e6ef3f.jpg",originalPrice:24.4},
  {id:"crf82",name:"Parmesan Toscanello 100g",desc:"Épicerie",price:44.53,cat:"epicerie",emoji:"🧂",imgRef:"G:78287e5b-8789-46a7-8ef4-4d174afd6b8f.jpg"},
  {id:"crf83",name:"Fromage Provolone Piquant Galileo 100g",desc:"Produit laitier",price:26,cat:"laitier",emoji:"🧀",imgRef:"P:69b84eb518eef1ea28017aa7.jpg",originalPrice:29.9},
  {id:"crf84",name:"Fromage Fumé Nature Irish 100g",desc:"Produit laitier",price:15.2,cat:"laitier",emoji:"🧀",imgRef:"P:69df5447517ffa92a3eec67c.png"},
  {id:"crf85",name:"Aïn Saïss Eau Minérale Pack Kids 12x33cl",desc:"Boisson",price:22.8,cat:"boissons",emoji:"💧",imgRef:"G:d6a242e6-9b0e-4458-8843-b78a9ef68c96.jpg"},
  {id:"crf86",name:"Pack Promo Eau Minérale Ain-soltane 2x2,5l",desc:"Boisson",price:14.5,cat:"boissons",emoji:"💧",imgRef:"G:fe4e3d1d-0c75-4a39-bb12-b030f17798ec.png"},
  {id:"crf87",name:"Huile de Table Équilibrée 3 Graines Lesieur 5L",desc:"Épicerie",price:88.5,cat:"epicerie",emoji:"🧂",imgRef:"G:3648b157-70a9-4a51-8695-44d0e6dc2391.jpg"},
  {id:"crf88",name:"Huile de Table Lesieur 1L",desc:"Épicerie",price:17.9,cat:"epicerie",emoji:"🧂",imgRef:"G:11b5f9a0-7015-4561-b286-e7555296551e.jpg"},
  {id:"crf89",name:"afia 5L",desc:"Épicerie",price:91.9,cat:"epicerie",emoji:"🧂",imgRef:"G:5e9612dc-3e99-4c5b-a58e-f02bd46bb8ab.jpg"},
  {id:"crf90",name:"Mélange Huiles 2en1 Huilor 1 litre",desc:"Épicerie",price:44.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b852b318eef1ea28040729.png"},
  {id:"crf91",name:"lesieur 0.5L",desc:"Épicerie",price:8.95,cat:"epicerie",emoji:"🧂",imgRef:"G:cdfb397c-5426-46da-b38c-7cb9fb26231e.jpg"},
  {id:"crf92",name:"Huile de Table Oléor 2L",desc:"Épicerie",price:35.95,cat:"epicerie",emoji:"🧂",imgRef:"G:e4ee39c0-e72c-4996-86be-abc460c95b1d.jpg"},
  {id:"crf93",name:"afia 2L",desc:"Épicerie",price:37.9,cat:"epicerie",emoji:"🧂",imgRef:"G:5674133d-51d2-43fb-8956-5f4374f1cdf1.jpg"},
  {id:"crf94",name:"Huile De Table Twimen 1L",desc:"Épicerie",price:16.5,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8544918eef1ea2804fa09.jpg"},
  {id:"crf95",name:"Afia Huile de Table 1L",desc:"Épicerie",price:18.95,cat:"epicerie",emoji:"🧂",imgRef:"G:84aaeedc-f737-460e-b52b-53e0d637a3ca.jpg"},
  {id:"crf96",name:"Afia Huile 0.5L",desc:"Épicerie",price:9.6,cat:"epicerie",emoji:"🧂",imgRef:"G:e6a89794-0174-412e-a4cd-20fd0af38731.jpg"},
  {id:"crf97",name:"Huile De Table Twimen 5L",desc:"Épicerie",price:81.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8544918eef1ea2804fa1f.jpg"},
  {id:"crf98",name:"Huile de Table Cristal 50cl",desc:"Épicerie",price:9,cat:"epicerie",emoji:"🧂",imgRef:"G:c702df2b-b199-42f0-89f3-7bc0b5d8e02d.jpg"},
  {id:"crf99",name:"Huile de Table Tournesol Huilor 1L",desc:"Épicerie",price:18.75,cat:"epicerie",emoji:"🧂",imgRef:"G:fd613f68-a640-49c7-af94-4cd4a47fba4f.jpg"},
  {id:"crf100",name:"Huile de Table Tournesol Huilor 2L",desc:"Épicerie",price:37.5,cat:"epicerie",emoji:"🧂",imgRef:"G:cbeafd51-c509-4cd3-bc20-cac3fd89419e.jpg"},
  {id:"crf101",name:"Cristal Huile De Table 1 Litre",desc:"Épicerie",price:18,cat:"epicerie",emoji:"🧂",imgRef:"G:1299d4b7-1b70-4557-a897-b16a5397dfdf.jpg"},
  {id:"crf102",name:"Huile de Table Oleor 50cl",desc:"Épicerie",price:9,cat:"epicerie",emoji:"🧂",imgRef:"G:01d66afc-6714-46b7-8284-8278a8ebd7f7.jpg"},
  {id:"crf103",name:"Huile De Table Oleor 1 Litre",desc:"Épicerie",price:17.95,cat:"epicerie",emoji:"🧂",imgRef:"G:48f67c8c-7409-4d8e-93ba-282262410039.jpg"},
  {id:"crf104",name:"Cristal Huile de Table 2L",desc:"Épicerie",price:35.95,cat:"epicerie",emoji:"🧂",imgRef:"G:68394eb4-f485-4592-bd83-8896f4a97f56.jpg"},
  {id:"crf105",name:"Huile de Table Pure Soja Hala 2L",desc:"Épicerie",price:35.95,cat:"epicerie",emoji:"🧂",imgRef:"G:c81f0998-e29f-48fe-88d2-095103b73404.jpg"},
  {id:"crf106",name:"Huile de Tournesol Hala 5 Litres",desc:"Épicerie",price:82.5,cat:"epicerie",emoji:"🧂",imgRef:"P:69b8548818eef1ea28052005.jpg"},
  {id:"crf107",name:"Hala Huile de Table 1L",desc:"Épicerie",price:17.95,cat:"epicerie",emoji:"🧂",imgRef:"G:b56f0451-2fff-4cdc-8e0a-07806b29f8d5.jpg"},
  {id:"crf108",name:"lesieur 2L",desc:"Épicerie",price:35.9,cat:"epicerie",emoji:"🧂",imgRef:"G:7476051f-b662-46ab-8759-645338007417.jpg"},
  {id:"crf109",name:"Huile de Table Tournesol Huilor 5L",desc:"Épicerie",price:93.95,cat:"epicerie",emoji:"🧂",imgRef:"G:c69564d4-3de9-43d2-a80e-60fe937bd5bc.jpg"},
  {id:"crf110",name:"Huile de Table Oléor 5L",desc:"Épicerie",price:86.95,cat:"epicerie",emoji:"🧂",imgRef:"G:d21ae738-9815-41b2-b614-00057f6a57fb.jpg"},
  {id:"crf111",name:"Huile de Table Pure Soja Hala 5L",desc:"Épicerie",price:88.95,cat:"epicerie",emoji:"🧂",imgRef:"G:dd987784-518f-41e2-8b60-4d4ade5be91d.jpg"},
  {id:"crf112",name:"Huile de Table Pure Soja Hala 8L",desc:"Épicerie",price:141.5,cat:"epicerie",emoji:"🧂",imgRef:"G:ca327ff3-41dc-4565-a658-0c7916339390.jpg"},
  {id:"crf113",name:"Pringles Tuiles Sour Cream & Onion 40g",desc:"Snacking",price:11.25,cat:"snacking",emoji:"🥔",imgRef:"G:fc795724-9923-46e7-abc4-8c509016a637.jpg"},
  {id:"crf114",name:"Pringles Cheese & Onion - 165g /688003",desc:"Snacking",price:21.95,cat:"snacking",emoji:"🥔",imgRef:"X"},
  {id:"crf115",name:"Leader Food Chips Conikos Fromage - 30g /414404",desc:"Produit laitier",price:3.3,cat:"laitier",emoji:"🧀",imgRef:"G:8244bc10-958d-45cc-a06f-3359f2a4195e.jpeg"},
  {id:"crf116",name:"Lays Chips Salt - 97g /548465",desc:"Snacking",price:17.5,cat:"snacking",emoji:"🥔",imgRef:"G:b0884223-bc46-41dd-aa27-972539f23444.jpg"},
  {id:"crf117",name:"Chips Original Lays 130g.",desc:"Snacking",price:24.7,cat:"snacking",emoji:"🥔",imgRef:"G:ea14c399-081e-495e-927a-1840b3c59b35.jpg"},
  {id:"crf118",name:"Chips Salées Twimen 75g",desc:"Snacking",price:6.95,cat:"snacking",emoji:"🥔",imgRef:"G:3b527f05-7a8c-40b4-89ad-e97fe46f1100.jpg"},
  {id:"crf119",name:"Chips au Fromage et aux Oignons Lay's 97g",desc:"Produit laitier",price:15.95,cat:"laitier",emoji:"🧀",imgRef:"G:87363d6f-9005-48f3-99ae-2d702dd260c9.jpg"},
  {id:"crf120",name:"Leader Food Chips Lisse Kebab - 85g /388768",desc:"Snacking",price:9.95,cat:"snacking",emoji:"🥔",imgRef:"G:7d569009-92db-4621-b1cf-e767078a40cc.jpg"},
  {id:"crf121",name:"Chips Kebab Lays 97g",desc:"Snacking",price:16.5,cat:"snacking",emoji:"🥔",imgRef:"G:a8763df7-8a9d-4968-b067-573c9b99582b.jpg"},
  {id:"crf122",name:"Leader Chips Chips Salées - 30g /69159",desc:"Snacking",price:3.4,cat:"snacking",emoji:"🥔",imgRef:"G:4d048de1-35f0-4cb6-a873-fa03bc469041.JPG"},
  {id:"crf123",name:"Lays Chips Cheese Flavor - 97g /548461",desc:"Snacking",price:16.5,cat:"snacking",emoji:"🥔",imgRef:"G:44ae2545-0002-4160-828c-1f2e8d7cbcb1.jpeg"},
  {id:"crf124",name:"Chips à l'Ancienne Saveur Moutarde Carrefour 150g",desc:"Snacking",price:25.75,cat:"snacking",emoji:"🥔",imgRef:"G:0f5a54c0-3394-432d-bf2e-17ec6cdbdd19.jpg"},
  {id:"crf125",name:"Pringles Paprika - 40g /594574",desc:"Snacking",price:11.25,cat:"snacking",emoji:"🥔",imgRef:"G:4db354b3-b5f5-4388-9472-82697d465775.JPG"},
  {id:"crf126",name:"Pringles Hot & Spicy - 40g /9610",desc:"Snacking",price:11.25,cat:"snacking",emoji:"🥔",imgRef:"G:e736d55f-dcd4-43fb-9fb9-69700abe3ae7.png"},
  {id:"crf127",name:"Crunchips Salted - 100g /1170",desc:"Snacking",price:20.25,cat:"snacking",emoji:"🥔",imgRef:"G:1c81b506-cd4d-4852-985f-7b3c5f00c3a6.JPG"},
  {id:"crf128",name:"Leader Chips Lisse Kebab - 30g /388772",desc:"Snacking",price:3.5,cat:"snacking",emoji:"🥔",imgRef:"G:c54da1d2-4cb7-4de1-a469-3be07a7c11bf.JPG"},
  {id:"crf129",name:"Chips Fromage Curlitos Ronchos 100 G",desc:"Produit laitier",price:12.5,cat:"laitier",emoji:"🧀",imgRef:"G:7be4592b-0eec-4059-bf71-2c955cbd90da.jpg"},
  {id:"crf130",name:"Pringles Tuiles Cheesy Cheese - 165g /992",desc:"Snacking",price:22.5,cat:"snacking",emoji:"🥔",imgRef:"G:4551ffbe-c344-4d4d-9aa6-e8d3a0cfc716.jpg"},
  {id:"crf131",name:"Chips À L'AncienneÂ Nature Carrefour 150g",desc:"Snacking",price:16.95,cat:"snacking",emoji:"🥔",imgRef:"G:8260d345-2c60-451f-b346-7fdd3d9d2de3.jpg"},
  {id:"crf132",name:"Chips Fromage Cheddar Planetas Ronchos 100 g",desc:"Produit laitier",price:12.5,cat:"laitier",emoji:"🧀",imgRef:"P:69b8548718eef1ea28051ff5.jpg"},
  {id:"crf133",name:"Chips Crème Oignons Carrefour 150g",desc:"Produit laitier",price:21.5,cat:"laitier",emoji:"🧀",imgRef:"G:069d0b02-202d-4695-a085-6000b43d8c3c.jpg"},
  {id:"crf134",name:"Carrefour Chips À L'ancienne Nature Original - 300g /708204",desc:"Snacking",price:39.5,cat:"snacking",emoji:"🥔",imgRef:"G:6a412e28-6abb-4b34-8e92-dd292acc3c02.jpg"},
  {id:"crf135",name:"Carrefour Chips Saveur Spicy Classic - 135g /710154",desc:"Snacking",price:25.95,cat:"snacking",emoji:"🥔",imgRef:"G:4b12219f-80e3-4f73-8330-9c1f186ac960.jpg"},
  {id:"crf136",name:"Chips Barbecue Carrefour - 135g /564689",desc:"Snacking",price:19.95,cat:"snacking",emoji:"🥔",imgRef:"G:4204fbd8-dcf0-4d8a-9c3e-c6bc3ddf5140.jpg"},
  {id:"crf137",name:"Carrefour Chips Ondulées - 150g /474736",desc:"Snacking",price:20.75,cat:"snacking",emoji:"🥔",imgRef:"G:cd59a1a5-b5e2-49de-bf41-568388ce6d9e.jpg"},
  {id:"crf138",name:"Carrefour Tuiles Apéritif Goût Barbecue /710403",desc:"Épicerie",price:27.5,cat:"epicerie",emoji:"🧂",imgRef:"G:ea7e9bcd-64e6-47e4-94b4-b17f589376dc.jpg"},
  {id:"crf139",name:"Pringles Original - 165g /17539",desc:"Snacking",price:21.95,cat:"snacking",emoji:"🥔",imgRef:"G:62279035-5142-48af-a7dc-c5b11fefc3b4.jpg"},
  {id:"crf140",name:"Chips Paprika Crunchips 100g.",desc:"Snacking",price:18.5,cat:"snacking",emoji:"🥔",imgRef:"G:2613b5cf-c5ca-4f27-8b1f-29c6a14ea575.jpg"},
  {id:"crf141",name:"Pringles Hot Spicy - 165g /165048",desc:"Snacking",price:21.95,cat:"snacking",emoji:"🥔",imgRef:"G:49faa8d4-c7d3-4d32-a13c-b526ef9dcd15.jpg"},
  {id:"crf142",name:"Crunchips Salt & Vinegar - 100g /237422",desc:"Snacking",price:20.25,cat:"snacking",emoji:"🥔",imgRef:"G:2204cb00-3274-4e6e-ae72-e1fee3223a04.JPG"},
  {id:"crf143",name:"Crunchips X-cut Salted - 85g /236260",desc:"Snacking",price:23.6,cat:"snacking",emoji:"🥔",imgRef:"G:5adbea9a-4604-4135-ada8-277e20b0e93e.JPG"},
  {id:"crf144",name:"Pringles Original - 40g /9612",desc:"Snacking",price:11.25,cat:"snacking",emoji:"🥔",imgRef:"G:ca415342-c189-45f9-b8b9-6895afb04f17.png"},
  {id:"crf145",name:"PRINGLES SALT & VINEGAR 165G",desc:"Snacking",price:21.95,cat:"snacking",emoji:"🥔",imgRef:"P:656dea35c8e2245b73d26a43.jpg"},
  {id:"crf146",name:"Crunchips X-cut Chips Paprika - 85g /236261",desc:"Snacking",price:23.1,cat:"snacking",emoji:"🥔",imgRef:"G:4d43501b-0bfc-4e82-82c0-98189a863d08.JPG"},
  {id:"crf147",name:"Chips Pringles Original 200g",desc:"Snacking",price:21.95,cat:"snacking",emoji:"🥔",imgRef:"G:f3a2d747-c353-452f-b221-8e0c892f1168.jpg",originalPrice:25.95},
  {id:"crf148",name:"Chips Fromages Oignon Twimen 75g",desc:"Produit laitier",price:6.95,cat:"laitier",emoji:"🧀",imgRef:"G:3564635f-f729-420d-a43b-ae0e142ebb02.jpg"},
  {id:"crf149",name:"Chips Red Chili Crunchips 100g",desc:"Snacking",price:18.5,cat:"snacking",emoji:"🥔",imgRef:"G:7e85e3dc-c3b8-4ac0-8a90-73d9fe07f788.jpg"},
  {id:"crf150",name:"Chips Campesina Lays 122g.",desc:"Snacking",price:23.95,cat:"snacking",emoji:"🥔",imgRef:"G:7af2802c-77a4-4830-a829-0498c982ca25.jpg"},
  {id:"crf151",name:"Leader Chips Chili - 85g /69145",desc:"Snacking",price:9.95,cat:"snacking",emoji:"🥔",imgRef:"G:89944cd1-b093-49f4-bbbb-8bfb07821109.jpg"},
  {id:"crf152",name:"Chips Paysanne Brets 125 g",desc:"Snacking",price:29.5,cat:"snacking",emoji:"🥔",imgRef:"P:69b84acc18eef1ea28fef969.jpg"},
  {id:"crf153",name:"Leader Chips Lisse Salé - 85g /63525",desc:"Snacking",price:11.95,cat:"snacking",emoji:"🥔",imgRef:"G:223e365b-c174-49c8-b5e9-1edf31b26a29.jpg"},
  {id:"crf154",name:"Leader Chips Campesina - 85g /679087",desc:"Snacking",price:9.95,cat:"snacking",emoji:"🥔",imgRef:"G:8460381b-a8a0-4ed3-8659-9604ba00ada5.jpg"},
  {id:"crf155",name:"Leader Chips Fromage Oignon - 85g /63531",desc:"Produit laitier",price:9.95,cat:"laitier",emoji:"🧀",imgRef:"G:bebd0340-05b0-49b9-a961-34eab69940ff.jpg"},
  {id:"crf156",name:"Chips Fromage du Jura Bret's 125g",desc:"Produit laitier",price:30.95,cat:"laitier",emoji:"🧀",imgRef:"G:1413ae64-ad16-4896-81c4-e1c294c0ee18.jpg"},
  {id:"crf157",name:"Chips Poulet Braisé Brets 125 g",desc:"Snacking",price:32.75,cat:"snacking",emoji:"🥔",imgRef:"P:69b8400e6792badc11c947fe.jpg"},
  {id:"crf158",name:"Chips Aioli Brets 125 g",desc:"Snacking",price:30.95,cat:"snacking",emoji:"🥔",imgRef:"P:69b84acc18eef1ea28fef96a.jpg"},
  {id:"crf159",name:"Leader Food Chips Oignon & Fromage - 13g /69143",desc:"Produit laitier",price:1.1,cat:"laitier",emoji:"🧀",imgRef:"G:e99c135f-46e5-4d86-b2b3-5d91a646a711.jpg"},
  {id:"crf160",name:"Inessence Chips Miel Moutarde - 125g /669457",desc:"Snacking",price:23.95,cat:"snacking",emoji:"🥔",imgRef:"G:5615b899-094b-4048-87c4-5d5f4ebabb4a.jpg"},
  {id:"crf161",name:"Chips Truffe Inessence 125g",desc:"Snacking",price:23.95,cat:"snacking",emoji:"🥔",imgRef:"G:d4cf90f7-2a55-4128-989d-76891422592e.jpg"},
  {id:"crf162",name:"Chips Barbecue Inessence 125g",desc:"Snacking",price:23.9,cat:"snacking",emoji:"🥔",imgRef:"G:13be5299-b234-4430-ac3f-8fb74586713d.jpg"},
  {id:"crf163",name:"Onduladas Campesinas - 100g /661694",desc:"Épicerie",price:16.5,cat:"epicerie",emoji:"🧂",imgRef:"G:10c25be5-7a3a-4715-9788-5bbfe2f5fa00.JPG"},
  {id:"crf164",name:"Onduladas Originales Mas Sabor - 100g /661604",desc:"Épicerie",price:16.4,cat:"epicerie",emoji:"🧂",imgRef:"G:d82840d3-b4a9-4751-88ae-4de8a7878f62.jpg"},
  {id:"crf165",name:"Risi Classicas Original - 100g /661695",desc:"Épicerie",price:16.5,cat:"epicerie",emoji:"🧂",imgRef:"G:5a4cc4d8-b87b-4cfe-8f2a-e9d94e44c162.png"},
  {id:"crf166",name:"Chips Crème Oignons Crunchips 100 g",desc:"Produit laitier",price:20.3,cat:"laitier",emoji:"🧀",imgRef:"P:69b8548718eef1ea28051fba.jpg"},
  {id:"crf167",name:"Leader Chips Lisses Chili - 30g /69161",desc:"Snacking",price:3.5,cat:"snacking",emoji:"🥔",imgRef:"G:2d85a188-4a13-4e0b-a03a-e518ea138640.JPG"},
  {id:"crf168",name:"Chips Hot Peperoni Chio 75 G",desc:"Snacking",price:13.95,cat:"snacking",emoji:"🥔",imgRef:"G:714e895e-32ca-41f6-8cfd-6a1e9e65ab4f.jpg"},
  {id:"crf169",name:"Milka Barre Chocolatée Oreo 22g",desc:"Sucré",price:3.3,cat:"sucre",emoji:"🍬",imgRef:"P:64b672439a6e474c914e5ba3.jpeg"},
  {id:"crf170",name:"Bounty Barre de Chocolat à La Noix de Coco 57g",desc:"Sucré",price:9.95,cat:"sucre",emoji:"🍬",imgRef:"G:1247191f-b6ba-4503-b7a7-409c069a1262.jpg"},
  {id:"crf171",name:"Barres chocolatées au Lait Kinder Bueno 43g",desc:"Produit laitier",price:9.95,cat:"laitier",emoji:"🧀",imgRef:"G:8ec5d00d-ba83-4f89-9dfe-160a850af918.jpg"},
  {id:"crf172",name:"Barre Chocolatée Mars 51g",desc:"Sucré",price:7.95,cat:"sucre",emoji:"🍬",imgRef:"G:4f87b2e5-bb08-4157-8cc5-971ce3ef687d.jpg"},
  {id:"crf173",name:"Kinder Chocolate Chocolat Aux Céréales 23,5g",desc:"Sucré",price:7.95,cat:"sucre",emoji:"🍬",imgRef:"G:3ca555dc-db51-4267-bfed-31574faa9dc5.jpg"},
  {id:"crf174",name:"Barre Crispy Caramel Cacahuète Nooco 40 g",desc:"Snacking",price:5.44,cat:"snacking",emoji:"🥔",imgRef:"P:69b8542a18eef1ea2804e74e.jpg"},
  {id:"crf175",name:"Kit Kat 4F Candy Crush MP (6 x 36,5 g)",desc:"Épicerie",price:36,cat:"epicerie",emoji:"🧂",imgRef:"G:0756d9ed-9c00-404d-9ff5-f37fd530ee6a.png"},
  {id:"crf176",name:"Barre Choco Amande Frégalior Aiguebelle 36 g",desc:"Sucré",price:6,cat:"sucre",emoji:"🍬",imgRef:"P:69b83fb26792badc11c90f03.jpg"},
  {id:"crf177",name:"Kinder Tronky T5 18G",desc:"Sucré",price:23.2,cat:"sucre",emoji:"🍬",imgRef:"G:848aaa71-d5aa-48e1-8a25-f9aaf1ac7e77.jpg"},
  {id:"crf178",name:"KINDER BUENO BLANC 39G",desc:"Sucré",price:9.95,cat:"sucre",emoji:"🍬",imgRef:"G:061f9d19-b1d0-4fc0-8de5-e0a6ef41feed.jpg"},
  {id:"crf179",name:"Snickers Miniatures Mini Barres Chocolatées 150g",desc:"Sucré",price:47.25,cat:"sucre",emoji:"🍬",imgRef:"G:81663c07-a699-41c4-b8ba-cdfbcef8fb7c.jpg"},
  {id:"crf180",name:"Mini Barres Chocolatées Kit Kat 150g",desc:"Sucré",price:34.95,cat:"sucre",emoji:"🍬",imgRef:"G:be7e899c-5187-4da6-ab67-59040c97644c.jpg"},
  {id:"crf181",name:"GALAXY FLUTES 22.5GX288",desc:"Épicerie",price:5,cat:"epicerie",emoji:"🧂",imgRef:"G:1693a153-6d7d-4bdf-9e02-4fa2b8a91087.jpg"},
  {id:"crf182",name:"Barres Chocolatées Sans Gluten Kinder 100g",desc:"Sucré",price:22.3,cat:"sucre",emoji:"🍬",imgRef:"G:a7475fa0-a13c-460e-a7b1-416bb3b14a75.jpg"},
  {id:"crf183",name:"Ferrero Kinder Maxi Chocolat, 240g",desc:"Sucré",price:4.5,cat:"sucre",emoji:"🍬",imgRef:"G:bd3ac942-10e4-42ac-9db6-d669a0fe4abb.jpg"},
  {id:"crf184",name:"Sachet barres chocolatées fourrées au caramel Miniatures MARS, 150g",desc:"Sucré",price:46.5,cat:"sucre",emoji:"🍬",imgRef:"G:0a4f1469-6560-436b-b246-8c756e05ba26.jpg",originalPrice:47.95},
  {id:"crf185",name:"Kinder Chocolat 4 Bars 50G",desc:"Sucré",price:10.5,cat:"sucre",emoji:"🍬",imgRef:"G:43f7713b-688d-490d-bf98-58f9935ce848.jpg"},
  {id:"crf186",name:"Barre Choco Blanc Lion 42 g",desc:"Sucré",price:19.95,cat:"sucre",emoji:"🍬",imgRef:"P:69b8546818eef1ea28050cba.jpg"},
  {id:"crf187",name:"Barre Chocolat au Lait Crunch Snack 30 G",desc:"Produit laitier",price:14.95,cat:"laitier",emoji:"🧀",imgRef:"P:69b8544918eef1ea2804fa0e.jpg"},
  {id:"crf188",name:"Barre Nougat Caramel Extrem 34g",desc:"Sucré",price:2,cat:"sucre",emoji:"🍬",imgRef:"P:69b8513418eef1ea280314ba.jpg"},
  {id:"crf189",name:"Milka Barre Chocolatée Caramel 22g",desc:"Sucré",price:3.3,cat:"sucre",emoji:"🍬",imgRef:"P:64b672439a6e474c914e5ba2.jpeg"},
  {id:"crf190",name:"Barre Chocolatée Lion Nestlé 42g",desc:"Sucré",price:6.95,cat:"sucre",emoji:"🍬",imgRef:"P:64b672409a6e474c914e5b9f.jpeg"},
  {id:"crf191",name:"SNICKERS 50G BARRE CHOCOLAT",desc:"Sucré",price:7.95,cat:"sucre",emoji:"🍬",imgRef:"G:961d0467-0477-46ba-b650-9b597bb333fa.jpg"},
  {id:"crf192",name:"Nestlé Kitkat Chunky 40g",desc:"Épicerie",price:8.8,cat:"epicerie",emoji:"🧂",imgRef:"G:43910cb2-6f78-4cc7-a5bb-dbc721966f9f.jpg"},
  {id:"crf193",name:"kitkat chunky caramel",desc:"Épicerie",price:9.9,cat:"epicerie",emoji:"🧂",imgRef:"G:13cccfbe-9700-4834-8ed2-5c07ef90fa76.jpg"},
  {id:"crf194",name:"SNICKERS MINIS 227Gx24",desc:"Sucré",price:49,cat:"sucre",emoji:"🍬",imgRef:"G:e0e9e092-6839-40b9-a9ca-9ab18afc0914.jpg"},
  {id:"crf195",name:"Barre Chocolatée Lindor Lindt 38g",desc:"Sucré",price:26.95,cat:"sucre",emoji:"🍬",imgRef:"G:08708aa6-3bbd-4382-9ac0-694290daa8f0.JPG"},
  {id:"crf196",name:"Dessert au Chocolat Twix, 50g",desc:"Sucré",price:7.75,cat:"sucre",emoji:"🍬",imgRef:"G:6f6901a4-70c4-4e81-bc22-873a2f5440b0.jpg"},
  {id:"crf197",name:"Mini Barres Chocolatées Twix 150g",desc:"Sucré",price:46.5,cat:"sucre",emoji:"🍬",imgRef:"G:a4462d31-345d-497b-b629-414c5167aff7.jpg"},
  {id:"crf198",name:"Mini-Barres Chocolatées Mars 227g",desc:"Sucré",price:49,cat:"sucre",emoji:"🍬",imgRef:"P:69d4d749ed47ae003c1e9263.png"},
  {id:"crf199",name:"BOUNTY MINIS 227Gx24",desc:"Sucré",price:49,cat:"sucre",emoji:"🍬",imgRef:"G:82010543-0e59-4547-8d59-7192577068ad.jpg"},
  {id:"crf200",name:"Pack Biscuit Enrobé Choco Lait Pickërs 5 unités 35g",desc:"Produit laitier",price:19.5,cat:"laitier",emoji:"🧀",imgRef:"P:69f0d3a3d53e7db668dfdb88.jpg"},
  {id:"crf201",name:"Pack de 5 Pyramido au Chocolat Tobigo 5x40 g",desc:"Sucré",price:9,cat:"sucre",emoji:"🍬",imgRef:"P:69f0d3a3d53e7db668dfdb8b.jpg"},
  {id:"crf202",name:"Pack de 5 Pyramido au Citron Tobigo 5x40 g",desc:"Fruit ou légume frais",price:9,cat:"fruits",emoji:"🍎",imgRef:"P:69f0d3a3d53e7db668dfdb8c.jpg"},
  {id:"crf203",name:"Pack Biscuit Enrobé Choco Noir Pickërs 5 unités 35g",desc:"Sucré",price:19.5,cat:"sucre",emoji:"🍬",imgRef:"P:69f0d3a3d53e7db668dfdb89.jpg"},
  {id:"crf204",name:"Barre Chocolat au Lait avec Nougat Miel et Amandes Caramélisées Toblerone 360g",desc:"Produit laitier",price:127,cat:"laitier",emoji:"🧀",imgRef:"G:706206c7-86d1-4090-b67f-8bec1dc52097.jpg"},
  {id:"crf205",name:"Barre Chocolat Noir avec Nougat Miel et Amandes Toblerone 360g",desc:"Sucré",price:127,cat:"sucre",emoji:"🍬",imgRef:"G:b24ae46a-2e01-443f-8cbd-259fa4fc1925.jpg"},
  {id:"crf206",name:"Barres Chocolate Coco Corny 6X25g",desc:"Sucré",price:31.9,cat:"sucre",emoji:"🍬",imgRef:"G:844b19cd-1f6c-46e4-847e-5a6089032ae2.jpg"},
  {id:"crf207",name:"Corny Barres chocolat au lait 6x25g",desc:"Produit laitier",price:31.9,cat:"laitier",emoji:"🧀",imgRef:"G:1826dd2c-2417-4b1a-bb50-5a6c6294de68.jpg"},
  {id:"crf208",name:"Barres Noisette Corny 6X25g",desc:"Sucré",price:29.5,cat:"sucre",emoji:"🍬",imgRef:"G:9cf39bb0-a7cc-4c4f-8035-ab9983a346c8.jpg"},
  {id:"crf209",name:"Pommes Frites Surgelées 9/9 Tastu 1kg",desc:"Surgelés",price:22.9,cat:"surgeles",emoji:"🧊",imgRef:"G:0ae65c5f-f959-41a6-8b4a-6eadef1c0a6b.jpg",originalPrice:29.9},
  {id:"crf210",name:"Pomme Frites Delaroche 1kg",desc:"Surgelés",price:17.9,cat:"surgeles",emoji:"🧊",imgRef:"P:69f0d3a4d53e7db668dfdbba.jpg",originalPrice:25.95},
  {id:"crf211",name:"Frites 6/6 Starfarm 1kg",desc:"Surgelés",price:25.9,cat:"surgeles",emoji:"🧊",imgRef:"G:b189eb5d-e662-43b5-9822-3283502c07a5.jpg",originalPrice:34.5},
  {id:"crf212",name:"Cubes de pommes de terre congelés à l'aube 1kg",desc:"Épicerie",price:28.5,cat:"epicerie",emoji:"🧂",imgRef:"G:a6cca7d1-aced-46c9-be17-750cb251f38c.jpg"},
  {id:"crf213",name:"Tranches de Pommes de Terre Surgelées Amanhecer 1kg",desc:"Surgelés",price:31.95,cat:"surgeles",emoji:"🧊",imgRef:"G:ad7ed986-4dcd-498a-9952-c711bb0c5ea2.jpg"},
  {id:"crf214",name:"Petits Pois Surgelés Goldy 400g",desc:"Surgelés",price:15.95,cat:"surgeles",emoji:"🧊",imgRef:"G:777ce425-2e5c-41ee-873d-36b09815676d.jpg"},
  {id:"crf215",name:"Pommes de Terre pour Frites 10/10 International 2,5kg.",desc:"Surgelés",price:45.9,cat:"surgeles",emoji:"🧊",imgRef:"G:d7ad95e5-17e7-4e51-aac2-4e970441f4bc.jpg",originalPrice:79.9},
  {id:"crf216",name:"Petits Pois et Artichauts Goldy 500g",desc:"Épicerie",price:21.9,cat:"epicerie",emoji:"🧂",imgRef:"G:4c180ac3-1aa0-4cd7-8b28-9f864945fc11.jpg"},
  {id:"crf217",name:"Pommes de Terre Rissolées Carrefour 450g",desc:"Épicerie",price:17.95,cat:"epicerie",emoji:"🧂",imgRef:"G:c3419075-165f-4526-a2db-bb83b17b1e9c.jpeg"},
  {id:"crf218",name:"fonds artichauts goldy 400g",desc:"Épicerie",price:34.5,cat:"epicerie",emoji:"🧂",imgRef:"G:f2d3801a-d991-42c5-ace1-0949212c51d0.jpg"},
  {id:"crf219",name:"Frites Allumettes FunFries 1kg",desc:"Surgelés",price:22.95,cat:"surgeles",emoji:"🧊",imgRef:"G:c88445e2-7543-40a6-a1d5-253ce406bacd.jpg",originalPrice:32.25},
  {id:"crf220",name:"Frites 9/9 Carrefour 2,5kg.",desc:"Surgelés",price:75.95,cat:"surgeles",emoji:"🧊",imgRef:"P:69b83f126792badc11c89f2b.jpg"},
  {id:"crf221",name:"Frites Allumettes 7/7 Funfries 2,5kg.",desc:"Surgelés",price:49.9,cat:"surgeles",emoji:"🧊",imgRef:"P:69b8508518eef1ea2802a513.jpg",originalPrice:71.25},
  {id:"crf222",name:"PINGUIN PETITS POIS 450G",desc:"Épicerie",price:22.25,cat:"epicerie",emoji:"🧂",imgRef:"G:3da2f5cb-771b-41a9-b898-67018fb44d5a.jpg"},
  {id:"crf223",name:"Frites 9/9 Funfries 2,5kg.",desc:"Surgelés",price:49.9,cat:"surgeles",emoji:"🧊",imgRef:"P:6729cdcb2499ebd608d91402.jpg",originalPrice:71.25},
  {id:"crf224",name:"PINGUIN EPINARDS BRANCHES 450G",desc:"Épicerie",price:22.25,cat:"epicerie",emoji:"🧂",imgRef:"G:e1cb10d9-2613-4a00-9300-20e3ec9537bf.jpg"},
  {id:"crf225",name:"Pommes de Terre Rissolées Funfries 1Kg",desc:"Épicerie",price:32.9,cat:"epicerie",emoji:"🧂",imgRef:"P:66acb90624faf96b43883669.jpg",originalPrice:39.95},
  {id:"crf226",name:"Pommes de terre croquettes LUTOSA 750g - 506",desc:"Épicerie",price:41.25,cat:"epicerie",emoji:"🧂",imgRef:"P:67613162cd130c3a80844054.jpg"},
  {id:"crf227",name:"Frites Allumettes Juste au Four McCain 700g",desc:"Surgelés",price:50.95,cat:"surgeles",emoji:"🧊",imgRef:"G:4b54305d-f11f-4e13-8262-ede6bf3088bf.jpg"},
  {id:"crf228",name:"Frites Classiques Juste au Four McCain 810g",desc:"Surgelés",price:45.95,cat:"surgeles",emoji:"🧊",imgRef:"G:9c42bf76-e54d-4072-beb0-529ac675009c.jpg"},
  {id:"crf229",name:"Frites Golden Allumettes McCain 1080g",desc:"Surgelés",price:48.5,cat:"surgeles",emoji:"🧊",imgRef:"G:42a4889d-18ef-470b-9f8c-fec07ced02e4.jpg"},
  {id:"crf230",name:"Asta Café Epicé 200g",desc:"Épicerie",price:28.95,cat:"epicerie",emoji:"🧂",imgRef:"G:85db1d10-e44b-4d8e-a206-13744cb60f77.jpeg"},
  {id:"crf231",name:"samar cafe creme express 45g",desc:"Produit laitier",price:23.75,cat:"laitier",emoji:"🧀",imgRef:"G:53e46022-69ed-461b-b4c6-3cd5b6c4b338.jpeg"},
  {id:"crf232",name:"Café Soluble Nescafé 190g.",desc:"Épicerie",price:76.95,cat:"epicerie",emoji:"🧂",imgRef:"G:709511a4-68bc-4c8e-ba91-d7f8cd543315.jpg"},
  {id:"crf233",name:"Café Moulu Arabica Java Timor Dubois 225g.",desc:"Épicerie",price:44.95,cat:"epicerie",emoji:"🧂",imgRef:"G:c8bc71dd-a518-4929-bf98-9d6dd460f2b3.jpg"},
  {id:"crf234",name:"Café Moulu Mélange Capriccio Rouge Dubois 225g",desc:"Épicerie",price:38.95,cat:"epicerie",emoji:"🧂",imgRef:"G:eda6ab62-4d77-4cef-a9ef-ea94d4c8895b.jpg"},
  {id:"crf235",name:"Café Moulu Capriccio Intense et Équilibré Dubois 225g",desc:"Épicerie",price:31.25,cat:"epicerie",emoji:"🧂",imgRef:"G:5b4ba66f-f1c2-432d-8a30-25422c746a6a.jpg"},
  {id:"crf236",name:"Café Moulu Ambassadeur Dubois 225g",desc:"Épicerie",price:47.75,cat:"epicerie",emoji:"🧂",imgRef:"G:3ec449ce-75fb-4acd-9337-e8e884c42cfd.jpg"},
  {id:"crf237",name:"Lot Café Capriccio Vert Dubois 2 unités 200g",desc:"Épicerie",price:52.95,cat:"epicerie",emoji:"🧂",imgRef:"G:1d372f86-72d0-4161-9224-6028b90a568d.jpg"},
  {id:"crf238",name:"Café moulu pure origine Colombie pur arabica 225g - JAVA TIMOR",desc:"Épicerie",price:60.95,cat:"epicerie",emoji:"🧂",imgRef:"G:1cc800e3-c083-4c34-bf02-79dccce75bbb.jpg"},
  {id:"crf239",name:"Café en Grains Brésil Supérieur Dubois 1kg.",desc:"Épicerie",price:176.5,cat:"epicerie",emoji:"🧂",imgRef:"G:dcf6b456-1601-4d22-8fe7-d0580b2f283f.jpg"},
  {id:"crf240",name:"Café en Grains Expresso Dubois 1kg",desc:"Épicerie",price:145.95,cat:"epicerie",emoji:"🧂",imgRef:"G:4a4cb3b5-d505-4294-af08-a543178fad9e.jpg"},
  {id:"crf241",name:"2 Nescafe 90G + 1 Nescafe Gold 45G Offert",desc:"Épicerie",price:74.95,cat:"epicerie",emoji:"🧂",imgRef:"P:6986169d2f7e062253d4ba87.jpg"},
  {id:"crf242",name:"Café Stick 3En1 Cream Nescafé 17G X15",desc:"Épicerie",price:24,cat:"epicerie",emoji:"🧂",imgRef:"G:e2489e58-51aa-4e96-812a-83ea31cc406e.jpg"},
  {id:"crf243",name:"Café Lyophilise Gold Nescafe 95g",desc:"Épicerie",price:69.5,cat:"epicerie",emoji:"🧂",imgRef:"G:07c19940-0553-4a0b-bc74-ae5746e17a95.jpg"},
  {id:"crf244",name:"Café Moulu Crema E Gusto Classique 250G - Lavazza",desc:"Épicerie",price:73.5,cat:"epicerie",emoji:"🧂",imgRef:"G:271e7584-6800-49e8-8268-090eae34fbd2.JPG"},
  {id:"crf245",name:"Cafe Lavazza Oro 250G",desc:"Épicerie",price:114.5,cat:"epicerie",emoji:"🧂",imgRef:"G:2824ddd9-ae10-4ca4-9adb-33153357de5a.jpeg"},
  {id:"crf246",name:"Samar Gusto Café Soluble 180g",desc:"Épicerie",price:82.95,cat:"epicerie",emoji:"🧂",imgRef:"G:05b6213e-afc4-4df5-8822-417319054096.jpg"},
  {id:"crf247",name:"Café Soluble Dynamique Asta 45G",desc:"Épicerie",price:20.5,cat:"epicerie",emoji:"🧂",imgRef:"P:66e4392fa9254d5a01ed1b99.jpeg"},
  {id:"crf248",name:"Samar Gusto Café Soluble 45g",desc:"Épicerie",price:23.75,cat:"epicerie",emoji:"🧂",imgRef:"G:f9175e17-1a5d-4e72-a06a-7dcea078f26a.jpg"},
  {id:"crf249",name:"Café Moulu Qualità Rossa 250G - Lavazza",desc:"Épicerie",price:105.95,cat:"epicerie",emoji:"🧂",imgRef:"G:75642d0f-f42e-4f95-9ede-4d78ba84b644.jpeg"},
  {id:"crf250",name:"Cafe Moulu Amanhecer 250g",desc:"Épicerie",price:46.25,cat:"epicerie",emoji:"🧂",imgRef:"P:69b84f8418eef1ea2801fde6.jpeg",originalPrice:55.5},
  {id:"crf251",name:"Café Soluble Décaféiné Carrefour 100G",desc:"Épicerie",price:75.5,cat:"epicerie",emoji:"🧂",imgRef:"G:076adf37-481e-4be3-82e2-e0a6cb7aa98e.jpeg"},
  {id:"crf252",name:"Café en Grains Amanhecer 250g",desc:"Épicerie",price:52.95,cat:"epicerie",emoji:"🧂",imgRef:"G:2d5fc1ee-b0da-4d3f-ab17-51fef62ae6ae.jpeg"},
  {id:"crf253",name:"L'or Classir Café Moulu 250g",desc:"Épicerie",price:42,cat:"epicerie",emoji:"🧂",imgRef:"G:cc97e08a-90bb-4720-93c6-a35b6ad4999b.jpg"},
  {id:"crf254",name:"Café Moulu Tonique Asta 200g.",desc:"Épicerie",price:27.9,cat:"epicerie",emoji:"🧂",imgRef:"G:afc7837e-4d66-498d-9554-6ee8dcab5496.jpg"},
  {id:"crf255",name:"250 GR CAF# L'OR ESPRESSO",desc:"Épicerie",price:42,cat:"epicerie",emoji:"🧂",imgRef:"G:a71ebe7a-1265-4e4c-b63b-f40a10a2a354.jpg"},
  {id:"crf256",name:"Café Moulu Force Asta 200g",desc:"Épicerie",price:29.5,cat:"epicerie",emoji:"🧂",imgRef:"G:d13c14b1-4b4d-4a49-a530-f57880f7ffda.jpg"},
  {id:"crf257",name:"Lavazza Boîte à café Crema E Gusto 2X250G sous vide",desc:"Épicerie",price:136.5,cat:"epicerie",emoji:"🧂",imgRef:"P:67e18868a87403abf88f1720.jpg"},
  {id:"crf258",name:"Café moulu arabica raffiné 200g - ASTA",desc:"Épicerie",price:35.5,cat:"epicerie",emoji:"🧂",imgRef:"G:513826d4-8c22-4993-9c96-efebbdcbfa49.jpg"},
  {id:"crf259",name:"Café Moulu Asta Prestige 200g.",desc:"Épicerie",price:28.95,cat:"epicerie",emoji:"🧂",imgRef:"G:3d1f7e16-fbf1-4b40-974b-2be8ad3501e0.jpg"},
  {id:"crf260",name:"Café Moulu Espresso Asta 200g",desc:"Épicerie",price:30.95,cat:"epicerie",emoji:"🧂",imgRef:"G:a3d02a26-771c-4f5a-a6a5-7a6bfc1fa3f5.jpeg"},
  {id:"crf261",name:"Asta Dynamic Café Soluble 90g",desc:"Épicerie",price:31.95,cat:"epicerie",emoji:"🧂",imgRef:"G:690909fd-e7ff-43b8-825d-1d6eefba880f.jpg"},
  {id:"crf262",name:"Café Soluble Dynamic 190G - Asta",desc:"Épicerie",price:53.95,cat:"epicerie",emoji:"🧂",imgRef:"G:912df6a5-5053-420a-93b4-4269615f75e0.JPG"},
  {id:"crf263",name:"Dubois Java Timor Café Lyophilisé 45g",desc:"Épicerie",price:27.95,cat:"epicerie",emoji:"🧂",imgRef:"G:19134868-da5b-4768-8b76-67c6c0024264.jpg"},
  {id:"crf264",name:"Café En Grains Moka 250G - Cafés Carrion",desc:"Épicerie",price:38.95,cat:"epicerie",emoji:"🧂",imgRef:"G:2e1dbb81-f8cd-4d72-b922-4be369cec9ea.jpg"},
  {id:"crf265",name:"Café En Grains Grano De Oro 250G - Cafés Carrion",desc:"Épicerie",price:54.5,cat:"epicerie",emoji:"🧂",imgRef:"G:17012747-d468-4a7f-b621-d344f6d0752e.jpg"},
  {id:"crf266",name:"Café Moulu Moka Carrion 225g",desc:"Épicerie",price:37.25,cat:"epicerie",emoji:"🧂",imgRef:"G:2b68883a-30e7-41d7-8406-5c3f0b726a00.jpg"},
  {id:"crf267",name:"Café Moulu Del Mundo Riche Et Doux 225G - Cafés Carrion",desc:"Épicerie",price:31.75,cat:"epicerie",emoji:"🧂",imgRef:"G:9a5695b8-5255-45b0-be69-0dd7d04ecb68.jpg"},
  {id:"crf268",name:"Café Moulu Grano De Oro 250G - Cafés Carrion",desc:"Épicerie",price:54.5,cat:"epicerie",emoji:"🧂",imgRef:"G:fe17ba9a-9a78-41b9-bb80-7f9b5eb1eef4.jpg"},
  {id:"crf269",name:"Café Soluble Lyophilisé Moka Gold 100G - Café Carrion",desc:"Épicerie",price:46.75,cat:"epicerie",emoji:"🧂",imgRef:"G:e90b99d9-930d-46c8-900c-fb63f19a4e16.jpg"},
  {id:"crf270",name:"Café Vert en Grain Granoverde Carrion 250g",desc:"Épicerie",price:70.25,cat:"epicerie",emoji:"🧂",imgRef:"G:6fa00ccd-f33a-4f38-af97-2bf88c9baa20.jpg"},
  {id:"crf271",name:"java timor cafe lyophilise 190g",desc:"Épicerie",price:80.95,cat:"epicerie",emoji:"🧂",imgRef:"G:140affb3-1942-4d60-bcfc-f036f28c4cab.jpg"},
  {id:"crf272",name:"Dubois Java Timor Espresso Crema 80g",desc:"Épicerie",price:49.95,cat:"epicerie",emoji:"🧂",imgRef:"G:59c62651-c107-4ac1-a09b-f3e77eba574f.jpeg"},
  {id:"crf273",name:"Café Moulu Pausa Café Carrion 200g.",desc:"Épicerie",price:26.75,cat:"epicerie",emoji:"🧂",imgRef:"G:eb252a34-5fa4-49ba-9366-eb63d6cac378.jpg"},
  {id:"crf274",name:"Café Soluble Del Mundo Carrion 50g",desc:"Épicerie",price:14.9,cat:"epicerie",emoji:"🧂",imgRef:"G:cb271012-8213-467d-b814-4d8f4c525dfe.jpg"},
  {id:"crf275",name:"Café en Grain Arabica Supérieur 250 g",desc:"Épicerie",price:50.95,cat:"epicerie",emoji:"🧂",imgRef:"P:69b842d36792badc11cb328a.jpeg"},
  {id:"crf276",name:"Café Moulu El Gusto Unico Carrion 250g",desc:"Épicerie",price:40.5,cat:"epicerie",emoji:"🧂",imgRef:"G:04ce04be-e8ff-478f-a294-f1d02766f590.jpg"},
  {id:"crf277",name:"Café Moulu Samar 180G",desc:"Épicerie",price:36,cat:"epicerie",emoji:"🧂",imgRef:"G:06a253c9-8100-49ad-a984-c5ebcc22925f.jpg"},
  {id:"crf278",name:"Café Moulu Arabica Intense Carte Noire 200g",desc:"Épicerie",price:64.75,cat:"epicerie",emoji:"🧂",imgRef:"G:04e16e9d-be80-4a0d-a0e5-0c17589f287d.jpg"},
  {id:"crf279",name:"Samar Dégustation Café Moulu 180g",desc:"Épicerie",price:37.5,cat:"epicerie",emoji:"🧂",imgRef:"G:8a254171-ee99-4949-8fb5-30ea99f08d6b.jpg"},
  {id:"crf280",name:"Café Moulu Arabica Carte Noire 200G",desc:"Épicerie",price:62.25,cat:"epicerie",emoji:"🧂",imgRef:"G:1721fe8e-a3f6-4ff8-8811-985b2b56448f.jpeg"},
  {id:"crf281",name:"Café soluble instantané 100% arabica - Le bocal de 95g - CARTE NOIRE (31)",desc:"Épicerie",price:82.75,cat:"epicerie",emoji:"🧂",imgRef:"G:ff06d396-a37a-4aa7-ae33-dff3e65ebac7.jpg"},
  {id:"crf282",name:"Café Soluble Gold Lyophilisé 190G - Asta Black",desc:"Épicerie",price:82.5,cat:"epicerie",emoji:"🧂",imgRef:"G:37b361e6-f686-4e21-b009-24c3ef2c795b.jpg"},
  {id:"crf283",name:"Café en Grains Ambassadeur Dubois 1kg.",desc:"Épicerie",price:205.5,cat:"epicerie",emoji:"🧂",imgRef:"G:f3c2b04d-8042-4a28-ab7b-eeb287d48435.jpg"},
  {id:"crf284",name:"Café Moulu Imperator Dubois 250g",desc:"Épicerie",price:46.95,cat:"epicerie",emoji:"🧂",imgRef:"G:6c91a3d6-0b91-4506-b325-217c02523002.jpg"},
  {id:"crf285",name:"Café Moulu Taiba 200g",desc:"Épicerie",price:29.95,cat:"epicerie",emoji:"🧂",imgRef:"G:ed726d2d-4ecb-43cc-bb44-65090efabcc6.JPG"},
  {id:"crf286",name:"Filtres à Café Numéro 4 Perfect 80 unités",desc:"Épicerie",price:27.95,cat:"epicerie",emoji:"🧂",imgRef:"G:2f0cf903-c379-407d-af4f-db3e4a43a3d7.jpg"},
  {id:"crf287",name:"Café en Grains 100% Arabica Diamant Noir 250g",desc:"Épicerie",price:53.95,cat:"epicerie",emoji:"🧂",imgRef:"G:a953dade-c1aa-49d8-8485-a36fb5aecefd.JPG"},
];
...
interface MarketStoreTheme{id:MarketStoreId;label:string;emoji:string;logoUrl?:string;accent:string;accentDark:string;accentLight:string;ring:string;grad:string;cardBg:string;cardBorder:string;textColor:string;mutedColor:string;}
const MARKET_STORES:MarketStoreTheme[]=[
  {id:'marjane',  label:'Marjane',   emoji:'🛒',logoUrl:'https://upload.wikimedia.org/wikipedia/commons/c/cf/Logo_marjane_market.svg',accent:'#059669',accentDark:'#065F46',accentLight:'#6EE7B7',ring:'rgba(5,150,105,0.55)',  grad:'linear-gradient(145deg,#000000 0%,#0D0D0D 45%,#1A1A1A 100%)', cardBg:'rgba(5,150,105,0.16)', cardBorder:'rgba(52,211,153,0.4)', textColor:'#D1FAE5', mutedColor:'rgba(209,250,229,0.6)'},
  {id:'carrefour',label:'Carrefour', emoji:'🅲',logoUrl:'https://upload.wikimedia.org/wikipedia/commons/0/0b/Carrefour-Mobile-logo.svg',accent:'#2563EB',accentDark:'#1E3A8A',accentLight:'#93C5FD',ring:'rgba(37,99,235,0.55)',  grad:'linear-gradient(145deg,#000000 0%,#0D0D0D 45%,#1A1A1A 100%)', cardBg:'rgba(37,99,235,0.16)', cardBorder:'rgba(147,197,253,0.4)', textColor:'#DBEAFE', mutedColor:'rgba(219,234,254,0.6)'},
  {id:'bim',      label:'Bim',       emoji:'🟡',logoUrl:'https://upload.wikimedia.org/wikipedia/commons/2/2d/Bim_%28company%29_logo.svg',accent:'#EAB308',accentDark:'#854D0E',accentLight:'#FDE68A',ring:'rgba(234,179,8,0.55)',  grad:'linear-gradient(145deg,#000000 0%,#0D0D0D 45%,#1A1A1A 100%)', cardBg:'rgba(234,179,8,0.18)', cardBorder:'rgba(253,230,138,0.45)', textColor:'#FEF9C3', mutedColor:'rgba(254,249,195,0.6)'},
];
...
function MarketItemCard({it,qty,theme,onAdd,onRem}:{it:MarketItem;qty:number;theme:MarketStoreTheme;onAdd:()=>void;onRem:()=>void}) {
  const photo=_mktImg(it.imgRef);
  const hasPromo=typeof it.originalPrice==='number'&&it.originalPrice>it.price;
  return(
    <div className="flex flex-col gap-2 rounded-2xl p-3 relative"
      ...
      <div style={{width:'100%',height:108,borderRadius:12,flexShrink:0,overflow:'hidden',background:theme.cardBg,border:`1px solid ${theme.cardBorder}`,display:'flex',alignItems:'center',justifyContent:'center',fontSize:32}}>
        ...
        <span style={{display:photo?'none':'flex',width:'100%',height:'100%',alignItems:'center',justifyContent:'center'}}>{it.emoji}</span>
      </div>
      <div style={{minWidth:0}}>
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {hasPromo&&<span className="text-[10px] font-bold" style={{color:theme.mutedColor,textDecoration:'line-through'}}>{it.originalPrice} DH</span>}
        </div>
      </div>
      <div className="flex items-center justify-end gap-2 flex-shrink-0 mt-auto">
        {qty>0&&(
  ...
  return(
    <button
      ...
      <div style={{position:'relative',width:88,height:88,flexShrink:0}}>
        ...
        <div style={{position:'absolute',inset:0,borderRadius:'50%',background:store.logoUrl?'#FDFCF9':store.grad,border:`2.5px solid ${store.accentLight}`,boxShadow:`0 8px 28px ${store.ring}`,display:'flex',alignItems:'center',justifyContent:'center',overflow:'hidden',animation:'marketFloat 3.6s ease-in-out infinite',animationDelay:`${index*0.4}s`}}>
          {store.logoUrl
            ?<img src={store.logoUrl} alt={store.label} style={{width:'68%',height:'68%',objectFit:'contain'}}/>
    ...
    {lang==='ar'?'تسجيل الدخول':lang==='amz'?'ⴰⴽⵛⵎ':'Se connecter'}
      ...
      <header className="relative pt-14 pb-4 flex flex-col items-center"
        ...
        <div className="h-14 w-14 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0"
          ...
          <img src="/logo.jpeg" alt="Bridge" className="w-full h-full object-cover" style={{transform:'scale(1.9)'}}/>
        </div>
