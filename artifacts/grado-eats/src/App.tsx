...
const MARKET_STORES:MarketStoreTheme[]=[
  {id:'marjane',  label:'Marjane',   emoji:'🛒',logoUrl:'https://upload.wikimedia.org/wikipedia/commons/c/cf/Logo_marjane_market.svg',accent:'#059669',accentDark:'#065F46',accentLight:'#6EE7B7',ring:'rgba(5,150,105,0.55)',  grad:'linear-gradient(145deg,#022c22 0%,#065F46 45%,#059669 100%)', cardBg:'rgba(5,150,105,0.16)', cardBorder:'rgba(52,211,153,0.4)', textColor:'#D1FAE5', mutedColor:'rgba(209,250,229,0.6)'},
  {id:'carrefour',label:'Carrefour', emoji:'🅲',logoUrl:'https://upload.wikimedia.org/wikipedia/commons/0/0b/Carrefour-Mobile-logo.svg',accent:'#2563EB',accentDark:'#1E3A8A',accentLight:'#93C5FD',ring:'rgba(37,99,235,0.55)',  grad:'linear-gradient(145deg,#0B1533 0%,#1E3A8A 45%,#2563EB 100%)', cardBg:'rgba(37,99,235,0.16)', cardBorder:'rgba(147,197,253,0.4)', textColor:'#DBEAFE', mutedColor:'rgba(219,234,254,0.6)'},
  {id:'bim',      label:'Bim',       emoji:'🟡',logoUrl:'https://upload.wikimedia.org/wikipedia/commons/2/2d/Bim_%28company%29_logo.svg',accent:'#EAB308',accentDark:'#854D0E',accentLight:'#FDE68A',ring:'rgba(234,179,8,0.55)',  grad:'linear-gradient(145deg,#3B0A0A 0%,#7F1D1D 45%,#EAB308 100%)', cardBg:'rgba(234,179,8,0.18)', cardBorder:'rgba(253,230,138,0.45)', textColor:'#FEF9C3', mutedColor:'rgba(254,249,195,0.6)'},
];
