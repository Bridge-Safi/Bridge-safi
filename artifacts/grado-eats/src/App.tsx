...
const RESTAURANTS: Restaurant[] = [
  ...
  // \u2500\u2500\u2500 GLOVO IMPORT (-5%) \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"sandwiches_0",emoji:"\ud83e\udd6a",names:_n("Sandwiches"),items:[{id:"rasslf_0_0",names:_n("Sandwich Viande Hach\u00e9e"),price:40,photo:_gp("")},{id:"rasslf_0_1",names:_n("Sandwich Poulet"),price:34,photo:_gp("")},{id:"rasslf_0_2",names:_n("Sandwich Fromage"),price:28,photo:_gp("")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"rasslf_1_0",names:_n("Tacos Viande Hach\u00e9e"),price:46,photo:_gp("")},{id:"rasslf_1_1",names:_n("Tacos Mixte"),price:46,photo:_gp("")},{id:"rasslf_1_2",names:_n("Tacos Poulet"),price:40,photo:_gp("")}]},
      {id:"pizzas_2",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"rasslf_2_0",names:_n("Pizza 4 Fromages"),price:63,photo:_gp("")},{id:"rasslf_2_1",names:_n("Pizza Poulet"),price:46,photo:_gp("")},{id:"rasslf_2_2",names:_n("Pizza Margarita"),price:40,photo:_gp("")}]},
  ...
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"safico_0_0",names:_n("Tacos Mixte"),price:57,photo:_gp("")},{id:"safico_0_1",names:_n("Tacos Poulet"),price:52,photo:_gp("")}]},
      {id:"pizzas_1",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"safico_1_0",names:_n("Pizza Poulet"),price:66,photo:_gp("")},{id:"safico_1_1",names:_n("Pizza Margherita"),price:40,photo:_gp("")}]},
      {id:"salades_2",emoji:"\ud83e\udd57",names:_n("Salades"),items:[{id:"safico_2_0",names:_n("Salade C\u00e9sar"),price:59,photo:_gp("")},{id:"safico_2_1",names:_n("Salade Marocaine"),price:40,photo:_gp("")}]},
  ...
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"endosa_0_0",names:_n("Tacos Sp\u00e9cial"),price:46,photo:_gp("")},{id:"endosa_0_1",names:_n("Tacos Mixte"),price:43,photo:_gp("")},{id:"endosa_0_2",names:_n("Tacos Chicken"),price:41,photo:_gp("")}]},
      {id:"burgers_1",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"endosa_1_0",names:_n("Big Burger"),price:48,photo:_gp("")},{id:"endosa_1_1",names:_n("Cheese Burger"),price:35,photo:_gp("")}]},
      {id:"chawarma_2",emoji:"\ud83c\udf2f",names:_n("Chawarma"),items:[{id:"endosa_2_0",names:_n("Plat Chawarma"),price:49,photo:_gp("")},{id:"endosa_2_1",names:_n("Chawarma Normal"),price:28,photo:_gp("")}]},
      {id:"pizza_3",emoji:"\ud83c\udf55",names:_n("Pizza"),items:[{id:"endosa_3_0",names:_n("Pizza Royale"),price:57,photo:_gp("")},{id:"endosa_3_1",names:_n("Pizza Margarita"),price:33,photo:_gp("")}]},
    ],
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"tacosplus_0",emoji:"\ud83c\udf2e",names:_n("Tacos Plus"),items:[{id:"tacosp_0_0",names:_n("Tacos Taco Plus"),price:46,photo:_gp("")},{id:"tacosp_0_1",names:_n("Tacos Mixte"),price:43,photo:_gp("")},{id:"tacosp_0_2",names:_n("Tacos Chicken"),price:41,photo:_gp("")}]},
      {id:"burgerplus_1",emoji:"\ud83c\udf54",names:_n("Burger Plus"),items:[{id:"tacosp_1_0",names:_n("Big Burger"),price:48,photo:_gp("")},{id:"tacosp_1_1",names:_n("Cheese Burger"),price:35,photo:_gp("")}]},
      {id:"chawarmaplus_2",emoji:"\ud83c\udf2f",names:_n("Chawarma Plus"),items:[{id:"tacosp_2_0",names:_n("Chawarma Plus"),price:42,photo:_gp("")},{id:"tacosp_2_1",names:_n("Chawarma Normal"),price:28,photo:_gp("")}]},
      {id:"pizzaplus_3",emoji:"\ud83c\udf55",names:_n("Pizza Plus"),items:[{id:"tacosp_3_0",names:_n("Pizza Royale"),price:57,photo:_gp("")},{id:"tacosp_3_1",names:_n("Pizza Margarita"),price:33,photo:_gp("")}]},
    ],
  },
  {
    ...
    categories:[
      ...
      {id:"pizza_1",emoji:"\ud83c\udf55",names:_n("Pizza"),items:[{id:"snacke_1_0",names:_n("Pizza Fruits De Mer"),price:48,photo:_gp("")},{id:"snacke_1_1",names:_n("Pizza Margarita"),price:33,photo:_gp("")}]},
      {id:"burger_2",emoji:"\ud83c\udf54",names:_n("Burger"),items:[{id:"snacke_2_0",names:_n("Fristo Burger"),price:43,photo:_gp("")},{id:"snacke_2_1",names:_n("Cheese Burger"),price:28,photo:_gp("")}]},
  ...
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"chawarma_0",emoji:"\ud83c\udf2f",names:_n("Chawarma"),items:[{id:"laquat_0_0",names:_n("Chawarma Big Size"),price:42,photo:_gp("")},{id:"laquat_0_1",names:_n("Chawarma Normal"),price:28,photo:_gp("")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"laquat_1_0",names:_n("Tacos Mixte"),price:43,photo:_gp("")},{id:"laquat_1_1",names:_n("Tacos Chicken"),price:41,photo:_gp("")}]},
      {id:"pizza_2",emoji:"\ud83c\udf55",names:_n("Pizza"),items:[{id:"laquat_2_0",names:_n("Pizza Poulet"),price:43,photo:_gp("")},{id:"laquat_2_1",names:_n("Pizza Margarita"),price:33,photo:_gp("")}]},
      {id:"burger_3",emoji:"\ud83c\udf54",names:_n("Burger"),items:[{id:"laquat_3_0",names:_n("Big Burger"),price:48,photo:_gp("")}]},
    ],
  },
  {
  ...
  },
  {
    ...
    categories:[
      ...
      {id:"pasticcio_3",emoji:"\ud83c\udf5d",names:_n("Pasticcio"),items:[{id:"labarq_3_0",names:_n("Pasticcio Poulet"),price:38,photo:_gp("")}]},
    ],
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"ltacos_0_0",names:_n("Tacos XXL"),price:57,photo:_gp("")},{id:"ltacos_0_1",names:_n("Tacos Mixte"),price:43,photo:_gp("")},{id:"ltacos_0_2",names:_n("Tacos Chicken"),price:38,photo:_gp("")}]},
      {id:"burgers_1",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"ltacos_1_0",names:_n("Widadi Burger"),price:48,photo:_gp("")},{id:"ltacos_1_1",names:_n("Chicken Burger"),price:33,photo:_gp("")}]},
      {id:"jus_2",emoji:"\ud83e\udde3",names:_n("Jus"),items:[{id:"ltacos_2_0",names:_n("Jus De Mangue"),price:24,photo:_gp("")},{id:"ltacos_2_1",names:_n("Jus Panach\u00e9"),price:19,photo:_gp("")}]},
    ],
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"tacos_0",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"snackc_0_0",names:_n("Tacos CHIRAZ"),price:48,photo:_gp("")},{id:"snackc_0_1",names:_n("Tacos Mixte"),price:45,photo:_gp("")}]},
      {id:"burgers_1",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"snackc_1_0",names:_n("Big Burger"),price:43,photo:_gp("")},{id:"snackc_1_1",names:_n("Chicken Burger"),price:32,photo:_gp("")}]},
      {id:"chawarmas_2",emoji:"\ud83c\udf2f",names:_n("Chawarmas"),items:[{id:"snackc_2_0",names:_n("Chawarma Extra"),price:40,photo:_gp("")}]},
      {id:"pizzas_3",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"snackc_3_0",names:_n("Pizza Royale"),price:59,photo:_gp("")},{id:"snackc_3_1",names:_n("Pizza Margherita"),price:32,photo:_gp("")}]},
    ],
  },
  {
  ...
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"sandwichs_0",emoji:"\ud83e\udd6a",names:_n("Sandwichs"),items:[{id:"ladolc_0_0",names:_n("Sandwich Viande Hach\u00e9e"),price:52,photo:_gp("")},{id:"ladolc_0_1",names:_n("Sandwich Poulet"),price:47,photo:_gp("")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"ladolc_1_0",names:_n("Tacos Cordon Bleu"),price:52,photo:_gp("")},{id:"ladolc_1_1",names:_n("Tacos Poulet"),price:43,photo:_gp("")}]},
  ...
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"burgers_0",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"dreams_0_0",names:_n("Dreams Burger"),price:61,photo:_gp("")},{id:"dreams_0_1",names:_n("Chicken Burger"),price:48,photo:_gp("")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"dreams_1_0",names:_n("Tacos Mixte"),price:63,photo:_gp("")},{id:"dreams_1_1",names:_n("Tacos Poulet"),price:43,photo:_gp("")}]},
      {id:"pizzas_2",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"dreams_2_0",names:_n("Pizza Poulet"),price:48,photo:_gp("")},{id:"dreams_2_1",names:_n("Pizza Margherita"),price:33,photo:_gp("")}]},
  ...
  },
  {
    ...
    address:'Safi, Maroc',
    categories:[
      {id:"pizzas_0",emoji:"\ud83c\udf55",names:_n("Pizzas"),items:[{id:"pizzer_0_0",names:_n("Pizza Fruits De Mer"),price:40,photo:_gp("")},{id:"pizzer_0_1",names:_n("Pizza Poulet"),price:36,photo:_gp("")},{id:"pizzer_0_2",names:_n("Pizza Margarita"),price:25,photo:_gp("")}]},
      {id:"tacos_1",emoji:"\ud83c\udf2e",names:_n("Tacos"),items:[{id:"pizzer_1_0",names:_n("Tacos Mixte"),price:43,photo:_gp("")},{id:"pizzer_1_1",names:_n("Tacos Poulet"),price:36,photo:_gp("")}]},
      {id:"burgers_2",emoji:"\ud83c\udf54",names:_n("Burgers"),items:[{id:"pizzer_2_0",names:_n("Cheese Burger"),price:29,photo:_gp("")}]},
      {id:"chawarmas_3",emoji:"\ud83c\udf2f",names:_n("Chawarmas"),items:[{id:"pizzer_3_0",names:_n("Chawarma Mixte"),price:34,photo:_gp("")}]},
    ],
  },
];
